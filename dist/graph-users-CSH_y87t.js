...
async function loadMSTeamsSdk() {
	const [appsModule, apiModule] = await Promise.all([import("./dist-CHLVR9Yo.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1)), import("./dist-ByLIWk5-.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1))]);
	return {
		App: appsModule.App,
...
async function createBotFrameworkJwtValidator(creds) {
	const { createServiceTokenValidator } = await import("./jwt-validator-n2nRbNVC.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1));
