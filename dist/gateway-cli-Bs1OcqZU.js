import { i as testRegexWithBoundedInput } from "./safe-regex-Bkc6yAjC.js";
import { t as compileConfigRegex } from "./config-regex-DURGpFbR.js";
import "./redact-DJH_TKCK.js";
import { a as hasErrnoCode, r as formatErrorMessage } from "./errors-Cn8_L7ES.js";
import { a as registerUnhandledRejectionHandler } from "./unhandled-rejections-DJzSnYbH.js";
import { a as getLogger, i as getChildLogger, o as getResolvedLoggerSettings } from "./logger-Qep7Kkk8.js";
import { _ as resolveStateDir, i as isNixMode, l as resolveGatewayLockDir, o as resolveConfigPath, r as STATE_DIR, t as CONFIG_PATH, u as resolveGatewayPort } from "./paths-C--RM-nt.js";
import "./tmp-openclaw-dir-DHiu0fYi.js";
import { n as isRich, r as theme, t as colorize } from "./theme-CWrxY1-_.js";
import { a as logVerbose, s as setVerbose } from "./globals-ir4cuPXg.js";
import { d as setConsoleTimestampPrefix, m as defaultRuntime, r as runtimeForLogger, t as createSubsystemLogger, u as setConsoleSubsystemFilter } from "./subsystem-DZirmh0Z.js";
import { t as sanitizeForLog } from "./ansi-cwY8Vrne.js";
import "./boolean-B6zcAynR.js";
import { n as logAcceptedEnvOption, t as isTruthyEnvValue } from "./env-BhXregSC.js";
import "./warning-filter-hHA7Rorp.js";
import { C as sleep, D as isPlainObject, E as truncateUtf16Safe, S as shortenHomePath, c as ensureDir, l as escapeRegExp, r as clamp, y as resolveUserPath } from "./utils-DHW4u72m.js";
...
import { $b as mergeSessionEntry, $c as buildDefaultToolPolicyPipelineSteps, $l as setGatewaySigusr1RestartPolicy, $y as computeBackoff, Ab as cleanupArchivedSessionTranscripts, Af as rejectNodePairing, Ag as OPENAI_TTS_VOICES, Al as resolveSessionModelRef, At as resolveHeartbeatSenderContext, Bc as waitForActiveEmbeddedRuns, Bd as deliverOutboundPayloads, Bf as createDefaultDeps, Bl as ensureOutboundSessionEntry, Bu as waitForActiveTasks, Cf as recordRemoteNodeInfo, Ch as normalizeMimeList, Ci as isAbortRequestText, Ct as resolveHeartbeatVisibility, Cu as activateSecretsRuntimeSnapshot, Db as archiveFileOnDisk, Df as setSkillsRemoteRegistry, Dl as loadSessionEntry, Dt as resolveIndicatorType, Du as resolveCommandSecretsFromActiveRuntimeSnapshot, Eb as normalizeSessionDeliveryFields, Ec as countActiveDescendantRuns, Ef as removeRemoteNodeInfo, El as loadCombinedSessionStoreForGateway, Es as requestBodyErrorToText, Et as onHeartbeatEvent, Eu as prepareSecretsRuntimeSnapshot, Fb as stripEnvelopeFromMessages, Ff as getSkillsSnapshotVersion, Fu as getQueueSize, Gd as resolveAgentDeliveryPlan, Gf as GATEWAY_AUTH_SURFACE_PATHS, Gg as getGlobalHookRunner, Gp as stripHeartbeatToken, Hb as loadCronStore, Hd as normalizeReplyPayloadsForDelivery, Ib as stripInlineDirectiveTagsForDisplay, Ic as clearSessionQueues, Id as lookupContextTokens, If as registerSkillsChangeListener, Is as createReplyDispatcher, Iu as getTotalQueueSize, Jb as evaluateSessionFreshness, Jd as getCliSessionId, Jl as deferGatewayRestartUntilIdle, Jp as emitAgentEvent, Kd as resolveAgentOutboundTarget, Kf as evaluateGatewayAuthSurfaceStates, Ky as resolveExecApprovalCommandDisplay, Lb as stripInlineDirectiveTagsFromMessageForDisplay, Lc as runEmbeddedPiAgent, Lf as buildOutboundSessionContext, Ll as normalizeGroupActivation, Lu as markGatewayDraining, Mb as readSessionPreviewItemsFromTranscript, Md as normalizeSpawnedRunMetadata, Mf as requestNodePairing, Mt as resolveSessionDeliveryTarget, Nb as resolveSessionTranscriptCandidates, Nd as resolveIngressWorkspaceOverrideForSpawnedRun, Nf as updatePairedNodeMetadata, Ni as createPluginRuntime, Nt as resolveOutboundChannelPlugin, Nu as enqueueCommandInLane, Ob as archiveSessionTranscripts, Of as approveNodePairing, Oi as stopSubagentsForRequester, Ol as migrateAndPruneGatewaySessionStoreKey, Ot as resolveExecApprovalSessionTarget, Ou as getPluginToolMeta, Pb as stripEnvelopeFromMessage, Pd as runWithModelFallback, Pf as verifyNodeToken, Pi as setGatewaySubagentRuntime, Ps as createReplyPrefixOptions, Pt as applyPluginAutoEnable, Pu as getActiveTaskCount, Qc as applyToolPolicyPipeline, Qd as resolveFailoverReasonFromError, Ql as scheduleGatewaySigusr1Restart, Qn as supportsXHighThinking, Rb as jsonUtf8Bytes, Rc as abortEmbeddedPiRun, Rd as resolveNestedAgentLane, Rf as extractDeliveryInfo, Rs as getTotalPendingReplies, Ru as resetAllLanes, Ry as buildChannelUiCatalog, Sf as primeRemoteSkillsCache, Sg as textToSpeech, Sh as extractImageContentFromSource, Sl as canonicalizeSpawnedByForAgent, Sm as SILENT_REPLY_TOKEN, St as resolveAgentOutboundIdentity, Su as persistBrowserProxyFiles, Tb as mergeDeliveryContext, Tf as refreshRemoteNodeBins, Tg as normalizeSpeechProviderId, Tl as listSessionsFromStore, Tt as getLastHeartbeatEvent, Tu as getActiveSecretsRuntimeSnapshot, Ub as resolveCronStorePath, Ug as normalizeSendPolicy, Ul as maybeResolveIdLikeTarget, Up as isHeartbeatContentEffectivelyEmpty, Vc as waitForEmbeddedPiRunEnd, Vf as createOutboundSendDeps$1, Vl as resolveOutboundSessionRoute, Wb as saveCronStore, Wd as resolveMessageChannelSelection, Wg as resolveSendPolicy, Wl as resetDirectoryCache, Wp as resolveHeartbeatPrompt$1, Xb as resolveSessionResetPolicy, Xd as runCliAgent, Xg as runGlobalGatewayStopSafely, Xl as isGatewaySigusr1RestartExternallyAllowed, Xm as extractTextFromChatContent, Xp as onAgentEvent, Yc as resolveFastModeState, Yd as setCliSessionId, Yl as emitGatewayRestart, Yn as formatThinkingLevels, Yp as getAgentRunContext, Zc as resolveToolLoopDetectionConfig, Zl as markGatewaySigusr1RestartHandled, Zp as registerAgentRunContext, _b as saveSessionStore, _c as formatZonedTimestamp, _f as resolveBootstrapWarningSignaturesSeen, _u as normalizeRequiredName, ad as canonicalizePathForSecurity, al as createOpenClawTools, ap as resolveEffectiveMessagesConfig, ax as resolveExplicitAgentSessionKey, bf as parseVerboseOverride, bh as DEFAULT_INPUT_TIMEOUT_MS, bu as closeTrackedBrowserTabsForSessions, cr as withPluginRuntimeGatewayRequestScope, cu as writeRestartSentinel, df as requestHeartbeatNow, dg as resolveTtsApiKey, di as buildBareSessionResetPrompt, dp as appendCronStyleCurrentTimeLine, du as normalizeCronJobPatch, eb as sleepWithAbort, ef as clearBootstrapSnapshot, eu as setPreRestartDeferralCheck, fb as archiveRemovedSessionTranscripts, ff as setHeartbeatWakeHandler, fg as resolveTtsAutoMode, fp as resolveCronStyleNow, gl as loadProviderUsageSummary, gu as normalizePayloadToSystemText, hg as resolveTtsProviderOrder, hl as resolvePreferredSessionKeyForSessionIdMatches, hu as normalizeOptionalText$1, id as PROTECTED_PLUGIN_ROUTE_PREFIXES, if as enqueueSystemEvent, ig as getTtsProvider, il as runBeforeToolCallHook, ip as resolveAgentIdentity, iu as formatRestartSentinelMessage, ix as resolveAgentMainSessionKey, jb as readSessionMessages, jc as listDescendantRunsForRequester, jd as agentCommandFromIngress, jf as renamePairedNode, jt as resolveOutboundTarget, kb as capArrayByJsonBytes, kc as initSubagentRegistry, kf as listNodePairing, kg as OPENAI_TTS_MODELS, kl as resolveGatewaySessionStoreTarget, kt as resolveHeartbeatDeliveryTarget, ku as resolvePluginTools, ky as resolveWhatsAppAccount, lu as normalizeHttpWebhookUrl, mf as resolveHeartbeatReasonKind, mg as resolveTtsPrefsPath, ml as resolveAnnounceTargetFromKey, mm as primeConfiguredBindingRegistry, mu as normalizeOptionalSessionKey, ni as dispatchInboundMessage, nl as resolveGroupToolPolicy, np as resolveAgentAvatar, nu as consumeRestartSentinel, nx as resolveMainSessionKeyFromConfig, od as canonicalizePathVariant, of as isSystemEventContextChanged, og as isTtsEnabled, or as loadOpenClawPlugins, ou as summarizeRestartSentinel, ox as resolveMainSessionKey, pb as loadSessionStore, pf as setHeartbeatsEnabled, pg as resolveTtsConfig, pl as readLatestAssistantReply, pu as normalizeOptionalAgentId, qd as createOutboundSendDeps, qh as resolveAgentTimeoutMs, ql as consumeGatewaySigusr1RestartAuthorization, qp as clearAgentRunContext, qy as sanitizeExecApprovalDisplayText, rh as loadModelCatalog, rl as resolveSubagentToolPolicy, ru as formatDoctorNonInteractiveHint, rx as canonicalizeMainSessionAlias, sf as peekSystemEventEntries, sg as isTtsProviderConfigured, sr as getPluginRuntimeGatewayRequestScope, sx as snapshotSessionOrigin, tf as clearBootstrapSnapshotOnSessionRollover, ti as resolveHeartbeatReplyPayload, tl as resolveEffectiveToolPolicy, tu as triggerOpenClawRestart, tx as setSessionRuntimeModel, uf as areHeartbeatsEnabled, ui as getReplyFromConfig, uu as normalizeCronJobCreate, vf as resolveSessionAuthProfileOverride, vh as DEFAULT_INPUT_IMAGE_MAX_BYTES, wb as deliveryContextFromSession, wf as refreshRemoteBinsForConnectedNodes, wg as listSpeechProviders, wh as resolveInputFileLimits, wl as listAgentsForGateway, wm as isSilentReplyText, ws as readJsonBodyWithLimit, wt as emitHeartbeatEvent, wu as clearSecretsRuntimeSnapshot, xf as getRemoteSkillEligibility, xg as setTtsProvider, xh as extractFileContentFromSource, xm as HEARTBEAT_TOKEN, xu as applyBrowserProxyPaths, y as resolveAgentSessionDirs, yb as updateSessionStore, yf as applyVerboseOverride, yg as setTtsEnabled, yh as DEFAULT_INPUT_IMAGE_MIMES, ym as getAcpSessionManager, yu as normalizeLegacyDeliveryInput, zb as applyModelOverrideToSessionEntry, zc as getActiveEmbeddedRunCount, zd as CommandLane, zf as parseSessionThreadInfo, zu as setCommandLaneConcurrency } from "./auth-profiles-BwxmeQoE.js";
import { B as normalizeUsageDisplay, F as normalizeElevatedLevel, I as normalizeFastMode, O as DEFAULT_MODEL, R as normalizeReasoningLevel, V as normalizeVerboseLevel, d as parseModelRef, f as resolveAllowedModelRef, g as resolveHooksGmailModel, h as resolveDefaultModelForAgent, i as getModelRefStatus, j as formatXHighModelHint, k as DEFAULT_PROVIDER, l as normalizeModelRef, m as resolveConfiguredModelRef, o as isCliProvider, t as buildAllowedModelSet, u as normalizeModelSelection, x as resolveThinkingDefault, y as resolveSubagentConfiguredModelSelection, z as normalizeThinkLevel } from "./model-selection-CnnQfpX3.js";
import { a as resolveAgentDir, f as resolveAgentSkillsFilter, i as resolveAgentConfig, m as resolveDefaultAgentId, n as listAgentEntries, p as resolveAgentWorkspaceDir, r as listAgentIds, u as resolveAgentModelFallbacksOverride, v as resolveSessionAgentId } from "./agent-scope-CjT_nq79.js";
import { S as parseAgentSessionKey, c as normalizeAgentId, h as toAgentStoreSessionKey, l as normalizeMainKey, m as toAgentRequestSessionKey, o as classifySessionKeyShape, r as buildAgentMainSessionKey, t as DEFAULT_AGENT_ID, u as resolveAgentIdFromSessionKey, v as isAcpSessionKey, x as isSubagentSessionKey, y as isCronRunSessionKey } from "./session-key-UoG7Kfw5.js";
import { n as normalizeAccountId$1, r as normalizeOptionalAccountId, t as DEFAULT_ACCOUNT_ID } from "./account-id-BuyZMNja.js";
import { t as matchesSkillFilter } from "./filter-DaT0-sMS.js";
import { o as isNotFoundPathError } from "./boundary-path-C6aAhZ_Z.js";
import { t as sameFileIdentity } from "./file-identity-DQqJBhLu.js";
import { t as openVerifiedFileSync } from "./safe-open-sync-Bm4-G5Nb.js";
import { n as openBoundaryFile, r as openBoundaryFileSync } from "./boundary-file-read-C_4eDsgv.js";
import { a as logWarn, t as logDebug } from "./logger-Cpn1HYqp.js";
import { n as runCommandWithTimeout, r as runExec } from "./exec-CmLTXzPB.js";
import { t as resolveOpenClawPackageRoot } from "./openclaw-root-pj1kqVk8.js";
import { _ as resolveWorkspaceTemplateDir, a as DEFAULT_IDENTITY_FILENAME, c as DEFAULT_SOUL_FILENAME, d as ensureAgentWorkspace, g as resolveDefaultAgentWorkspaceDir, i as DEFAULT_HEARTBEAT_FILENAME, l as DEFAULT_TOOLS_FILENAME, o as DEFAULT_MEMORY_ALT_FILENAME, p as isWorkspaceSetupCompleted, r as DEFAULT_BOOTSTRAP_FILENAME, s as DEFAULT_MEMORY_FILENAME, t as DEFAULT_AGENTS_FILENAME, u as DEFAULT_USER_FILENAME } from "./workspace-v-lU9b6K.js";
import { C as parseByteSize, D as isAvatarImageDataUrl, Dt as applyLegacyMigrations, E as isAvatarHttpUrl, Et as applyMergePatch, Ht as resolveSubagentMaxConcurrent, Mt as buildTalkConfigResponse, Ot as ensureControlUiAllowedOriginsForNonLoopbackBind, P as applyConfigOverrides, Vt as resolveAgentMaxConcurrent, b as validateConfigObjectWithPlugins, c as parseConfigJson5, d as readConfigFileSnapshot, f as readConfigFileSnapshotForWrite, g as writeConfigFile, i as createConfigIO, j as looksLikeAvatarPath, p as resolveConfigSnapshotHash, s as loadConfig, u as readBestEffortConfig, w as AVATAR_MAX_BYTES, x as OpenClawSchema } from "./io-CT8Gq6Au.js";
import "./host-env-security-d-Ny36Hl.js";
import "./safe-text-C0AOXwdt.js";
import { n as VERSION, o as resolveRuntimeServiceVersion } from "./version-DI1aYFTb.js";
import { a as hasConfiguredSecretInput } from "./types.secrets-Es1UJmu9.js";
import "./env-substitution-BgU3yPjd.js";
import { n as isTestDefaultMemorySlotDisabled, r as normalizePluginsConfig } from "./config-state-ZFfx7wSS.js";
...
import { t as parseDurationMs } from "./parse-duration-DeZixF8S.js";
...
import { d as triggerInternalHook, n as createInternalHookEvent, t as clearInternalHooks, u as registerInternalHook } from "./internal-hooks-C8-czxy2.js";
import "./provider-models-CUuE-GPt.js";
import "./provider-onboard-CTDjrzVM.js";
import "./model-definitions-DMtyKAcZ.js";
import { n as callGateway, u as loadGatewayTlsRuntime$1 } from "./call-DsrhjEGT.js";
import { n as normalizeDeviceAuthScopes } from "./device-auth-UM88Cskj.js";
import { t as normalizeDeviceMetadataForAuth } from "./device-metadata-normalization-CyhH_kCK.js";
import "./delegate-CWt-W_4V.js";
import { o as getMachineDisplayName } from "./with-timeout-CTddzu9N.js";
...
import { n as getMemorySearchManager, r as resolveMemoryBackendConfig } from "./search-manager-CT1sU3t7.js";
import "./setup-binary-DRLu1svD.js";
import { f as isWithinDir } from "./signal-cli-install-DLDwZweW.js";
import "./identity-file-Nv1Ohjz7.js";
import { f as isKnownSecretTargetId } from "./command-secret-targets-CENFEFUU.js";
import "./pairing-token-D6LUir0O.js";
import "./delivery-queue-8m1md8rh.js";
import { i as isExternalHookSession, n as detectSuspiciousPatterns, r as getHookType, t as buildSafeExternalPrompt } from "./external-content-DgFPTkof.js";
...
import { b as saveExecApprovals, c as normalizeExecApprovals, f as readExecApprovalsSnapshot, o as mergeExecApprovalsSocketDefaults, r as ensureExecApprovals, t as DEFAULT_EXEC_APPROVAL_TIMEOUT_MS } from "./exec-approvals-DTpzP2Nr.js";
import { _ as resolveSystemRunApprovalRuntimeContext, g as resolveSystemRunApprovalRequestContext, o as parseTimeoutMsWithFallback } from "./nodes-screen-vvSkT3VA.js";
import { a as matchSystemRunApprovalBinding, c as toSystemRunApprovalMismatchError, i as buildSystemRunApprovalEnvBinding, n as resolveSystemRunCommandRequest, o as missingSystemRunApprovalBinding, r as buildSystemRunApprovalBinding } from "./system-run-command-DdZK-0ii.js";
import { i as parseAbsoluteTimeMs, n as resolveCronStaggerMs, r as resolveDefaultCronStaggerMs, t as normalizeCronStaggerMs } from "./stagger-BWAPcNjV.js";
import { t as cleanStaleGatewayProcessesSync } from "./restart-stale-pids-BrY5UIs4.js";
import "./provider-usage.fetch-kdzf0s7h.js";
import { o as buildHistoryContextFromEntries } from "./history-BwTruWhS.js";
...
import { n as withProgress } from "./progress-D-tTUmAz.js";
import "./shared-BTjSaeGP.js";
import { p as handleSlackHttpRequest } from "./slack-DhkVpWMZ.js";
...
import { i as resolveAssistantAvatarUrl, n as buildControlUiAvatarUrl, r as normalizeControlUiBasePath, t as CONTROL_UI_AVATAR_PREFIX } from "./control-ui-shared-r2ZND0kb.js";
import "./prompt-style-m5RmghCt.js";
import { c as handleReset } from "./onboard-helpers-igIv5Vw8.js";
import "./runtime-parse-CY3H6gL_.js";
import { p as scheduleDetachedLaunchdRestartHandoff } from "./launchd-BxxknCWn.js";
import { c as parseProcCmdline, s as isGatewayArgv } from "./service-D28G6QL6.js";
import "./systemd-D-7FRv18.js";
import "./shared-BIVk8tXe.js";
import "./systemd-hints-qagSoh_R.js";
import { t as parsePort } from "./parse-port-BRTgZlvY.js";
import { n as addGatewayServiceCommands } from "./daemon-cli-DrYXIugA.js";
import { t as probeGateway } from "./probe-CSKLhUQj.js";
import { n as formatConfigIssueLines } from "./issue-format-CCL1as7a.js";
import "./lifecycle-core-CNqmtlCz.js";
import "./status-Dz_a8lb5.js";
import "./diagnostics-BXtEh3e8.js";
import "./inspect-DGPCyh-B.js";
import "./probe-auth-BKTRcjO6.js";
import { t as WizardCancelledError } from "./prompts-DQOuT_uf.js";
import "./slack-core-COT8OzzV.js";
import "./replies-BXWhI4Ce.js";
import { a as rejectDevicePairing, c as revokeDeviceToken, d as updatePairedDeviceMetadata, f as verifyDeviceToken, i as listDevicePairing, l as rotateDeviceToken, m as roleScopesAllow, n as ensureDeviceToken, o as removePairedDevice, p as resolveMissingRequestedScope, r as getPairedDevice, s as requestDevicePairing, t as approveDevicePairing, u as summarizeDeviceTokens } from "./device-pairing-DHd7ZGLc.js";
import { n as verifyDeviceBootstrapToken } from "./device-bootstrap-CYpV23WS.js";
import "./agent-C93BfHdT.js";
import { n as resolveHookConfig, r as shouldIncludeHook } from "./config-DfMEaYAJ.js";
...
import { n as DEFAULT_GATEWAY_HTTP_TOOL_DENY } from "./dangerous-tools-Cyy4Gtoy.js";
import { t as readSecretFromFile } from "./secret-file-D4Y9f47j.js";
import { r as resolveConfiguredDeferredChannelPluginIds } from "./channel-plugin-ids-Bq9o3vsv.js";
import { a as buildBaseHints, i as applySensitiveHints, n as redactConfigSnapshot, o as mapSensitivePaths, r as restoreRedactedValues, s as applyDerivedTags, t as redactConfigObject } from "./redact-snapshot-BXK3wNOu.js";
import "./table-TB4eFk7v.js";
import { n as resolveWideAreaDiscoveryDomain, r as writeWideAreaGatewayZone } from "./widearea-dns-CH7iP0oW.js";
import { i as toOptionString, n as extractGatewayMiskeys, r as maybeExplainGatewayServiceStop, t as describeUnknownError } from "./shared-D6qI1qeP.js";
import { t as discoverGatewayBeacons } from "./bonjour-discovery-BDUIVgEl.js";
import { h as pickGatewaySelfPresence, t as getStatusSummary } from "./status.summary-dhW73cfL.js";
import { n as resolveHeartbeatIntervalMs, t as isHeartbeatEnabledForAgent } from "./heartbeat-summary-Xkyy4SjO.js";
import { i as styleHealthChannelLine, n as getHealthSnapshot, t as formatHealthChannelLines } from "./health-BXUdMzDD.js";
import { a as resolveControlUiRootOverrideSync, n as isPackageProvenControlUiRootSync, o as resolveControlUiRootSync, t as ensureControlUiAssetsBuilt } from "./control-ui-assets-BDnC0dQf.js";
import { a as resolveNpmChannelTag, n as compareSemverStrings, p as normalizeUpdateChannel, t as checkUpdateStatus } from "./update-check-B8XM124m.js";
import "./setup.secret-input-DBHi0U4v.js";
import { t as runSetupWizard } from "./setup-DTRrridP.js";
import { a as resolveApnsAuthConfigFromEnv, c as shouldClearStoredApnsRegistration, d as parseMessageWithAttachments, f as formatForLog, g as setGatewayWsLogStyle, h as summarizeAgentEventForWsLog, l as resolveApnsRelayConfigFromEnv, m as shouldLogWs, n as loadApnsRegistration, o as sendApnsAlert, p as logWs, r as normalizeApnsEnvironment, s as sendApnsBackgroundWake, t as clearApnsRegistrationIfCurrent, u as normalizeRpcAttachmentsToChatAttachments } from "./push-apns-BbKzCX0H.js";
import { _ as buildGogWatchStartArgs, g as buildGogWatchServeArgs, i as ensureTailscaleEndpoint, w as resolveGmailHookRuntimeConfig } from "./gmail-setup-utils-DBeXMT4f.js";
import { g as computePreviousRunAtMs, h as computeNextRunAtMs, m as coerceFiniteScheduleNumber, p as normalizeStoredCronJobs, t as runGatewayUpdate } from "./update-runner-BDephK0Q.js";
import { i as loadAgentIdentity, o as pruneAgentConfig, r as findAgentEntryIndex, t as applyAgentConfig } from "./agents.config-CTHfg-9O.js";
import { n as isNodeCommandAllowed, r as resolveNodeCommandAllowlist } from "./node-command-policy-BkW7t_-3.js";
import { t as buildChannelAccountSnapshot } from "./status-DMwLdl4g.js";
import "./status-CDyNUVi_.js";
import "./node-service-i4H8bC-s.js";
import "./channels-status-issues-a-w52bmm.js";
import "./channels-DKywqtHW.js";
import "./status.update-CdaBHYFn.js";
import "./skill-scanner-CWmjK63Q.js";
import { t as installSkill } from "./skills-install-DHMfrADY.js";
import { t as resolveAllowedAgentIds } from "./hooks-policy-C2nySCsn.js";
import { t as collectEnabledInsecureOrDangerousFlags } from "./dangerous-config-flags-BpSAElHi.js";
import { t as loadWorkspaceHookEntries } from "./workspace-C6IA37FT.js";
import { n as forceFreePortAndWait, r as waitForPortBindable } from "./ports-DZ5LGEJe.js";
...
function loadSshConfigModule() {
	sshConfigModulePromise ??= import("./ssh-config-DI9gCCW4.js");
	return sshConfigModulePromise;
}
function loadSshTunnelModule() {
	sshTunnelModulePromise ??= import("./ssh-tunnel-CEmMQpxh.js");
...
const nodeHandlers = {
	...
	"node.event": async ({ params, respond, context, client }) => {
		...
		await respondUnavailableOnThrow(respond, async () => {
			const { handleNodeEvent } = await import("./server-node-events-DV0H362e.js");
...
const usageHandlers = {
	...
	"sessions.usage.logs": async ({ respond, params }) => {
		...
		if (!resolved) return;
		const { config, entry, agentId, sessionId, sessionFile } = resolved;
		const { loadSessionLogs } = await import("./session-cost-usage-C9iyy0gB.js");
...
async function startBrowserControlServerIfEnabled() {
	...
	const mod = override ? await import(override) : await import("./server-B3_YyIxW.js");
		...
		try {
			...
			if (!client) {
				...
				const handleMissingDeviceIdentity = () => {
					...
					if (!device && (!isControlUi || decision.kind !== "allow" || trustedProxyAuthOk)) clearUnboundScopes();
...
async function startGatewayServer(port = 18789, opts = {}) {
	...
	if (!minimalTestGateway) (async () => {
		const { recoverPendingDeliveries } = await import("./delivery-queue-Ci5aHKZ7.js");
		const { deliverOutboundPayloads } = await import("./deliver-OwxAq8jL.js");
