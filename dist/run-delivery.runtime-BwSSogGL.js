...
import { i as resolveMainSessionKey, n as resolveAgentMainSessionKey } from "./main-session-CRdpto3G.js";
...
import { t as normalizeReplyPayload } from "./normalize-reply-Bh_yE48K.js";
import { t as createReplyPrefixContext } from "./reply-prefix-DLSoo5Xn.js";
import { _ as resolveDeliveryTarget, l as hasScheduledNextRunAtMs } from "./jobs-BQaLdLY9.js";
import { n as pickLastNonEmptyTextFromPayloads, r as pickSummaryFromOutput } from "./helpers-CUontHLo.js";
import { n as isLikelyInterimCronMessage, t as expectsSubagentFollowup } from "./subagent-followup-hints-yowAVAbI.js";
...
async function loadGatewayCallRuntime() {
	gatewayCallRuntimePromise ??= import("./call.runtime-CwsFjt1E.js");
	return await gatewayCallRuntimePromise;
}
async function loadDeliveryOutboundRuntime() {
	deliveryOutboundRuntimePromise ??= import("./delivery-outbound.runtime-FkW_59XV.js");
	return await deliveryOutboundRuntimePromise;
}
async function loadDeliverySubagentRegistryRuntime() {
	deliverySubagentRegistryRuntimePromise ??= import("./delivery-subagent-registry.runtime-BCQMyU3P.js");
	return await deliverySubagentRegistryRuntimePromise;
}
async function loadDeliveryLoggerRuntime() {
	deliveryLoggerRuntimePromise ??= import("./delivery-logger.runtime-CfoJO28w.js");
	return await deliveryLoggerRuntimePromise;
}
async function loadSubagentFollowupRuntime() {
	subagentFollowupRuntimePromise ??= import("./subagent-followup.runtime-Cs5m58Cw.js");
	...
	const deliverViaDirect = async (delivery, options) => {
		...
		try {
			...
			const normalizedPayloadsForDelivery = payloadsForDelivery.flatMap((p) => {
				const normalized = normalizeReplyPayload(p, { enableSlackInteractiveReplies: replyPrefix.enableSlackInteractiveReplies });
