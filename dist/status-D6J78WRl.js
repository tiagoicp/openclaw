...
import { g as resolveControlUiLinks } from "./onboard-helpers-D1z7-ld8.js";
...
import { n as resolveGatewayProbeAuthSafe } from "./probe-auth-f_duLt2h.js";
...
import { t as formatHealthChannelLines } from "./health-DK9uTHu_.js";
...
import { t as buildChannelsTable } from "./channels-CZU8aKqY.js";
...
function loadPluginRegistryModule() {
	pluginRegistryModulePromise ??= import("./plugin-registry-ckHsBpOP.js");
	return pluginRegistryModulePromise;
}
const loadStatusScanRuntimeModule = createLazyRuntimeSurface(() => import("./status.scan.runtime-DVRY2Rnz.js"), ({ statusScanRuntime }) => statusScanRuntime);
function loadStatusScanDepsRuntimeModule() {
	statusScanDepsRuntimeModulePromise ??= import("./status.scan.deps.runtime-DL52iATJ.js");
...
function loadProviderUsage() {
	providerUsagePromise ??= import("./provider-usage-6yAKYmPB.js");
	return providerUsagePromise;
}
function loadSecurityAuditModule() {
	securityAuditModulePromise ??= import("./audit.runtime-BXjdE1js.js");
