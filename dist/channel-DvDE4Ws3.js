import { Mp as createDefaultChannelRuntimeState, Op as buildProbeChannelStatusSummary, kp as buildRuntimeAccountStatusSnapshot, qt as createMessageToolCardSchema, um as parseFeishuConversationId } from "./auth-profiles-Djd2VmMW.js";
...
import { i as createActionGate } from "./common-BSZuydpj.js";
...
import { c as listFeishuAccountIds, d as resolveFeishuCredentials, f as feishuSetupAdapter, i as createFeishuClient, l as resolveDefaultFeishuAccountId, s as listEnabledFeishuAccounts, t as feishuSetupWizard, u as resolveFeishuAccount } from "./feishu-Cw4Dc-17.js";
import { i as normalizeFeishuTarget, r as looksLikeFeishuId, t as getFeishuRuntime } from "./runtime-GK-blqJr.js";
import { n as listFeishuDirectoryPeers, t as listFeishuDirectoryGroups } from "./directory.static-fzahlj3_.js";
import { i as resolveFeishuGroupToolPolicy } from "./policy-DS5TE9f2.js";
...
const loadFeishuChannelRuntime = createLazyRuntimeNamedExport(() => import("./channel.runtime-DjKGj25e.js"), "feishuChannelRuntime");
...
const feishuPlugin = {
	...
	gateway: { startAccount: async (ctx) => {
		const { monitorFeishuProvider } = await import("./monitor-CSUunFv1.js");
		const account = resolveFeishuAccount({
			cfg: ctx.cfg,
