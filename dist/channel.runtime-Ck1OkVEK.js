...
import { i as getMe, n as ZaloApiError, t as resolveZaloProxyFetch } from "./proxy-CS30K6mV.js";
import { t as sendMessageZalo } from "./send-DB5A9oQW.js";
...
async function notifyZaloPairingApproval(params) {
	const { resolveZaloAccount } = await import("./accounts-Cu7YV-y-.js");
...
async function startZaloGatewayAccount(ctx) {
	...
	const { monitorZaloProvider } = await import("./monitor-C76Zxb8-.js");
