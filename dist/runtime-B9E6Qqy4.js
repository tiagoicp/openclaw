...
import { t as registerMemoryCli } from "./memory-cli-CEvRi-iL.js";
...
import { $l as dispatchReplyWithBufferedBlockDispatcher, Ay as pushTemplateMessage, Bb as probeLineBot, Cb as recordChannelActivity, D as setTelegramThreadBindingMaxAgeBySessionKey, Dy as pushLocationMessage, E as setTelegramThreadBindingIdleTimeoutBySessionKey, Fh as resolveTelegramToken, Fv as hasControlCommand, Gv as resolveEnvelopeFormatOptions, Hv as formatAgentEnvelope, Iy as listLineAccountIds, Lv as isControlCommandMessage, Ly as normalizeAccountId, Ny as sendMessageLine, Oy as pushMessageLine, Rv as shouldComputeCommandAuthorized, Ry as resolveDefaultLineAccountId, Sb as getChannelActivity, Tb as buildTemplateMessageFromPayload, Tu as onAgentEvent, Ty as pushFlexMessage, Ul as monitorSignalProvider, Uv as formatInboundEnvelope, Vl as probeSignal, Wl as sendMessageSignal, _m as isVoiceCompatibleAudio, _y as resolveInboundDebounceMs, ay as dispatchReplyFromConfig, bs as listWebSearchProviders, dg as generateImage, fg as listRuntimeImageGenerationProviders, gy as createInboundDebouncer, jy as pushTextMessageWithQuickReplies, k as telegramMessageActions, ky as pushMessagesLine, pv as requestHeartbeatNow, qa as monitorLineProvider, ry as createReplyDispatcherWithTyping, ty as withReplyDispatcher, xf as signalMessageActions, xs as runWebSearch, xy as createQuickReplyItems, zy as resolveLineAccount } from "./pi-embedded-BHLc2HPd.js";
...
import { m as saveMediaBuffer } from "./client-fetch-DG9t9440.js";
...
import { n as collectTelegramUnmentionedGroupIds } from "./audit-BszklQB5.js";
import { t as discordMessageActions } from "./runtime-api-Cqzv7_gf.js";
import { D as resolveThreadBindingInactivityExpiresAt, E as resolveThreadBindingIdleTimeoutMs, O as resolveThreadBindingMaxAgeExpiresAt, k as resolveThreadBindingMaxAgeMs } from "./thread-bindings.messages-O0XAJ0VO.js";
import { a as setThreadBindingIdleTimeoutBySessionKey, d as getThreadBindingManager, o as setThreadBindingMaxAgeBySessionKey, s as unbindThreadBindingsBySessionKey } from "./thread-bindings-Cj-wJS44.js";
import { n as sendMessageIMessage, r as probeIMessage, t as monitorIMessageProvider } from "./imessage-DmcmMNiY.js";
...
const loadEmbeddedPiRuntime = createLazyRuntimeModule(() => import("./runtime-embedded-pi.runtime-BsVWqqLL.js"));
...
const bindDiscordRuntimeMethod = createLazyRuntimeMethodBinder(createLazyRuntimeSurface(() => import("./runtime-discord-ops.runtime-D0z7croK.js"), ({ runtimeDiscordOps }) => runtimeDiscordOps));
...
const bindSlackRuntimeMethod = createLazyRuntimeMethodBinder(createLazyRuntimeSurface(() => import("./runtime-slack-ops.runtime-C26HPTLe.js"), ({ runtimeSlackOps }) => runtimeSlackOps));
...
const bindTelegramRuntimeMethod = createLazyRuntimeMethodBinder(createLazyRuntimeSurface(() => import("./runtime-telegram-ops.runtime-C4YOskBw.js"), ({ runtimeTelegramOps }) => runtimeTelegramOps));
...
async function loadMemoryToolRuntime() {
	memoryToolRuntimePromise ??= import("./memory-tool.runtime-CyYXoqsh.js");
...
const loadTtsRuntime = createLazyRuntimeModule(() => import("./runtime-tts.runtime-Dm6vYan7.js"));
const loadMediaUnderstandingRuntime = createLazyRuntimeModule(() => import("./runtime-media-understanding.runtime-BS7wYxD7.js"));
const loadModelAuthRuntime = createLazyRuntimeModule(() => import("./runtime-model-auth.runtime-DCt5l2PZ.js"));
