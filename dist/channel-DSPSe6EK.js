import { Op as buildProbeChannelStatusSummary, jp as collectStatusIssuesFromLastError } from "./auth-profiles-Djd2VmMW.js";
...
import { _ as matrixSetupAdapter, a as resolveMatrixAccount, g as isBunRuntime, i as resolveDefaultMatrixAccountId, l as resolveSharedMatrixClient, o as resolveMatrixAccountConfig, p as resolveMatrixAuth, r as listMatrixAccountIds, t as matrixSetupWizard } from "./matrix-D7qFNJbP.js";
...
import { c as getActiveMatrixClient, n as sendMessageMatrix, o as resolveMatrixRoomId, s as createPreparedMatrixClient, t as reactMatrixMessage } from "./send-D-1X4f2M.js";
...
const loadMatrixChannelRuntime = createLazyRuntimeNamedExport(() => import("./channel.runtime-DpEmB6ZD.js"), "matrixChannelRuntime");
const meta = {
	id: "matrix",
	label: "Matrix",
...
const matrixPlugin = {
	...
	gateway: { startAccount: async (ctx) => {
		...
		try {
			monitorMatrixProvider = (await import("./matrix-CyfBVZ37.js")).monitorMatrixProvider;
		} finally {
			releaseLock();
		}
