...
import { d as listFeishuAccountIds, f as resolveDefaultFeishuAccountId, h as feishuSetupAdapter, i as createFeishuClient, l as inspectFeishuCredentials, m as resolveFeishuRuntimeAccount, p as resolveFeishuAccount, t as feishuSetupWizard, u as listEnabledFeishuAccounts } from "./setup-surface-DQhMaeQy.js";
import { a as parseFeishuConversationId } from "./api-BFv_lz1Q.js";
...
const loadFeishuChannelRuntime = createLazyRuntimeNamedExport(() => import("./channel.runtime-C1YszCv8.js"), "feishuChannelRuntime");
...
const feishuPlugin = createChatChannelPlugin({
	base: {
		...
		gateway: { startAccount: async (ctx) => {
			const { monitorFeishuProvider } = await import("./monitor-l-u3t41X.js");
