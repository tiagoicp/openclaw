import { _ as resolveStateDir, c as resolveDefaultConfigCandidates, n as DEFAULT_GATEWAY_PORT, o as resolveConfigPath, v as expandHomePrefix, x as resolveRequiredHomeDir } from "./paths-C--RM-nt.js";
import { t as isTruthyEnvValue } from "./env-BhXregSC.js";
import { D as isPlainObject$2, d as isRecord$1, g as resolveConfigDir, y as resolveUserPath } from "./utils-DHW4u72m.js";
import { D as DEFAULT_CONTEXT_TOKENS, d as parseModelRef, w as normalizeProviderId } from "./model-selection-CnnQfpX3.js";
import { m as resolveDefaultAgentId, p as resolveAgentWorkspaceDir, x as resolveAgentModelPrimaryValue } from "./agent-scope-CjT_nq79.js";
import { c as normalizeAgentId } from "./session-key-UoG7Kfw5.js";
import { i as isBlockedObjectKey } from "./account-id-BuyZMNja.js";
import { i as sanitizeHostExecEnv, n as isDangerousHostEnvVarName, r as normalizeEnvVarKey, t as isDangerousHostEnvOverrideVarName } from "./host-env-security-d-Ny36Hl.js";
import { t as sanitizeTerminalText } from "./safe-text-C0AOXwdt.js";
import { n as VERSION } from "./version-DI1aYFTb.js";
import { a as hasConfiguredSecretInput, i as coerceSecretRef } from "./types.secrets-Es1UJmu9.js";
import { n as containsEnvVarReference, r as resolveConfigEnvVars } from "./env-substitution-BgU3yPjd.js";
import { a as resolveMemorySlotDecision, i as resolveEffectiveEnableState, r as normalizePluginsConfig } from "./config-state-ZFfx7wSS.js";
import { a as resolveConfigIncludes, i as readConfigIncludeFileWithGuards, n as ConfigIncludeError } from "./includes-YrNTZia-.js";
import { E as formatSlackStreamingBooleanMigrationMessage, F as resolveTelegramPreviewStreamMode, M as resolveDiscordPreviewStreamMode, N as resolveSlackNativeStreaming, P as resolveSlackStreamingMode, T as formatSlackStreamModeMigrationMessage, a as IrcConfigSchema, c as SlackConfigSchema, i as IMessageConfigSchema, l as TelegramConfigSchema, n as DiscordConfigSchema, o as MSTeamsConfigSchema, r as GoogleChatConfigSchema, s as SignalConfigSchema, t as BlueBubblesConfigSchema } from "./zod-schema.providers-core-Lq3UWu4O.js";
import { t as isSafeExecutableValue } from "./exec-safety-COV9kYbz.js";
import { t as splitShellArgs } from "./shell-argv-DNSsonlL.js";
import { c as normalizeChatChannelId, l as CHANNEL_IDS } from "./registry-B1w4aWmD.js";
import { n as loadPluginManifestRegistry } from "./manifest-registry-DX175h3u.js";
import { i as isCanonicalDottedDecimalIPv4, u as isLoopbackIpAddress } from "./ip-BX5dj8yZ.js";
import { n as normalizeLegacyWebSearchConfig, t as listLegacyWebSearchConfigPaths } from "./legacy-web-search-C4CYOXDT.js";
import { t as parseDurationMs } from "./parse-duration-DeZixF8S.js";
import { a as ElevatedAllowFromSchema, i as AgentSandboxSchema, l as ToolsSchema, n as ChannelHeartbeatVisibilitySchema, o as HeartbeatSchema, r as AgentEntrySchema, s as MemorySearchSchema, u as AgentModelSchema } from "./zod-schema.channels-FynKKE-p.js";
import { A as TtsConfigSchema, I as sensitive, L as createAllowDenyChannelRulesSchema, N as TypingModeSchema, O as TranscribeAudioSchema, S as SecretInputSchema, T as SecretsConfigSchema, c as GroupPolicySchema, f as InboundDebounceSchema, g as NativeCommandsSettingSchema, h as ModelsConfigSchema, l as HexColorSchema, n as BlockStreamingCoalesceSchema, r as CliBackendSchema, s as GroupChatSchema, t as BlockStreamingChunkSchema, u as HumanDelaySchema, v as QueueSchema } from "./zod-schema.core-Ck0QyHFp.js";
...
//#endregion
export { isWindowsPlatform as $, isWorkspaceRelativeAvatarPath as A, createConfigRuntimeEnv as At, parseConfigPath as B, DEFAULT_SUBAGENT_MAX_SPAWN_DEPTH as Bt, parseByteSize as C, SAFE_BIN_PROFILES as Ct, isAvatarImageDataUrl as D, applyLegacyMigrations as Dt, isAvatarHttpUrl as E, applyMergePatch as Et, getConfigOverrides as F, readTalkApiKeyFromProfile as Ft, listWritableExplicitTrustedSafeBinDirs as G, resolveShellEnvFallbackTimeoutMs as Gt, unsetConfigValueAtPath as H, resolveSubagentMaxConcurrent as Ht, resetConfigOverrides as I, resolveActiveTalkProviderConfig as It, analyzeArgvCommand as J, normalizeTrustedSafeBinDirs as K, shouldEnableShellEnvFallback as Kt, setConfigOverride as L, resolveTalkApiKey as Lt, resolveAvatarMime as M, buildTalkConfigResponse as Mt, validateJsonSchemaValue as N, normalizeTalkConfig as Nt, isPathWithinRoot as O, ensureControlUiAllowedOriginsForNonLoopbackBind as Ot, applyConfigOverrides as P, normalizeTalkSection as Pt, buildSafeShellCommand as Q, unsetConfigOverride as R, DEFAULT_AGENT_MAX_CONCURRENT as Rt, parseNonNegativeByteSize as S, resolveInlineCommandMatch as St, isAvatarDataUrl as T, resolveSafeBinProfiles as Tt, getTrustedSafeBinDirs as U, getShellEnvAppliedKeys as Ut, setConfigValueAtPath as V, resolveAgentMaxConcurrent as Vt, isTrustedSafeBinPath as W, getShellPathFromLoginShell as Wt, buildEnforcedShellCommand as X, analyzeShellCommand as Y, buildSafeBinsShellCommand as Z, validateConfigObject as _, unwrapDispatchWrappersForResolution as _t, getRuntimeConfigSnapshot as a, parseExecArgvToken as at, validateConfigObjectWithPlugins as b, POSIX_INLINE_COMMAND_FLAGS as bt, parseConfigJson5 as c, resolveCommandResolutionFromArgv as ct, readConfigFileSnapshot as d, extractShellWrapperCommand as dt, resolvePlannedSegmentArgv as et, readConfigFileSnapshotForWrite as f, extractShellWrapperInlineCommand as ft, writeConfigFile as g, normalizeExecutableToken as gt, setRuntimeConfigSnapshotRefreshHandler as h, isShellWrapperExecutable as ht, createConfigIO as i, matchAllowlist as it, looksLikeAvatarPath as j, DEFAULT_TALK_PROVIDER as jt, isSupportedLocalAvatarExtension as k, collectConfigServiceEnvVars as kt, projectConfigOntoRuntimeSourceSnapshot as l, resolveExecutableFromPathEnv as lt, setRuntimeConfigSnapshot as m, isDispatchWrapperExecutable as mt, clearConfigCache as n, splitCommandChainWithOperators as nt, getRuntimeConfigSourceSnapshot as o, resolveAllowlistCandidatePath as ot, resolveConfigSnapshotHash as p, hasEnvManipulationBeforeShellWrapper as pt, validateSafeBinArgv as q, resolveOwnerDisplaySetting as qt, clearRuntimeConfigSnapshot as r, DEFAULT_SAFE_BINS as rt, loadConfig as s, resolveCommandResolution as st, ConfigRuntimeRefreshError as t, splitCommandChain as tt, readBestEffortConfig as u, POSIX_SHELL_WRAPPERS as ut, validateConfigObjectRaw as v, unwrapKnownDispatchWrapperInvocation as vt, AVATAR_MAX_BYTES as w, normalizeSafeBinProfileFixtures as wt, OpenClawSchema as x, POWERSHELL_INLINE_COMMAND_FLAGS as xt, validateConfigObjectRawWithPlugins as y, unwrapKnownShellMultiplexerInvocation as yt, getConfigValueAtPath as z, DEFAULT_SUBAGENT_MAX_CONCURRENT as zt };
