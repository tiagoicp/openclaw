...
//#region src/index.ts
const library = await import("./library-Tza2V8Sd.js");
...
async function runLegacyCliEntry(argv = process.argv) {
	const [{ installGaxiosFetchCompat }, { runCli }] = await Promise.all([import("./gaxios-fetch-compat-B7BnjzpF.js"), import("./run-main-DCdmwtnm.js")]);
