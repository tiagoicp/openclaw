...
import { n as getMemorySearchManager, r as resolveMemoryBackendConfig } from "./search-manager-VGSYs6ud.js";
...
import { n as addGatewayServiceCommands } from "./daemon-cli-VdRA1p29.js";
...
import { r as resolveConfiguredDeferredChannelPluginIds } from "./channel-plugin-ids-o8OEmREE.js";
import { a as buildBaseHints, i as applySensitiveHints, n as redactConfigSnapshot, o as mapSensitivePaths, r as restoreRedactedValues, s as applyDerivedTags, t as redactConfigObject } from "./redact-snapshot-Dt1bvJAQ.js";
...
import { h as pickGatewaySelfPresence, t as getStatusSummary } from "./status.summary-BW7wkskn.js";
import { n as resolveHeartbeatIntervalMs, t as isHeartbeatEnabledForAgent } from "./heartbeat-summary-ipYnu6uq.js";
import { i as styleHealthChannelLine, n as getHealthSnapshot, t as formatHealthChannelLines } from "./health-NCGv6QEu.js";
...
import { g as computePreviousRunAtMs, h as computeNextRunAtMs, m as coerceFiniteScheduleNumber, p as normalizeStoredCronJobs, t as runGatewayUpdate } from "./update-runner-C0DTmOuf.js";
...
import { t as buildChannelAccountSnapshot } from "./status-5DqA77FN.js";
import "./status-0a4bK1vE.js";
import "./node-service-B05RDgoZ.js";
import "./channels-status-issues-D92fLnot.js";
import "./channels-c0URgPsP.js";
...
const nodeHandlers = {
	...
	"node.event": async ({ params, respond, context, client }) => {
		...
		await respondUnavailableOnThrow(respond, async () => {
			const { handleNodeEvent } = await import("./server-node-events-DL4xkcoA.js");
...
async function startGatewayServer(port = 18789, opts = {}) {
	...
	if (!minimalTestGateway) (async () => {
		...
		const { deliverOutboundPayloads } = await import("./deliver-qujPZUcS.js");
