...
import { r as DEFAULT_BOOTSTRAP_FILENAME } from "./workspace-Dphk4K2m.js";
import { i as isSystemdUserServiceAvailable } from "./systemd-C3qt0ip4.js";
...
import { n as listConfiguredWebSearchProviders } from "./runtime-AGM5zWhq.js";
...
import { n as openUrl, t as detectBrowserOpenSupport } from "./browser-open-pXCCKIYi.js";
import { i as formatControlUiSshHint, m as waitForGatewayReachable, u as probeGatewayReachable } from "./onboard-helpers-DF7PxzmN.js";
...
import { t as runTui } from "./tui-Cqd0UBL3.js";
...
function loadOnboardSearchModule() {
	onboardSearchModulePromise ??= import("./onboard-search-BFS866CR.js");
...
async function finalizeSetupWizard(options) {
	...
	if (process.platform === "linux" && systemdAvailable) {
		const { ensureSystemdUserLingerInteractive } = await import("./systemd-linger-Craj9Yrl.js");
