...
import { By as hasPotentialConfiguredChannels } from "./auth-profiles-Djd2VmMW.js";
import { K as normalizeTrustedSafeBinDirs } from "./io-BLrYinYw.js";
import { a as hasConfiguredSecretInput } from "./types.secrets-Mh0km-xK.js";
import { n as formatPermissionRemediation, r as inspectPathPermissions, t as formatPermissionDetail } from "./audit-fs-CKHUnnaF.js";
import { N as resolveSandboxConfigForAgent } from "./tool-policy-match-DO-I18kG.js";
import { m as resolveGatewayAuth, n as resolveBrowserConfig, r as resolveProfile } from "./config-DDXUFMD9.js";
import { t as formatCliCommand } from "./command-format-BGWw_xvQ.js";
import { et as resolveBrowserControlAuth, f as redactCdpUrl } from "./routes-D_PnVmld.js";
import { d as isBlockedHostnameOrIp, p as isPrivateNetworkAllowedByPolicy } from "./proxy-env-TLeMux0w.js";
...
async function loadChannelPlugins() {
	channelPluginsModulePromise ??= import("./plugins-WcXsD6rz.js");
	return await channelPluginsModulePromise;
}
async function loadAuditNonDeepModule() {
	auditNonDeepModulePromise ??= import("./audit.nondeep.runtime-Ih4jzpeo.js");
	return await auditNonDeepModulePromise;
}
async function loadAuditDeepModule() {
	auditDeepModulePromise ??= import("./audit.deep.runtime-BJD5SfD8.js");
	return await auditDeepModulePromise;
}
async function loadAuditChannelModule() {
	auditChannelModulePromise ??= import("./audit-channel.collect.runtime-mtxr_OJl.js");
	return await auditChannelModulePromise;
}
async function loadGatewayProbeDeps() {
	gatewayProbeDepsPromise ??= Promise.all([
		import("./call-Bi6xuKqW.js"),
		import("./probe-auth-gbBcnlUl.js"),
		import("./probe-CdD0mLg6.js")
