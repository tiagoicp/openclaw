...
const entries = [
	{
		...
		register: async (program) => {
			(await import("./acp-cli-B68r-Zv8.js")).registerAcpCli(program);
		}
	},
	{
		name: "gateway",
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./gateway-cli-CkXsQpqg.js")).registerGatewayCli(program);
		}
	},
	{
		name: "daemon",
	...
	},
	{
		...
		register: async (program) => {
			(await import("./logs-cli-UlAXsX_e.js")).registerLogsCli(program);
		}
	},
	{
		name: "system",
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./system-cli-nXN7KnMd.js")).registerSystemCli(program);
		}
	},
	{
		name: "models",
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./models-cli-Dcoy6126.js")).registerModelsCli(program);
		}
	},
	{
		name: "approvals",
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./exec-approvals-cli-6Rt4zGsJ.js")).registerExecApprovalsCli(program);
		}
	},
	{
		name: "nodes",
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./nodes-cli-giUCP19x.js")).registerNodesCli(program);
		}
	},
	{
		name: "devices",
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./devices-cli-L_MXbtHE.js")).registerDevicesCli(program);
		}
	},
	{
		name: "node",
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./node-cli-CvmgXlMg.js")).registerNodeCli(program);
		}
	},
	{
		name: "sandbox",
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./sandbox-cli-Ds73d3o9.js")).registerSandboxCli(program);
		}
	},
	{
		name: "tui",
		...
		hasSubcommands: false,
		register: async (program) => {
			(await import("./tui-cli-D61gZwi4.js")).registerTuiCli(program);
		}
	},
	{
		name: "cron",
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./cron-cli-A0DjIsYF.js")).registerCronCli(program);
		}
	},
	{
		name: "dns",
	...
	},
	{
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./hooks-cli-BnhefN4T.js")).registerHooksCli(program);
		}
	},
	{
		name: "webhooks",
	...
	},
	{
		...
		hasSubcommands: false,
		register: async (program) => {
			(await import("./qr-cli-CpJKmbwa.js")).registerQrCli(program);
		}
	},
	{
		name: "clawbot",
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./clawbot-cli-Dgn0KAKN.js")).registerClawbotCli(program);
		}
	},
	{
		name: "pairing",
		...
		hasSubcommands: true,
		register: async (program) => {
			const { registerPluginCliCommands } = await import("./cli-DK7ah7ZM.js");
	...
	},
	{
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./plugins-cli-DzQ2iSux.js")).registerPluginsCli(program);
			const { registerPluginCliCommands } = await import("./cli-DK7ah7ZM.js");
			const config = await loadValidatedConfigForPluginRegistration();
			if (config) registerPluginCliCommands(program, config);
		}
	},
	{
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./channels-cli-tp5VGXWu.js")).registerChannelsCli(program);
		}
	},
	{
		name: "directory",
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./directory-cli-ButxbeOH.js")).registerDirectoryCli(program);
		}
	},
	{
		name: "security",
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./security-cli-BY-u1Gyh.js")).registerSecurityCli(program);
		}
	},
	{
		name: "secrets",
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./secrets-cli-BsAfzftu.js")).registerSecretsCli(program);
		}
	},
	{
		name: "skills",
	...
	},
	{
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./update-cli-BNs36bkQ.js")).registerUpdateCli(program);
		}
	},
	{
		name: "completion",
		...
		hasSubcommands: false,
		register: async (program) => {
			(await import("./completion-cli-DnZT9RUq.js")).registerCompletionCli(program);
		}
	}
];
