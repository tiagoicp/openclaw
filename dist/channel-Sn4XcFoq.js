import { Mp as createDefaultChannelRuntimeState, Op as buildProbeChannelStatusSummary, kp as buildRuntimeAccountStatusSnapshot, qt as createMessageToolCardSchema, um as parseFeishuConversationId } from "./auth-profiles-BwxmeQoE.js";
...
import { i as createActionGate } from "./common-B_0mVuwy.js";
import { a as collectAllowlistProviderRestrictSendersWarnings } from "./group-policy-warnings-YpdU_Yps.js";
import { t as createHybridChannelConfigAdapter } from "./channel-config-helpers-BRtPQkQ4.js";
...
import { c as listFeishuAccountIds, d as resolveFeishuCredentials, f as feishuSetupAdapter, i as createFeishuClient, l as resolveDefaultFeishuAccountId, s as listEnabledFeishuAccounts, t as feishuSetupWizard, u as resolveFeishuAccount } from "./feishu-CJo-SqEb.js";
import { i as normalizeFeishuTarget, r as looksLikeFeishuId, t as getFeishuRuntime } from "./runtime-Tl_6iFz9.js";
import { n as listFeishuDirectoryPeers, t as listFeishuDirectoryGroups } from "./directory.static-JzN0UDNs.js";
import { i as resolveFeishuGroupToolPolicy } from "./policy-Cs3-rZZl.js";
...
const loadFeishuChannelRuntime = createLazyRuntimeNamedExport(() => import("./channel.runtime-CPCsG6Hc.js"), "feishuChannelRuntime");
...
const feishuPlugin = {
	...
	gateway: { startAccount: async (ctx) => {
		const { monitorFeishuProvider } = await import("./monitor-CmoxVBmr.js");
		const account = resolveFeishuAccount({
			cfg: ctx.cfg,
