...
import { sn as listConfiguredAccountIds } from "./pi-embedded-DFNOKLyy.js";
...
import { d as requiresExplicitMatrixDefaultAccount, f as resolveConfiguredMatrixAccountIds, h as getMatrixScopedEnvVarNames, m as resolveMatrixDefaultOrOnlyAccountId, n as resolveMatrixAccountStorageRoot, s as resolveMatrixLegacyFlatStoragePaths } from "./helper-api-B-x72re_.js";
import { r as maybeCreateMatrixMigrationSnapshot } from "./matrix-migration-snapshot-Dtxo3Bp6.js";
import { t as require_src } from "./src-ClXgsL9k.js";
import { a as getMatrixRuntime, n as loadMatrixCredentials, t as credentialsMatchConfig } from "./credentials-read-D4kF0cMI.js";
import { $ as MapWithDefault, A as VerifierEvent, E as decodeRecoveryKey, N as Preset, O as VerificationPhase, U as KnownMembership, V as UNREAD_THREAD_NOTIFICATIONS, W as EventType$1, Y as logger, Z as MemoryCryptoStore, a as RoomStateEvent, ct as require_asyncToGenerator, et as deepCopy, it as recursiveMapToObject, j as MatrixScheduler, k as VerificationRequestEvent, l as ClientEvent, nt as isSupportedReceiptType, o as MAX_STICKY_DURATION_MS, ot as UnstableValue, q as TypedEventEmitter, s as MatrixEventEvent, st as require_defineProperty, t as VerificationMethod, u as MatrixClient$1, w as CryptoEvent } from "./types-BlMCBRyo.js";
import { t as fromBuffer } from "./lib-CCLJ6FUn.js";
import { n as TrackType, r as TrackTypeValueToKeyMap } from "./types-DPe4D4G5.js";
import { O as textDecode, S as UINT32_LE, a as UnsupportedFileTypeError, i as InternalParserError, n as CouldNotDetermineFileTypeError } from "./BasicParser-BFPFK_A-.js";
import { l as toRatio, n as decodeString } from "./Util-JdJHDvlk.js";
import { c as TimestampFormat, i as LyricsContentType } from "./ID3v2Token-FwBn95OK.js";
import { t as APEv2Parser } from "./APEv2Parser-w6J7R5XL.js";
import { r as hasID3v1Header } from "./ID3v1Parser-Cs6VoGZh.js";
...
async function loadMatrixCryptoNodeRuntime() {
	matrixCryptoNodeRuntimePromise ??= import("./crypto-node.runtime-C3cKhyGv.js");
...
async function resolveMatrixAuth(params) {
	...
	const loadCredentialsWriter = async () => {
		credentialsWriter ??= await import("./credentials-write.runtime-B9WIg4Dq.js");
...
const mpegParserLoader = {
	...
	async load() {
		return (await import("./MpegParser-CgOQFFz9.js")).MpegParser;
	}
};
//#endregion
...
const apeParserLoader = {
	...
	async load() {
		return (await import("./APEv2Parser-CW0dmfNq.js")).APEv2Parser;
	}
};
//#endregion
...
const asfParserLoader = {
	...
	async load() {
		return (await import("./AsfParser-BSyCC3FB.js")).AsfParser;
	}
};
//#endregion
...
const dsdiffParserLoader = {
	...
	async load() {
		return (await import("./DsdiffParser-DdKAlnc-.js")).DsdiffParser;
	}
};
//#endregion
...
const aiffParserLoader = {
	...
	async load() {
		return (await import("./AiffParser-CKMEQj0y.js")).AIFFParser;
	}
};
//#endregion
...
const dsfParserLoader = {
	...
	mimeTypes: ["audio/dsf"],
	async load() {
		return (await import("./DsfParser-aWz_z-tz.js")).DsfParser;
	}
};
//#endregion
...
const flacParserLoader = {
	...
	async load() {
		return (await import("./FlacParser-IT-UtNKc.js")).FlacParser;
	}
};
//#endregion
...
const matroskaParserLoader = {
	...
	async load() {
		return (await import("./MatroskaParser-O0zgspmo.js")).MatroskaParser;
	}
};
//#endregion
...
const mp4ParserLoader = {
	...
	async load() {
		return (await import("./MP4Parser-pQk4kMcV.js")).MP4Parser;
	}
};
//#endregion
...
const musepackParserLoader = {
	...
	async load() {
		return (await import("./MusepackParser-59mLARq5.js")).MusepackParser;
	}
};
//#endregion
...
const oggParserLoader = {
	...
	async load() {
		return (await import("./OggParser-C1jnL8ej.js")).OggParser;
	}
};
//#endregion
...
const wavpackParserLoader = {
	...
	async load() {
		return (await import("./WavPackParser-BrMGbppa.js")).WavPackParser;
	}
};
//#endregion
...
const riffParserLoader = {
	...
	async load() {
		return (await import("./WaveParser-D0A8h8F3.js")).WaveParser;
	}
};
//#endregion
