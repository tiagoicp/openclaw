...
import { Bi as formatResolvedUnresolvedNote, Zi as buildSingleChannelSecretPromptState, _a as patchNestedChannelConfigSection, ca as createTopLevelChannelGroupPolicySetter, la as mergeAllowFromEntries, ra as createNestedChannelDmPolicy, wa as promptSingleChannelSecretInput } from "./auth-profiles-BwxmeQoE.js";
...
import { c as prepareScopedSetupConfig } from "./setup-helpers-CEgEzTMS.js";
...
import { t as runPluginCommandWithTimeout } from "./run-command-BfLiaIRL.js";
import { n as loadMatrixCredentials, s as getMatrixRuntime, t as credentialsMatchConfig } from "./credentials-IOihXLeg.js";
...
async function resolveMatrixAuth(params) {
	...
	const { loadMatrixCredentials, saveMatrixCredentials, credentialsMatchConfig, touchMatrixCredentials } = await import("./credentials-Ddl4CtyQ.js");
