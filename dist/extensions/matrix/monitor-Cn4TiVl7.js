...
import { n as resolveConfiguredMatrixBotUserIds } from "./accounts-DgCaeFDx.js";
import { d as resolveDefaultGroupPolicy, g as warnMissingProviderGroupPolicyFallbackOnce, m as resolveThreadBindingMaxAgeMsForChannel, p as resolveThreadBindingIdleTimeoutMsForChannel, t as GROUP_POLICY_BLOCKED_LABEL, u as resolveAllowlistProviderRuntimeGroupPolicy } from "./runtime-api-C0MmlxNx.js";
import { n as normalizeMatrixUserId, r as resolveMatrixAllowListMatch, t as normalizeMatrixAllowList } from "./allowlist-oxo2f0OI.js";
import { t as isMatrixQualifiedUserId } from "./target-ids-f9BfmQLF.js";
import { r as isMatrixNotFoundError, t as formatMatrixErrorMessage } from "./errors-Ba5M_uuU.js";
import { a as canonicalizeAllowlistWithResolvedIds, c as formatAllowlistMatchMeta, d as logInboundDrop, f as logTypingFailure, h as toLocationContext, i as buildAllowlistResolutionSummary, l as formatLocationText, m as summarizeMapping, n as resolveMatrixRoomConfig, o as createReplyPrefixOptions, p as patchAllowlistUsersInConfigEntries, r as addAllowlistUserEntriesFromConfigEntry, s as createTypingCallbacks, t as resolveMatrixStoredSessionMeta, u as getAgentScopedMediaLocalRoots } from "./session-store-metadata-DXlMpeXT.js";
import { i as resolveMatrixStateFilePath } from "./storage-CBQyYIrE.js";
import { _ as parsePollStartContent, a as sendMessageMatrix, f as formatPollAsText, h as isPollStartType, m as isPollEventType, t as chunkMatrixText } from "./send-CVKCAx5S.js";
import { i as promoteMatrixDirectRoomCandidate, s as MATRIX_OPENCLAW_FINALIZED_PREVIEW_KEY } from "./direct-management-DPJVY3_G.js";
import { i as isStrictDirectMembership, n as hasDirectMatrixMemberFlag, o as readJoinedMatrixMembers } from "./direct-room-huyBQtDH.js";
...
import { n as LogService } from "./logger-BhK_JhVL.js";
import { i as isMatrixMediaSizeLimitError, r as MatrixMediaSizeLimitError } from "./http-client-BPhGwxx7.js";
import { i as throwIfMatrixStartupAborted, r as isMatrixStartupAbortError } from "./startup-abort-wsWo0T5m.js";
...
import { a as resolveMatrixMessageBody, i as resolveMatrixMessageAttachment, n as formatMatrixMediaUnavailableText, r as formatMatrixMessageText, s as fetchMatrixPollSnapshot, t as formatMatrixMediaTooLargeText } from "./media-text-DUG17az5.js";
import { n as setActiveMatrixClient } from "./active-client-CaJPILsr.js";
import { t as isBunRuntime } from "./runtime-rzhzT7mI.js";
import { i as resolveMatrixAuthContext, r as resolveMatrixAuth, t as backfillMatrixAuthDeviceIdAfterStartup } from "./config-ghiuvBhr.js";
import { i as resolveSharedMatrixClient, n as releaseSharedClientInstance } from "./shared-gksFmjiR.js";
import "./client-D22FT1yq.js";
import { t as resolveMatrixTargets } from "./resolve-targets-CPY38yGN.js";
import { t as formatMatrixEncryptedEventDisabledWarning } from "./encryption-guidance-JMs0IR54.js";
import { a as EventType, i as resolveMatrixThreadRouting, n as resolveMatrixReplyToEventId, o as RelationType, r as resolveMatrixThreadRootId, t as resolveMatrixInboundRoute } from "./route-C3wyn9eG.js";
...
async function loadMatrixDirectRoomDeps() {
	matrixDirectRoomDepsPromise ??= Promise.all([import("./direct-management-DPJVY3_G.js").then((n) => n.t), import("./direct-room-huyBQtDH.js").then((n) => n.t)]).then(([directManagementModule, directRoomModule]) => ({
...
function loadMatrixSendModule() {
	matrixSendModulePromise ??= import("./send-CVKCAx5S.js").then((n) => n.c);
...
function loadMatrixReactionEvents() {
	matrixReactionEventsPromise ??= import("./reaction-events-DImKyASH.js");
	return matrixReactionEventsPromise;
}
function loadMatrixDraftStream() {
	matrixDraftStreamPromise ??= import("./draft-stream-R4dodk87.js");
...
async function loadMatrixStartupMaintenanceDeps() {
	matrixStartupMaintenanceDepsPromise ??= Promise.all([
		import("./config-update-BImKJFKS.js").then((n) => n.t),
		import("./device-health-DotOgVDu.js"),
		import("./profile-BlHu0wDX.js").then((n) => n.n),
		import("./legacy-crypto-restore-bFnPNlQu.js"),
		import("./startup-verification-DgDmKVap.js")
