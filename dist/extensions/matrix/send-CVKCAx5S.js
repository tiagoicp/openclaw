...
import { r as normalizeMatrixResolvableTarget, t as isMatrixQualifiedUserId } from "./target-ids-f9BfmQLF.js";
import { r as buildMatrixReactionContent } from "./reaction-common-BD3zx_W1.js";
import { c as MSC4357_LIVE_KEY, l as MsgType, n as inspectMatrixDirectRooms, o as EventType, r as persistMatrixDirectRoomMapping, u as RelationType } from "./direct-management-DPJVY3_G.js";
import { a as isStrictDirectRoom } from "./direct-room-huyBQtDH.js";
...
async function loadMatrixSendClientRuntime() {
	matrixSendClientRuntimePromise ??= import("./client-bootstrap-DniNHAoQ.js").then((n) => n.t);
...
//#endregion
export { parsePollStartContent as _, sendMessageMatrix as a, send_exports as c, buildPollResultsSummary as d, formatPollAsText as f, parsePollStart as g, isPollStartType as h, reactMatrixMessage as i, resolveMatrixRoomId as l, isPollEventType as m, editMessageMatrix as n, sendPollMatrix as o, formatPollResultsAsText as p, prepareMatrixSingleText as r, sendSingleTextMessageMatrix as s, chunkMatrixText as t, buildPollResponseContent as u, resolvePollReferenceEventId as v };
