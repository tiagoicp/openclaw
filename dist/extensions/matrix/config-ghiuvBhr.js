import { a as resolveMatrixDefaultOrOnlyAccountId, n as requiresExplicitMatrixDefaultAccount, s as resolveMatrixAccountStringValues } from "./account-selection-DkdXH9W5.js";
import { t as getMatrixScopedEnvVarNames } from "./env-vars-CpXNsTJq.js";
import { a as resolveMatrixBaseConfig, r as listNormalizedMatrixAccountIds, t as findMatrixAccountConfig } from "./account-config-BhOcf8Xo.js";
...
import { t as isPrivateOrLoopbackHost } from "./private-network-host-DDD3n0Z4.js";
import { r as repairCurrentTokenStorageMetaDeviceId } from "./storage-CBQyYIrE.js";
...
import { assertHttpUrlTargetsPrivateNetwork as assertHttpUrlTargetsPrivateNetwork$1, isPrivateNetworkOptInEnabled, ssrfPolicyFromDangerouslyAllowPrivateNetwork } from "openclaw/plugin-sdk/ssrf-runtime";
...
async function loadMatrixAuthClientDeps() {
	matrixAuthClientDepsPromise ??= Promise.all([import("./sdk-BfbDwf8U.js").then((n) => n.n), import("./logging-CtTORNqs.js").then((n) => n.n)]).then(([sdkModule, loggingModule]) => ({
...
async function loadMatrixCredentialsReadDeps() {
	matrixCredentialsReadDepsPromise ??= import("./credentials-read-DCrBt2yO.js").then((n) => n.r).then((credentialsReadModule) => ({
...
async function loadMatrixCredentialsWriteRuntime() {
	matrixCredentialsWriteRuntimePromise ??= import("./credentials-write.runtime-CKBt4lyB.js");
	return await matrixCredentialsWriteRuntimePromise;
}
async function loadMatrixSecretInputDeps() {
	matrixSecretInputDepsPromise ??= import("./config-secret-input.runtime-DUbgwgdl.js").then((runtime) => ({ resolveConfiguredSecretInputString: runtime.resolveConfiguredSecretInputString }));
...
async function resolveValidatedMatrixHomeserverUrl(homeserver, opts) {
	...
	await assertHttpUrlTargetsPrivateNetwork$1(normalized, {
...
//#endregion
export { resolveMatrixConfigForAccount as a, resolveValidatedMatrixHomeserverUrl as c, resolveMatrixAuthContext as i, validateMatrixHomeserverUrl as l, hasReadyMatrixEnvAuth as n, resolveMatrixEnvAuthReadiness as o, resolveMatrixAuth as r, resolveScopedMatrixEnvConfig as s, backfillMatrixAuthDeviceIdAfterStartup as t };
