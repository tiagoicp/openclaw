...
import { i as resolveMatrixAccount } from "./accounts-DgCaeFDx.js";
...
import { t as resolveMatrixRoomKeyBackupIssue } from "./backup-health-BrMLCroZ.js";
import { i as setMatrixSdkLogMode, r as setMatrixSdkConsoleLogging } from "./logging-CtTORNqs.js";
import { i as withStartedActionClient, n as withResolvedActionClient } from "./client-Br5d0LpA.js";
import { i as resolveMatrixAuthContext } from "./config-ghiuvBhr.js";
import "./client-D22FT1yq.js";
import { isOpenClawManagedMatrixDevice, summarizeMatrixDeviceHealth } from "./device-health-DotOgVDu.js";
import { n as updateMatrixOwnProfile, t as applyMatrixProfileUpdate } from "./profile-update-BXleU8K-.js";
import { c as getMatrixRoomKeyBackupStatus, h as restoreMatrixRoomKeyBackup, m as resetMatrixRoomKeyBackup, n as bootstrapMatrixVerification, u as getMatrixVerificationStatus, y as verifyMatrixRecoveryKey } from "./verification-DEYCrhXL.js";
...
function loadMatrixActionClientModule() {
	matrixActionClientModulePromise ??= import("./client-Br5d0LpA.js").then((n) => n.t);
	return matrixActionClientModulePromise;
}
function loadMatrixDirectManagementModule() {
	matrixDirectManagementModulePromise ??= import("./direct-management-DPJVY3_G.js").then((n) => n.t);
...
async function addMatrixAccount(params) {
	...
	if (accountConfig.encryption === true) {
		const { maybeBootstrapNewEncryptedMatrixAccount } = await import("./setup-bootstrap-BjCAUikk.js");
