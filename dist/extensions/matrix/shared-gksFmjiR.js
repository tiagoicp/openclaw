...
import { t as awaitMatrixStartupWithAbort } from "./startup-abort-wsWo0T5m.js";
import { i as resolveMatrixAuthContext, r as resolveMatrixAuth } from "./config-ghiuvBhr.js";
...
async function loadMatrixCreateClientDeps() {
	matrixCreateClientDepsPromise ??= import("./create-client-CmmfSaey.js").then((n) => n.n).then((runtime) => ({ createMatrixClient: runtime.createMatrixClient }));
