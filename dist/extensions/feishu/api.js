...
import { a as createFeishuClient, c as inspectFeishuCredentials, d as resolveDefaultFeishuAccountId, f as resolveFeishuAccount, l as listEnabledFeishuAccounts, p as resolveFeishuRuntimeAccount, u as listFeishuAccountIds } from "./probe-moFMgrSp.js";
import { a as jsonToolResult, c as createFeishuToolClient, l as resolveAnyEnabledFeishuToolsConfig, m as normalizeFeishuTarget, n as registerFeishuDriveTools, o as toolExecutionErrorResult, p as looksLikeFeishuId, s as unknownToolActionResult, u as resolveFeishuToolAccount } from "./drive-CtEZq2CU.js";
import { i as resolveFeishuGroupToolPolicy } from "./policy-yBeEgiGs.js";
import { a as parseFeishuTargetId, i as parseFeishuDirectConversationId, n as buildFeishuModelOverrideParentCandidates, r as parseFeishuConversationId, t as buildFeishuConversationId } from "./conversation-id-Y_HL1Mgk.js";
import { a as listFeishuDirectoryGroups, i as registerFeishuChatTools, o as listFeishuDirectoryPeers } from "./chat-CCfKV6oG.js";
import { n as messageActionTargetAliases, t as collectFeishuSecurityAuditFindings } from "./security-audit-B3L4f06k.js";
import { n as collectRuntimeConfigAssignments, r as secretTargetRegistryEntries } from "./secret-contract-CpXK04fx.js";
import { t as resolveFeishuSessionConversation } from "./session-conversation-LQMnXvai.js";
import { i as setFeishuNamedAccountEnabled, n as runFeishuLogin, r as feishuSetupAdapter, t as feishuSetupWizard } from "./setup-surface-BLMOeOlm.js";
...
const loadFeishuChannelRuntime = createLazyRuntimeNamedExport(() => import("./channel.runtime-DxxoMM7h.js"), "feishuChannelRuntime");
...
const feishuPlugin = createChatChannelPlugin({
	base: {
		...
		gateway: { startAccount: async (ctx) => {
			const { monitorFeishuProvider } = await import("./monitor-BCGCjVss.js");
