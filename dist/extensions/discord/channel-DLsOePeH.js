...
import { o as shouldSuppressLocalDiscordExecApprovalPrompt, t as DiscordUiContainer } from "./ui-TmeTCM3s.js";
import { t as getDiscordApprovalCapability } from "./approval-native-Bjl23H66.js";
import { t as discordMessageActions$1 } from "./channel-actions-B7zpIZm7.js";
...
import { t as normalizeExplicitDiscordSessionKey } from "./session-key-normalization-Csdvn9wg.js";
import { n as discordConfigAdapter, r as discordSetupAdapter, t as createDiscordPluginBase } from "./shared-DMNuzVKm.js";
...
const loadDiscordSecurityAuditModule = createLazyRuntimeModule(() => import("./security-audit.runtime-ecPnmUY2.js"));
const loadDiscordResolveChannelsModule = createLazyRuntimeModule(() => import("./resolve-channels-DX0qQeLz.js").then((n) => n.n));
const loadDiscordResolveUsersModule = createLazyRuntimeModule(() => import("./resolve-users-kuX8M8Ao.js").then((n) => n.n));
const loadDiscordThreadBindingsManagerModule = createLazyRuntimeModule(() => import("./thread-bindings.manager-B03xKl7a.js").then((n) => n.a));
const require = createRequire(import.meta.url);
async function loadDiscordProviderRuntime() {
	discordProviderRuntimePromise ??= import("./provider.runtime-Q7ZTATQE.js");
...
async function loadDiscordAuditModule() {
	discordAuditModulePromise ??= import("./audit-UZgffs4W.js").then((n) => n.n);
	return await discordAuditModulePromise;
}
async function loadDiscordSendModule() {
	discordSendModulePromise ??= import("./send-BJB7KJn9.js").then((n) => n.t);
