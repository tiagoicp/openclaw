import { _ as wasSentByBot, a as editMessageTelegram, b as withTelegramApiErrorLogging, g as recordSentMessage, v as buildInlineKeyboard } from "./send--LiRZp6Q.js";
import { o as resolveTelegramAccount, s as resolveTelegramMediaRuntimeOptions } from "./accounts-q2NkR7D9.js";
import { t as normalizeTelegramReplyToMessageId } from "./outbound-params-DGwD1V0i.js";
import { r as resolveTelegramTransport } from "./fetch-DsVI7XW5.js";
...
import { t as createTelegramThreadBindingManager } from "./thread-bindings-17xJvB2Y.js";
import { n as cacheSticker, t as describeStickerImage } from "./sticker-cache-D0o4aQUS.js";
import { n as evaluateTelegramGroupPolicyAccess, t as evaluateTelegramGroupBaseAccess } from "./group-access-Db9WRrf9.js";
import { n as deliverReplies, r as emitInternalMessageSentHook, t as resolveMedia } from "./delivery-CMjeEKRT.js";
...
async function loadTelegramSendRuntime() {
	telegramSendRuntimePromise ??= import("./send--LiRZp6Q.js").then((n) => n.p);
...
async function loadTelegramNativeCommandDeliveryRuntime() {
	telegramNativeCommandDeliveryRuntimePromise ??= import("./bot-native-commands.delivery.runtime-DrDc7YKs.js");
...
async function loadTelegramNativeCommandRuntime() {
	telegramNativeCommandRuntimePromise ??= import("./bot-native-commands.runtime-B5dYgHzm.js");
...
function loadStickerVisionRuntime() {
	stickerVisionRuntimePromise ??= import("./sticker-vision.runtime-CXU-FlTU.js");
	return stickerVisionRuntimePromise;
}
function loadMediaUnderstandingRuntime() {
	mediaUnderstandingRuntimePromise ??= import("./media-understanding.runtime-oOVMXzR8.js");
...
async function loadTelegramMessageContextSessionRuntime(runtime) {
	...
	return {
		...await import("./bot-message-context.session.runtime-POEiZz3h.js"),
		...runtime
	};
}
...
async function loadTelegramMessageContextRuntime() {
	telegramMessageContextRuntimePromise ??= import("./bot-message-context.runtime-wQAV_TNe.js");
