...
import { a as makeProxyFetch, n as resolveTelegramFetch, r as resolveTelegramTransport, t as resolveTelegramApiBase } from "./fetch-DsVI7XW5.js";
...
import { s as isRecoverableTelegramNetworkError, u as isTelegramPollingNetworkError } from "./format-PNdx7BWb.js";
...
function loadAuditMembershipRuntime() {
	auditMembershipRuntimePromise ??= import("./audit-membership-runtime-QsJI-PY2.js");
...
async function loadTelegramActionRuntime() {
	telegramActionRuntimePromise ??= import("./action-runtime-C63Q0sM9.js");
...
async function loadTelegramMonitorPollingRuntime() {
	telegramMonitorPollingRuntimePromise ??= import("./monitor-polling.runtime-BdyzgtMV.js");
...
async function loadTelegramMonitorWebhookRuntime() {
	telegramMonitorWebhookRuntimePromise ??= import("./monitor-webhook.runtime-CNciOLPI.js");
