...
import { Dv as buildApiKeyCredential, Ev as applyAuthProfileConfig, Nm as describeImageWithModel, Nv as normalizeApiKeyInput, Nx as upsertAuthProfile, Pm as describeImagesWithModel, Rv as validateApiKeyInput, jv as ensureApiKeyFromOptionEnvOrPrompt } from "../../auth-profiles-CPtwVkYW.js";
import { D as DEFAULT_CONTEXT_TOKENS } from "../../model-selection-BvgYPMZN.js";
...
import { tn as normalizeModelCompat } from "../../provider-models-mqi97xJa.js";
import { a as applyProviderConfigWithModelCatalog, t as applyAgentDefaultModelPrimary } from "../../provider-onboard-YZwyyz0l.js";
import { c as resolveZaiBaseUrl, i as ZAI_DEFAULT_MODEL_ID, s as buildZaiModelDefinition } from "../../model-definitions-CPk0fx2x.js";
...
import { p as resolveLegacyPiAgentAccessToken, t as fetchZaiUsage } from "../../provider-usage.fetch-Cilv-_i6.js";
...
import { t as detectZaiEndpoint$1 } from "../../zai-Dt0O4O2R.js";
import "../../provider-auth-api-key-DEtAkEdq.js";
import { i as createZaiToolStreamWrapper } from "../../provider-stream-BIzy1_fv.js";
...
function applyZaiProviderConfig(cfg, params) {
	...
	return applyProviderConfigWithModelCatalog(cfg, {
		...
		baseUrl: params?.endpoint ? resolveZaiBaseUrl(params.endpoint) : existingBaseUrl || resolveZaiBaseUrl(),
