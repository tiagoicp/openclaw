...
import { Qn as supportsXHighThinking } from "../../auth-profiles-CPtwVkYW.js";
import { j as formatXHighModelHint, z as normalizeThinkLevel } from "../../model-selection-BvgYPMZN.js";
		...
		async execute(_id, params) {
			...
			try {
				...
				if (schema && typeof schema === "object" && !Array.isArray(schema)) {
					const validate = new AjvPkg.default({
						allErrors: true,
						strict: false
					}).compile(schema);
					if (!validate(parsed)) {
