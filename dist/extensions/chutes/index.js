...
import { Tv as createProviderApiKeyAuthMethod, dy as resolveOAuthApiKeyMarker } from "../../auth-profiles-Djd2VmMW.js";
...
import { B as buildChutesModelDefinition, I as CHUTES_BASE_URL, R as CHUTES_DEFAULT_MODEL_REF, V as discoverChutesModels, z as CHUTES_MODEL_CATALOG } from "../../provider-models-mqi97xJa.js";
...
import "../../github-copilot-auth-G37lNCF2.js";
import { n as loginChutes } from "../../provider-auth-login-DkRXuEs1.js";
...
function applyChutesProviderConfig(cfg) {
	...
	for (const m of CHUTES_MODEL_CATALOG) models[`chutes/${m.id}`] = { ...models[`chutes/${m.id}`] };
