...
import { i as normalizeLowercaseStringOrEmpty$4, o as normalizeOptionalLowercaseString, s as normalizeOptionalString$2 } from "../../string-coerce-BUSzWgUA.js";
...
import { I as requireOpenAllowFrom, b as ReplyRuntimeConfigSchemaShape, h as MarkdownConfigSchema, l as GroupPolicySchema, o as DmPolicySchema } from "../../zod-schema.core-Du3k_7-j.js";
...
import { t as safeParseJsonWithSchema } from "../../zod-parse-DyCUZEvs.js";
...
import { r as deliverFormattedTextWithAttachments } from "../../reply-payload-B7vg_FeY.js";
...
import { r as describeWebhookAccountSnapshot, s as resolveMergedAccountConfig, t as createAccountListHelpers } from "../../account-helpers-Cq1Zr5oH.js";
import { n as resolveAccountWithDefaultFallback } from "../../account-core-BovahHzV.js";
...
import { v as createAllowlistProviderRouteAllowlistWarningCollector } from "../../channel-policy-fpyKQCGQ.js";
...
import "../../channel-targets-DdpMe36e.js";
import { n as logInboundDrop } from "../../logging-D6UFdlyH.js";
import { J as setSetupChannelEnabled, f as createStandardChannelSetupStatus, j as promptParsedAllowFromForAccount, v as mergeAllowFromEntries, z as resolveSetupAccountId } from "../../setup-wizard-helpers-BrpKVoK7.js";
import { i as createPairingPrefixStripper, n as createChannelPairingController, r as createLoggedPairingApprovalNotifier } from "../../channel-pairing-CP5CQA0B.js";
import { d as createDefaultChannelRuntimeState, s as buildWebhookChannelStatusSummary, u as createComputedAccountStatusAdapter } from "../../status-helpers-C-OjDvUo.js";
...
import { d as ssrfPolicyFromPrivateNetworkOptIn, r as createLegacyPrivateNetworkDoctorContract } from "../../ssrf-policy-DpRGHY9E.js";
import "../../ssrf-runtime-CFMDGr4_.js";
import "../../secret-file-runtime-IhkUM7zz.js";
import { l as resolveLoggerBackedRuntime, s as requireChannelOpenAllowFrom, u as runStoppablePassiveMonitor } from "../../extension-shared-B3txLw6Y.js";
...
import { t as getNextcloudTalkRuntime } from "../../runtime-api-DtVGjTZ4.js";
import { n as collectRuntimeConfigAssignments, r as secretTargetRegistryEntries } from "../../secret-contract-ADiCR8nz.js";
...
function normalizeLowercaseStringOrEmpty$3(value) {
	return normalizeOptionalString$1(value)?.toLowerCase() ?? "";
}
function isTruthyEnvValue(value) {
	const normalized = normalizeLowercaseStringOrEmpty$3(value);
...
function resolveNextcloudTalkSecret(cfg, opts) {
	...
	const envSecret = normalizeOptionalString$1(process.env.NEXTCLOUD_TALK_BOT_SECRET);
...
function resolveNextcloudTalkAccount(params) {
	...
	const resolve = (accountId) => {
		...
		return {
			accountId,
			enabled,
			name: normalizeOptionalString$1(merged.name),
			baseUrl,
...
const nextcloudTalkSecurityAdapter = { resolveDmPolicy: createScopedDmSecurityResolver({
	...
	normalizeEntry: (raw) => normalizeLowercaseStringOrEmpty$2(raw.trim().replace(/^(nextcloud-talk|nc-talk|nc):/i, ""))
}) };
const nextcloudTalkPairingTextAdapter = {
	idLabel: "nextcloudUserId",
	message: "OpenClaw: your access has been approved.",
	normalizeAllowEntry: createPairingPrefixStripper(/^(nextcloud-talk|nc-talk|nc):/i, (entry) => normalizeLowercaseStringOrEmpty$2(entry))
};
//#endregion
...
function extractNextcloudTalkHeaders(headers) {
	const getHeader = (name) => {
		const value = headers[name] ?? headers[normalizeLowercaseStringOrEmpty$1(name)];
...
async function handleNextcloudTalkInbound(params) {
	...
	const groupSystemPrompt = normalizeOptionalString$2(roomConfig?.systemPrompt);
...
function normalizeOrigin(value) {
	try {
		return normalizeLowercaseStringOrEmpty$4(new URL(value).origin);
	} catch {
		return null;
	}
}
