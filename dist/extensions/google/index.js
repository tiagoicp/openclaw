...
import { Dh as normalizeBaseUrl, Eh as assertOkOrThrowHttpError, Nm as describeImageWithModel, Oh as postJsonRequest, Pm as describeImagesWithModel, Tv as createProviderApiKeyAuthMethod } from "../../auth-profiles-CPtwVkYW.js";
...
import { Ft as GOOGLE_GEMINI_DEFAULT_MODEL, Ht as cloneFirstTemplateModel, zt as applyGoogleGeminiModelDefault } from "../../provider-models-mqi97xJa.js";
...
import { r as fetchGeminiUsage } from "../../provider-usage.fetch-Cilv-_i6.js";
...
import { n as isWSL2Sync } from "../../wsl-DVP8J-WP.js";
import { n as buildGoogleImageGenerationProvider } from "../../image-generation-D1V-0DOk.js";
import { l as createGoogleThinkingPayloadWrapper } from "../../provider-stream-BIzy1_fv.js";
import "../../provider-usage-B_JD4wEk.js";
import { a as resolveProviderWebSearchPluginConfig, l as resolveCitationRedirectUrl, o as setProviderWebSearchPluginConfigValue } from "../../provider-web-search-DR5xY1kU.js";
...
function resolveGeminiConfig(config, searchConfig) {
...
function resolveGeminiApiKey(gemini) {
	return readConfiguredSecretString(gemini?.apiKey, "plugins.entries.google.config.webSearch.apiKey") ?? readProviderEnvValue(["GEMINI_API_KEY"]);
}
...
function createGeminiToolDefinition(config, searchConfig) {
	return {
		...
		execute: async (args) => {
			...
			if (!apiKey) return {
				...
				message: "web_search (gemini) needs an API key. Set GEMINI_API_KEY in the Gateway environment, or configure plugins.entries.google.config.webSearch.apiKey.",
				docs: "https://docs.openclaw.ai/tools/web"
			};
...
function createGeminiWebSearchProvider() {
	return {
		...
		getCredentialValue: (searchConfig) => {
			const gemini = searchConfig?.gemini;
			return gemini && typeof gemini === "object" && !Array.isArray(gemini) ? gemini.apiKey : void 0;
		},
		...
		createTool: (ctx) => createGeminiToolDefinition(ctx.config, ctx.searchConfig)
	};
}
//#endregion
