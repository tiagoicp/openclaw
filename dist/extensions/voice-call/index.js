...
import { Cs as isRequestBodyLimitError, Es as requestBodyErrorToText, Ts as readRequestBodyWithLimit } from "../../auth-profiles-BwxmeQoE.js";
...
import { A as TtsConfigSchema } from "../../zod-schema.core-Ck0QyHFp.js";
  ...
  <Play loop="0">https://s3.amazonaws.com/com.twilio.music.classical/BusyStrings.mp3</Play>
	...
	*/
	async handleInboundResponse(callId, userMessage) {
		...
		try {
			const { generateVoiceResponse } = await import("../../response-generator-CP5Mvw-2.js");
