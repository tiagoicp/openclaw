...
import { a as resolveNodeProgramArguments, n as resolveDaemonInstallRuntimeInputs, r as resolveDaemonNodeBinDir, t as emitDaemonInstallRuntimeWarning } from "./daemon-install-plan.shared-C4P9ld-H.js";
import { n as VERSION } from "./version-Bk5OW-rN.js";
import { s as buildNodeServiceEnvironment } from "./runtime-paths-DkAqA6Ce.js";
...
import { i as runServiceUninstall, r as runServiceStop, t as runServiceRestart } from "./lifecycle-core-CuHd77rc.js";
import { i as NODE_SYSTEM_RUN_COMMANDS, n as NODE_EXEC_APPROVALS_COMMANDS } from "./node-commands-bL6vUW38.js";
...
import { _ as resolvePlannedSegmentArgv, c as describeInterpreterInlineEval, d as analyzeArgvCommand, l as detectInterpreterInlineEvalArgv, n as evaluateShellAllowlist, t as evaluateExecAllowlist } from "./exec-approvals-allowlist-6Hm2htNt.js";
import { r as resolveExecSafeBinRuntimePolicy, t as isInterpreterLikeSafeBin } from "./exec-safe-bin-runtime-policy-ClUHWlNb.js";
...
import { n as resolveSystemRunCommandRequest, s as normalizeSystemRunApprovalPlan, t as formatExecCommand } from "./system-run-command-5r1ju6Yw.js";
import { t as ensureOpenClawCliOnPath } from "./path-env-D0mEATeb.js";
import { n as loadNodeHostConfig, r as saveNodeHostConfig, t as ensureNodeHostConfig } from "./config-CJV62DKi.js";
import { t as resolveNodeService } from "./node-service-DZfUdeRi.js";
...
async function loadSystemRunConfig(opts) {
	...
	const { loadConfig } = await import("./config-CLxow9pB.js");
	return loadConfig();
}
...
async function loadPluginRegistryLoaderModule() {
	pluginRegistryLoaderModulePromise ??= import("./runtime-registry-loader-DE4V0Oy4.js");
