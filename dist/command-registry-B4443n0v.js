...
import { a as removeCommandByName, i as registerSubCliCommands, o as reparseProgramFromActionArgs } from "./register.subclis-Xbd1QBIM.js";
...
const coreEntries = [
	{
		...
		register: async ({ program }) => {
			(await import("./register.setup-BXOFgeMb.js")).registerSetupCommand(program);
		}
	},
	{
		commands: [{
		...
		register: async ({ program }) => {
			(await import("./register.onboard-CnSeRZfA.js")).registerOnboardCommand(program);
		}
	},
	{
		commands: [{
		...
		register: async ({ program }) => {
			(await import("./register.configure-C3uVWk2_.js")).registerConfigureCommand(program);
		}
	},
	{
		commands: [{
		...
		register: async ({ program }) => {
			(await import("./config-cli-K6r02drT.js")).registerConfigCli(program);
		}
	},
	{
		commands: [{
	...
	},
	{
		...
		register: async ({ program }) => {
			(await import("./register.maintenance-DkKuUdOI.js")).registerMaintenanceCommands(program);
		}
	},
	{
		commands: [{
		...
		register: async ({ program, ctx }) => {
			(await import("./register.message-CdrkHPx0.js")).registerMessageCommands(program, ctx);
		}
	},
	{
		commands: [{
		...
		register: async ({ program }) => {
			(await import("./memory-cli-DnouvPnY.js")).registerMemoryCli(program);
		}
	},
	{
		commands: [{
	...
	},
	{
		...
		register: async ({ program, ctx }) => {
			(await import("./register.agent-DfovHb4k.js")).registerAgentCommands(program, { agentChannelOptions: ctx.agentChannelOptions });
		}
	},
	{
		commands: [
		...
		register: async ({ program }) => {
			(await import("./register.status-health-sessions-Ckzn747v.js")).registerStatusHealthSessionsCommands(program);
		}
	},
	{
		commands: [{
