...
import { t as CONFIG_PATH } from "./paths-C--RM-nt.js";
import "./tmp-openclaw-dir-DHiu0fYi.js";
import { r as theme } from "./theme-CWrxY1-_.js";
import { n as info, t as danger, u as success } from "./globals-ir4cuPXg.js";
...
import { d as readConfigFileSnapshot, g as writeConfigFile, v as validateConfigObjectRaw } from "./io-CT8Gq6Au.js";
import "./host-env-security-d-Ny36Hl.js";
import "./safe-text-C0AOXwdt.js";
import "./version-DI1aYFTb.js";
import { d as resolveSecretInputRef, i as coerceSecretRef, s as isValidEnvSecretRefId } from "./types.secrets-Es1UJmu9.js";
...
import { a as formatExecSecretRefIdValidationMessage, c as isValidSecretProviderAlias, d as validateExecSecretRefId, o as isValidExecSecretRefId, s as isValidFileSecretRefId, u as secretRefKey } from "./ref-contract-BQ1K_5QR.js";
...
import { r as resolveSecretRefValue } from "./resolve-166A8Gzf.js";
...
import { h as resolveConfigSecretTargetByPath, u as discoverConfigSecretTargets } from "./command-secret-targets-CENFEFUU.js";
...
import { a as normalizeConfigIssues, n as formatConfigIssueLines } from "./issue-format-CCL1as7a.js";
import { t as redactConfigObject } from "./redact-snapshot-BXK3wNOu.js";
...
function registerConfigCli(program) {
	const cmd = program.command("config").description("Non-interactive config helpers (get/set/unset/file/validate). Run without subcommand for guided setup.").addHelpText("after", () => `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/config", "docs.openclaw.ai/cli/config")}\n`).option("--section <section>", "Configuration sections for guided setup (repeatable). Use with no subcommand.", (value, previous) => [...previous, value], []).action(async (opts) => {
		const { configureCommandFromSectionsArg } = await import("./configure-MCWxEfAw.js");
