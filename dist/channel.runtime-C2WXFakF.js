...
import { i as getMe, n as ZaloApiError, t as resolveZaloProxyFetch } from "./proxy-DwCpa5QU.js";
import { t as sendMessageZalo } from "./send-EDhWZf7p.js";
...
async function notifyZaloPairingApproval(params) {
	const { resolveZaloAccount } = await import("./accounts-DVAO_gb5.js");
...
async function startZaloGatewayAccount(ctx) {
	...
	const { monitorZaloProvider } = await import("./monitor-m3Ux9JZx.js");
