import { Mp as createDefaultChannelRuntimeState, Op as buildProbeChannelStatusSummary, kp as buildRuntimeAccountStatusSnapshot, qt as createMessageToolCardSchema, um as parseFeishuConversationId } from "./auth-profiles-C1V2x6_A.js";
...
import { c as listFeishuAccountIds, d as resolveFeishuCredentials, f as feishuSetupAdapter, i as createFeishuClient, l as resolveDefaultFeishuAccountId, s as listEnabledFeishuAccounts, t as feishuSetupWizard, u as resolveFeishuAccount } from "./feishu-DF9o3fNz.js";
import { i as normalizeFeishuTarget, r as looksLikeFeishuId, t as getFeishuRuntime } from "./runtime-GK-blqJr.js";
import { n as listFeishuDirectoryPeers, t as listFeishuDirectoryGroups } from "./directory.static-9JcscJqB.js";
...
const loadFeishuChannelRuntime = createLazyRuntimeNamedExport(() => import("./channel.runtime-2OMU8B_1.js"), "feishuChannelRuntime");
...
const feishuPlugin = {
	...
	gateway: { startAccount: async (ctx) => {
		const { monitorFeishuProvider } = await import("./monitor-Bm2PjXlh.js");
		const account = resolveFeishuAccount({
			cfg: ctx.cfg,
