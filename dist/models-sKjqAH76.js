import { n as isRich$1, r as theme, t as colorize } from "./theme-Bnch_o1K.js";
import { S as shortenHomePath } from "./utils-CIAfMgvq.js";
import { g as resolveOpenClawAgentDir, m as resolveAuthStorePathForDisplay } from "./models-config.providers.discovery-CBSen190.js";
import { Ax as listProfilesForProvider, Ev as applyAuthProfileConfig, Gv as resolveApiKeyForProvider, Hf as resolveCommandSecretRefsViaGateway, Ig as discoverAuthStorage, Ix as ensureAuthProfileStore, Jx as resolveAuthProfileDisplayLabel, Kv as resolveAwsSdkEnvVarName, Lc as runEmbeddedPiAgent, Lg as discoverModels, Mx as setAuthProfileOrder, Ng as resolveModelWithRegistry, Nx as upsertAuthProfile, Rg as shouldSuppressBuiltInModel, Rx as loadAuthProfileStoreForRuntime, Uv as hasUsableCustomProviderApiKey, Vv as getCustomProviderApiKey, Yv as resolveUsableCustomProviderApiKey, Zd as describeFailoverError, _i as DEFAULT_OAUTH_WARN_MS, ar as resolvePluginProviders, ay as isNonSecretApiKeyMarker, d as resolveProfileUnusableUntilForDisplay, gi as maskApiKey, gl as loadProviderUsageSummary, i as clearAuthProfileCooldown, n as resolveAuthProfileOrder, qv as resolveEnvApiKey, rh as loadModelCatalog, t as resolveAuthProfileEligibility, vi as buildAuthHealthSummary, xl as formatUsageWindowSummary, yi as formatRemainingShort } from "./auth-profiles-Djd2VmMW.js";
import { C as findNormalizedProviderValue, O as DEFAULT_MODEL, _ as resolveModelRefFromString, c as modelKey, d as parseModelRef, h as resolveDefaultModelForAgent, k as DEFAULT_PROVIDER, m as resolveConfiguredModelRef, r as buildModelAliasIndex, w as normalizeProviderId } from "./model-selection-BvgYPMZN.js";
import { S as toAgentModelListLike, a as resolveAgentDir, b as resolveAgentModelFallbackValues, m as resolveDefaultAgentId, p as resolveAgentWorkspaceDir, s as resolveAgentExplicitModelPrimary, u as resolveAgentModelFallbacksOverride, x as resolveAgentModelPrimaryValue } from "./agent-scope-BvOTVsJZ.js";
import { r as normalizeStringEntries } from "./string-normalization-CnYrQB31.js";
import { g as resolveDefaultAgentWorkspaceDir } from "./workspace-C3BQkKrq.js";
import { Kt as shouldEnableShellEnvFallback, Ut as getShellEnvAppliedKeys, f as readConfigFileSnapshotForWrite, i as createConfigIO, m as setRuntimeConfigSnapshot, s as loadConfig } from "./io-BLrYinYw.js";
import { i as coerceSecretRef, l as normalizeSecretInputString } from "./types.secrets-Mh0km-xK.js";
import { t as parseDurationMs } from "./parse-duration-Bn5FuAH2.js";
import { n as resolveSecretRefString } from "./resolve-OpLtNdHa.js";
import { t as formatCliCommand } from "./command-format-BGWw_xvQ.js";
import { a as resolveSessionTranscriptPath, c as resolveSessionTranscriptsDirForAgent } from "./paths-DkI03UGW.js";
import { i as getModelsCommandSecretTargetIds } from "./command-secret-targets-DoLf7afU.js";
import { m as resolveUsageProviderId } from "./provider-usage.fetch-Cilv-_i6.js";
import { r as withProgressTotals } from "./progress-D69d44Ic.js";
import { r as isWSLEnv } from "./wsl-DVP8J-WP.js";
import { n as stylePromptMessage, r as stylePromptTitle, t as stylePromptHint } from "./prompt-style-BzSNuBnj.js";
import { d as openUrl } from "./onboard-helpers-Bp9X8OX9.js";
import { a as isLocalBaseUrl, c as normalizeAlias, d as resolveModelTarget, f as updateConfig, i as formatTokenK, l as resolveKnownAgentId, n as ensureFlagCompatibility, o as loadValidConfigOrThrow, p as upsertCanonicalModelConfigEntry, r as formatMs, s as mergePrimaryFallbackConfig, t as applyDefaultModelPrimaryUpdate, u as resolveModelKeysFromEntries } from "./shared-D0vQiquy.js";
import { n as logConfigUpdated } from "./logging-DoKPzL8d.js";
import { t as createVpsAwareOAuthHandlers } from "./provider-oauth-flow-DZdWsod0.js";
import { n as renderTable, t as getTerminalTableWidth } from "./table-Crh5QJw9.js";
import { n as redactSecrets } from "./format-CNUAO_-N.js";
import { t as createClackPrompter } from "./clack-prompter-BjFG7rAB.js";
import { i as resolveProviderMatch, n as mergeConfigPatch, r as pickAuthMethod, t as applyDefaultModel } from "./provider-auth-choice-helpers-Crpau6sY.js";
import { t as buildProviderAuthRecoveryHint } from "./provider-auth-guidance-4sYW0l7X.js";
import { t as inferParamBFromIdOrName } from "./model-param-b-eM-r2cj6.js";
...
async function modelsListCommand(opts, runtime) {
	ensureFlagCompatibility(opts);
	const { ensureAuthProfileStore } = await import("./auth-profiles.runtime-BuzGkWez.js");
	const { ensureOpenClawModelsJson } = await import("./models-config-B4nMd3EC.js");
