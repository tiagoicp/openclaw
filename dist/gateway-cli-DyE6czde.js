...
import { n as getMemorySearchManager, r as resolveMemoryBackendConfig } from "./search-manager-B73xZeLt.js";
...
import { p as handleSlackHttpRequest } from "./slack-BsNhit51.js";
...
import { n as addGatewayServiceCommands } from "./daemon-cli-C7sazXAX.js";
...
import { r as resolveConfiguredDeferredChannelPluginIds } from "./channel-plugin-ids-D6Nfhipd.js";
import { a as buildBaseHints, i as applySensitiveHints, n as redactConfigSnapshot, o as mapSensitivePaths, r as restoreRedactedValues, s as applyDerivedTags, t as redactConfigObject } from "./redact-snapshot-CYZuWbC5.js";
...
import { h as pickGatewaySelfPresence, t as getStatusSummary } from "./status.summary-CTq2C4HU.js";
import { n as resolveHeartbeatIntervalMs, t as isHeartbeatEnabledForAgent } from "./heartbeat-summary-BP8wtnQG.js";
import { i as styleHealthChannelLine, n as getHealthSnapshot, t as formatHealthChannelLines } from "./health-C2r0CjXi.js";
...
import { g as computePreviousRunAtMs, h as computeNextRunAtMs, m as coerceFiniteScheduleNumber, p as normalizeStoredCronJobs, t as runGatewayUpdate } from "./update-runner-NhNWejKg.js";
...
import { t as buildChannelAccountSnapshot } from "./status-DneYiwtY.js";
import "./status-CC8_CQNq.js";
import "./node-service-B05RDgoZ.js";
import "./channels-status-issues-D92fLnot.js";
import "./channels-B43EladT.js";
...
const nodeHandlers = {
	...
	"node.event": async ({ params, respond, context, client }) => {
		...
		await respondUnavailableOnThrow(respond, async () => {
			const { handleNodeEvent } = await import("./server-node-events-K3Y8iOoC.js");
...
async function startGatewayServer(port = 18789, opts = {}) {
	...
	if (!minimalTestGateway) (async () => {
		...
		const { deliverOutboundPayloads } = await import("./deliver-aaYhuUb9.js");
