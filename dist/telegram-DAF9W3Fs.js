...
import { $x as createAllowlistProviderRouteAllowlistWarningCollector, Bu as parseTelegramTopicConversation, C as monitorTelegramProvider, Dh as listTelegramAccountIds, Gm as parseTelegramTarget, Hp as sendTypingTelegram, Im as isTelegramExecApprovalClientEnabled, Jm as listTelegramDirectoryGroupsFromConfig, Mm as resolveTelegramGroupToolPolicy, O as buildTelegramExecApprovalButtons, Rm as resolveTelegramExecApprovalTarget, S as probeTelegram, Ym as listTelegramDirectoryPeersFromConfig, _m as parseTelegramReplyToMessageId, ax as defineChannelPluginEntry, bm as normalizeTelegramMessagingTarget, eh as buildTelegramGroupPeerId, fb as buildExecApprovalPendingReplyPayload, gb as resolveExecApprovalCommandDisplay, hp as collectTelegramStatusIssues, ix as createChatChannelPlugin, jh as resolveTelegramAccount, jm as resolveTelegramGroupRequireMention, kp as sendTelegramPayloadMessages, vm as parseTelegramThreadId, ym as looksLikeTelegramTargetId } from "./pi-embedded-DFNOKLyy.js";
...
import { n as collectTelegramUnmentionedGroupIds, t as auditTelegramGroupMembership } from "./audit-D7armGfs.js";
...
import { a as telegramSetupWizard, i as telegramConfigAdapter, n as findTelegramTokenOwnerAccountId, o as telegramSetupAdapter, r as formatDuplicateTelegramTokenReason, t as createTelegramPluginBase } from "./shared-BX6Hkm2i.js";
		...
		lifecycle: {
			onAccountConfigChanged: async ({ prevCfg, nextCfg, accountId }) => {
				if (resolveTelegramAccount({
					...
					const { deleteTelegramUpdateOffset } = await import("./update-offset-store-VcSsVgGp.js");
