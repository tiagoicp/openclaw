...
import { t as parseBooleanValue } from "./boolean-BgLJTske.js";
import { g as resolveConfigDir, l as escapeRegExp, t as CONFIG_DIR, y as resolveUserPath } from "./utils-CIAfMgvq.js";
...
import { a as getRuntimeConfigSnapshot, g as writeConfigFile, i as createConfigIO, s as loadConfig } from "./io-BLrYinYw.js";
import { a as hasConfiguredSecretInput, d as resolveSecretInputRef } from "./types.secrets-Mh0km-xK.js";
import { u as secretRefKey } from "./ref-contract-DVGMsUgm.js";
import { i as resolveSecretRefValues } from "./resolve-OpLtNdHa.js";
import { A as DEFAULT_AI_SNAPSHOT_MAX_CHARS, M as DEFAULT_OPENCLAW_BROWSER_PROFILE_NAME, a as allocateColor, c as isValidProfileName, i as allocateCdpPort, k as DEFAULT_AI_SNAPSHOT_EFFICIENT_MAX_CHARS, l as deriveDefaultBrowserCdpPortRange, m as resolveGatewayAuth, n as resolveBrowserConfig, o as getUsedColors, r as resolveProfile, s as getUsedPorts, t as parseHttpUrl } from "./config-DDXUFMD9.js";
import { t as formatCliCommand } from "./command-format-BGWw_xvQ.js";
import { r as isLoopbackHost } from "./net-BDAb36NC.js";
import { c as hasGatewayPasswordEnvCandidate, d as readGatewayTokenEnv, l as hasGatewayTokenEnvCandidate } from "./credentials-Dlg2fw8S.js";
import { r as ensurePortAvailable } from "./ports-DbHCZ217.js";
import { a as SsrFBlockedError, h as resolvePinnedHostnameWithPolicy, m as resolvePinnedHostname, p as isPrivateNetworkAllowedByPolicy, r as hasProxyEnvConfigured } from "./proxy-env-TLeMux0w.js";
import { a as openFileWithinRoot, c as readLocalFileSafely, t as SafeOpenError } from "./fs-safe-DNTBHVlm.js";
import { n as extensionForMime, t as detectMime } from "./mime-BZfENK18.js";
import { t as rawDataToString } from "./ws-DtCYAeza.js";
import { t as generateSecureToken } from "./secure-random-BiuCTl7V.js";
import { c as resizeToJpeg, i as getImageMetadata, n as buildImageResizeSideGrid, t as IMAGE_REDUCE_QUALITY_STEPS } from "./image-ops-DsrR0jfa.js";
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-CIp3dZjy.js");
	} catch (err) {
...
function createProfileAvailability({ opts, profile, state, getProfileState, setProfileRunning }) {
	...
	const closePlaywrightBrowserConnectionForProfile = async (cdpUrl) => {
		try {
			await (await import("./pw-ai-CIp3dZjy.js")).closePlaywrightBrowserConnection(cdpUrl ? { cdpUrl } : void 0);
		} catch {}
	};
...
async function stopBrowserRuntime(params) {
	...
	try {
		await (await import("./pw-ai-CIp3dZjy.js")).closePlaywrightBrowserConnection();
	} catch {}
}
//#endregion
