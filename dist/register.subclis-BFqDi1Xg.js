...
const entries = [
	{
		...
		register: async (program) => {
			(await import("./acp-cli-DKOn_OI5.js")).registerAcpCli(program);
		}
	},
	{
		name: "gateway",
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./gateway-cli-dS23dQ21.js")).registerGatewayCli(program);
		}
	},
	{
		name: "daemon",
	...
	},
	{
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./models-cli-ehr3GTuw.js")).registerModelsCli(program);
		}
	},
	{
		name: "approvals",
	...
	},
	{
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./sandbox-cli-DUrgsvfN.js")).registerSandboxCli(program);
		}
	},
	{
		name: "tui",
		...
		hasSubcommands: false,
		register: async (program) => {
			(await import("./tui-cli-DOmPgyji.js")).registerTuiCli(program);
		}
	},
	{
		name: "cron",
	...
	},
	{
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./hooks-cli-Cb5s222O.js")).registerHooksCli(program);
		}
	},
	{
		name: "webhooks",
	...
	},
	{
		...
		hasSubcommands: false,
		register: async (program) => {
			(await import("./qr-cli-DGNau5XI.js")).registerQrCli(program);
		}
	},
	{
		name: "clawbot",
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./clawbot-cli-0TN43j2N.js")).registerClawbotCli(program);
		}
	},
	{
		name: "pairing",
	...
	},
	{
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./plugins-cli-y5gU0LwN.js")).registerPluginsCli(program);
			const { registerPluginCliCommands } = await import("./cli-DdQy2nMw.js");
			const config = await loadValidatedConfigForPluginRegistration();
			if (config) registerPluginCliCommands(program, config);
		}
	},
	{
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./channels-cli-B9XIMfiN.js")).registerChannelsCli(program);
		}
	},
	{
		name: "directory",
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./directory-cli-OuAytuZp.js")).registerDirectoryCli(program);
		}
	},
	{
		name: "security",
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./security-cli-TQfANKVK.js")).registerSecurityCli(program);
		}
	},
	{
		name: "secrets",
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./secrets-cli-BuU5zc7h.js")).registerSecretsCli(program);
		}
	},
	{
		name: "skills",
	...
	},
	{
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./update-cli-B0GT5H13.js")).registerUpdateCli(program);
		}
	},
	{
		name: "completion",
		...
		hasSubcommands: false,
		register: async (program) => {
			(await import("./completion-cli-B58sPW6W.js")).registerCompletionCli(program);
		}
	}
];
