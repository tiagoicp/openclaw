...
import { d as requiresExplicitMatrixDefaultAccount } from "./helper-api-BPfY-0H1.js";
...
import { A as normalizeMatrixMessagingTarget, I as resolveDefaultMatrixAccountId, L as resolveMatrixAccount, M as resolveMatrixDirectUserId, N as resolveMatrixTargetIdentity, P as listMatrixAccountIds, R as resolveMatrixAccountConfig, j as normalizeMatrixResolvableTarget } from "./send-DNEq_cLA.js";
import { i as resolveMatrixRoomConfig, n as normalizeMatrixUserId, t as normalizeMatrixAllowList } from "./allowlist-zu9TyQuG.js";
import { n as matrixSetupAdapter } from "./setup-core-Cx5lOMCe.js";
import { z } from "zod";
...
const matrixMessageActions = {
	...
	handleAction: async (ctx) => {
		const { handleMatrixAction } = await import("./tool-actions.runtime-vbVgz7Wq.js");
...
const loadMatrixChannelRuntime = createLazyRuntimeNamedExport(() => import("./channel.runtime-9d49Y1d4.js"), "matrixChannelRuntime");
const meta = {
	id: "matrix",
	label: "Matrix",
...
const matrixPlugin = createChatChannelPlugin({
	base: {
		...
		gateway: { startAccount: async (ctx) => {
			...
			try {
				monitorMatrixProvider = (await import("./monitor-BTMhVTfA.js")).monitorMatrixProvider;
			} finally {
				releaseLock();
			}
