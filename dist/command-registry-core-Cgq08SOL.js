...
import { a as defineImportedCommandGroupSpec, i as buildCommandGroupEntries, o as defineImportedProgramCommandGroupSpecs } from "./register.subclis-core-C-Iwvi1I.js";
...
const coreEntrySpecs = [
	...withProgramOnlySpecs(defineImportedProgramCommandGroupSpecs([
		...
		},
		{
			...
			loadModule: () => import("./register.maintenance-Ci6r1m3w.js"),
			exportName: "registerMaintenanceCommands"
		}
	])),
	defineImportedCommandGroupSpec(["message"], () => import("./register.message-B9g2aN1X.js"), (mod, { program, ctx }) => {
	...
	defineImportedCommandGroupSpec(["agent", "agents"], () => import("./register.agent-DxsNbd14.js"), (mod, { program, ctx }) => {
	...
	...withProgramOnlySpecs(defineImportedProgramCommandGroupSpecs([{
		...
		loadModule: () => import("./register.status-health-sessions-iCDzJhCI.js"),
