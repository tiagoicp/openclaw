...
import { i as getRuntimeConfig, p as readSourceConfigSnapshotForWrite, r as createConfigIO } from "./io-CW6SWMPF.js";
...
import { o as shouldEnableShellEnvFallback, t as getShellEnvAppliedKeys } from "./shell-env-Qv0wgXnA.js";
...
import { b as resolveAgentWorkspaceDir, i as resolveAgentExplicitModelPrimary, s as resolveAgentModelFallbacksOverride, x as resolveDefaultAgentId, y as resolveAgentDir } from "./agent-scope-DsH_ZwEW.js";
import { t as parseDurationMs } from "./parse-duration-6f3-RI10.js";
import "./config-CGntDIeG.js";
import { c as resolveAuthStatePathForDisplay, u as resolveAuthStorePathForDisplay } from "./source-check-Bc8rRw6e.js";
import { a as loadAuthProfileStoreForRuntime, n as ensureAuthProfileStore } from "./store-BkxBSJMW.js";
...
import { u as isNonSecretApiKeyMarker, v as resolveProviderEnvApiKeyCandidates } from "./model-auth-markers-DcExIRpy.js";
import { t as modelKey } from "./model-ref-shared-DH0JOmm_.js";
import { C as parseModelRef, _ as resolveModelRefFromString, c as buildModelAliasIndex, m as resolveConfiguredModelRef, t as isCliProvider, x as modelKey$1 } from "./model-selection-cli-CXSa0KzE.js";
...
import { n as resolveAwsSdkEnvVarName } from "./model-auth-runtime-shared-D8VYLkAp.js";
...
import { a as setAuthProfileOrder, n as listProfilesForProvider, o as upsertAuthProfile } from "./profiles-DGA70W16.js";
import { d as resolveProfileUnusableUntilForDisplay, i as clearAuthProfileCooldown } from "./order-DnyCa__a.js";
import { i as getCustomProviderApiKey, l as resolveUsableCustomProviderApiKey, o as hasUsableCustomProviderApiKey, s as resolveApiKeyForProvider } from "./model-auth-BKyXLO-t.js";
import "./command-secret-gateway-Z0IKx_3N.js";
import { r as getModelsCommandSecretTargetIds } from "./command-secret-targets-FBgrg_Bz.js";
import { n as shouldSuppressBuiltInModel } from "./model-suppression-CVgRl1xL.js";
import { r as resolveModelWithRegistry } from "./model-B7HWI1pe.js";
import { n as validateAnthropicSetupToken } from "./provider-auth-token-DTWQFNU1.js";
import { t as applyAuthProfileConfig } from "./provider-auth-helpers-UDxcHI9h.js";
import { r as withProgressTotals } from "./progress-D743D9W-.js";
...
import { i as resolveProviderMatch, n as applyProviderAuthConfigPatch, r as pickAuthMethod, t as applyDefaultModel } from "./provider-auth-choice-helpers-Cnqbfkkj.js";
import "./list.runtime-DXs6y1wq.js";
import { t as inferParamBFromIdOrName } from "./model-param-b-YYgS74vu.js";
...
async function runProviderAuthMethod(params) {
	...
	await persistProviderAuthResult({
		result: await params.method.run({
			...
			openUrl: async (url) => {
				const { openUrl } = await import("./onboard-helpers-CEupgiJ8.js");
				await openUrl(url);
			},
...
async function removeFallbackCommand(params, modelRaw, runtime) {
	const updated = await updateConfig((cfg) => {
		...
		const targetKey = modelKey$1(resolved.provider, resolved.model);
		...
		const filtered = existing.filter((entry) => {
			...
			return modelKey$1(resolvedEntry.ref.provider, resolvedEntry.ref.model) !== targetKey;
		});
...
async function modelsListCommand(opts, runtime) {
	ensureFlagCompatibility(opts);
	const { ensureAuthProfileStore, ensureOpenClawModelsJson } = await import("./list.runtime-BGB_-sPu.js");
...
function loadProviderUsageRuntime() {
	providerUsageRuntimePromise ??= import("./provider-usage-KUPo1Hdt.js");
	return providerUsageRuntimePromise;
}
function loadProgressRuntime() {
	progressRuntimePromise ??= import("./progress-BtC-aAIi.js");
	return progressRuntimePromise;
}
function loadTerminalTableRuntime() {
	terminalTableRuntimePromise ??= import("./table-DMIMtR8-.js");
	return terminalTableRuntimePromise;
}
function loadListProbeRuntime() {
	listProbeRuntimePromise ??= import("./list.probe-CLvOTHQq.js");
...
async function modelsStatusCommand(opts, runtime) {
	...
	if (missingProvidersInUse.length > 0) {
		const { buildProviderAuthRecoveryHint } = await import("./provider-auth-guidance-DJpDvMnC.js");
		runtime.log("");
