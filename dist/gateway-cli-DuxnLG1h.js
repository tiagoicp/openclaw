import { i as testRegexWithBoundedInput } from "./safe-regex-tLlDZYfM.js";
...
import { a as getLogger, i as getChildLogger, o as getResolvedLoggerSettings } from "./logger-Bisu6sgz.js";
import { _ as resolveStateDir, i as isNixMode, l as resolveGatewayLockDir, o as resolveConfigPath, r as STATE_DIR, t as CONFIG_PATH, u as resolveGatewayPort } from "./paths-D_QmduAc.js";
import "./tmp-openclaw-dir-CEAo8CGE.js";
import { n as isRich, r as theme, t as colorize } from "./theme-Bnch_o1K.js";
import { a as logVerbose, s as setVerbose } from "./globals-CnsLPQis.js";
import { d as setConsoleTimestampPrefix, m as defaultRuntime, r as runtimeForLogger, t as createSubsystemLogger, u as setConsoleSubsystemFilter } from "./subsystem-Dm-AQqmI.js";
import { t as sanitizeForLog } from "./ansi-BMqrB9En.js";
import "./boolean-BgLJTske.js";
import { n as logAcceptedEnvOption, t as isTruthyEnvValue } from "./env-mHZMLTjc.js";
import "./warning-filter-m2BbicIr.js";
import { C as sleep, D as isPlainObject, E as truncateUtf16Safe, S as shortenHomePath, c as ensureDir, l as escapeRegExp, r as clamp, y as resolveUserPath } from "./utils-CIAfMgvq.js";
...
import { B as normalizeUsageDisplay, F as normalizeElevatedLevel, I as normalizeFastMode, O as DEFAULT_MODEL, R as normalizeReasoningLevel, V as normalizeVerboseLevel, d as parseModelRef, f as resolveAllowedModelRef, g as resolveHooksGmailModel, h as resolveDefaultModelForAgent, i as getModelRefStatus, j as formatXHighModelHint, k as DEFAULT_PROVIDER, l as normalizeModelRef, m as resolveConfiguredModelRef, o as isCliProvider, t as buildAllowedModelSet, u as normalizeModelSelection, x as resolveThinkingDefault, y as resolveSubagentConfiguredModelSelection, z as normalizeThinkLevel } from "./model-selection-BvgYPMZN.js";
import { a as resolveAgentDir, f as resolveAgentSkillsFilter, i as resolveAgentConfig, m as resolveDefaultAgentId, n as listAgentEntries, p as resolveAgentWorkspaceDir, r as listAgentIds, u as resolveAgentModelFallbacksOverride, v as resolveSessionAgentId } from "./agent-scope-BvOTVsJZ.js";
import { S as parseAgentSessionKey, c as normalizeAgentId, h as toAgentStoreSessionKey, l as normalizeMainKey, m as toAgentRequestSessionKey, o as classifySessionKeyShape, r as buildAgentMainSessionKey, t as DEFAULT_AGENT_ID, u as resolveAgentIdFromSessionKey, v as isAcpSessionKey, x as isSubagentSessionKey, y as isCronRunSessionKey } from "./session-key-DbuJEGZO.js";
import { n as normalizeAccountId$1, r as normalizeOptionalAccountId, t as DEFAULT_ACCOUNT_ID } from "./account-id-B0Ci-_gE.js";
import { t as matchesSkillFilter } from "./filter-CB7VqccI.js";
import { o as isNotFoundPathError } from "./boundary-path-BVHzCDEE.js";
...
import { n as openBoundaryFile, r as openBoundaryFileSync } from "./boundary-file-read-1knRHcS0.js";
import { a as logWarn, t as logDebug } from "./logger-DcSg74GU.js";
import { n as runCommandWithTimeout, r as runExec } from "./exec-Bwz57vWc.js";
import { t as resolveOpenClawPackageRoot } from "./openclaw-root-n7TjP2uU.js";
import { _ as resolveWorkspaceTemplateDir, a as DEFAULT_IDENTITY_FILENAME, c as DEFAULT_SOUL_FILENAME, d as ensureAgentWorkspace, g as resolveDefaultAgentWorkspaceDir, i as DEFAULT_HEARTBEAT_FILENAME, l as DEFAULT_TOOLS_FILENAME, o as DEFAULT_MEMORY_ALT_FILENAME, p as isWorkspaceSetupCompleted, r as DEFAULT_BOOTSTRAP_FILENAME, s as DEFAULT_MEMORY_FILENAME, t as DEFAULT_AGENTS_FILENAME, u as DEFAULT_USER_FILENAME } from "./workspace-C3BQkKrq.js";
import { C as parseByteSize, D as isAvatarImageDataUrl, Dt as applyLegacyMigrations, E as isAvatarHttpUrl, Et as applyMergePatch, Ht as resolveSubagentMaxConcurrent, Mt as buildTalkConfigResponse, Ot as ensureControlUiAllowedOriginsForNonLoopbackBind, P as applyConfigOverrides, Vt as resolveAgentMaxConcurrent, b as validateConfigObjectWithPlugins, c as parseConfigJson5, d as readConfigFileSnapshot, f as readConfigFileSnapshotForWrite, g as writeConfigFile, i as createConfigIO, j as looksLikeAvatarPath, p as resolveConfigSnapshotHash, s as loadConfig, u as readBestEffortConfig, w as AVATAR_MAX_BYTES, x as OpenClawSchema } from "./io-BLrYinYw.js";
import "./host-env-security-DRYydSLp.js";
import "./safe-text-Bls0e7eh.js";
import { n as VERSION, o as resolveRuntimeServiceVersion } from "./version-BXFMfrjE.js";
import { a as hasConfiguredSecretInput } from "./types.secrets-Mh0km-xK.js";
import "./env-substitution-CCbMWMw3.js";
import { n as isTestDefaultMemorySlotDisabled, r as normalizePluginsConfig } from "./config-state-DxIr_ZFp.js";
import "./includes-Babm_gOl.js";
import "./zod-schema.providers-core-JSZEvSLs.js";
import { l as CHANNEL_IDS } from "./registry-DHFXbGRB.js";
import "./manifest-registry-BN97WD1N.js";
import "./ip-COVlKUC6.js";
import { t as parseDurationMs } from "./parse-duration-Bn5FuAH2.js";
...
import { d as triggerInternalHook, n as createInternalHookEvent, t as clearInternalHooks, u as registerInternalHook } from "./internal-hooks-jmovcAUX.js";
import "./provider-models-mqi97xJa.js";
import "./provider-onboard-YZwyyz0l.js";
import "./model-definitions-CPk0fx2x.js";
import { n as callGateway, u as loadGatewayTlsRuntime$1 } from "./call-BlwEFcjC.js";
import { n as normalizeDeviceAuthScopes } from "./device-auth-DZ3aUFYV.js";
import { t as normalizeDeviceMetadataForAuth } from "./device-metadata-normalization-Bcl5Dpx6.js";
import "./delegate-VRfyt_wr.js";
import { o as getMachineDisplayName } from "./with-timeout-6Mk1JecS.js";
import "./multimodal-BZ5nSU8_.js";
import { t as resolveMemorySearchConfig } from "./memory-search-BEee7lTM.js";
import "./query-expansion-C5OcnmBU.js";
import { n as getMemorySearchManager, r as resolveMemoryBackendConfig } from "./search-manager-CCmW7xrg.js";
import "./setup-binary-BRNtxkNZ.js";
import { f as isWithinDir } from "./signal-cli-install-CazITAFo.js";
import "./identity-file-L2phPATJ.js";
import { f as isKnownSecretTargetId } from "./command-secret-targets-DoLf7afU.js";
import "./pairing-token-D5GBjAVE.js";
import "./delivery-queue-B2kD8cNZ.js";
import { i as isExternalHookSession, n as detectSuspiciousPatterns, r as getHookType, t as buildSafeExternalPrompt } from "./external-content-DohesiX3.js";
...
import { b as saveExecApprovals, c as normalizeExecApprovals, f as readExecApprovalsSnapshot, o as mergeExecApprovalsSocketDefaults, r as ensureExecApprovals, t as DEFAULT_EXEC_APPROVAL_TIMEOUT_MS } from "./exec-approvals-CZGtkt6y.js";
import { _ as resolveSystemRunApprovalRuntimeContext, g as resolveSystemRunApprovalRequestContext, o as parseTimeoutMsWithFallback } from "./nodes-screen-DWWnCUAS.js";
import { a as matchSystemRunApprovalBinding, c as toSystemRunApprovalMismatchError, i as buildSystemRunApprovalEnvBinding, n as resolveSystemRunCommandRequest, o as missingSystemRunApprovalBinding, r as buildSystemRunApprovalBinding } from "./system-run-command-BnhKEiGR.js";
import { i as parseAbsoluteTimeMs, n as resolveCronStaggerMs, r as resolveDefaultCronStaggerMs, t as normalizeCronStaggerMs } from "./stagger-Ds3EfozT.js";
import { t as cleanStaleGatewayProcessesSync } from "./restart-stale-pids-D84WQQ67.js";
import "./provider-usage.fetch-Cilv-_i6.js";
import { o as buildHistoryContextFromEntries } from "./history-CZuN-T_-.js";
...
import { n as runCommandWithRuntime } from "./cli-utils-CreDWcAs.js";
import { t as formatHelpExamples } from "./help-format-zSqk-GrQ.js";
import { n as withProgress } from "./progress-D69d44Ic.js";
import "./shared-TeMeV5_s.js";
import { p as handleSlackHttpRequest } from "./slack-DBxx-epH.js";
import "./daemon-install-plan.shared-Mfqlk9b0.js";
import "./runtime-paths-B5uSIycC.js";
import "./runtime-guard-C9oWXPLS.js";
import "./gateway-install-token-C-clm3hb.js";
import { i as resolveAssistantAvatarUrl, n as buildControlUiAvatarUrl, r as normalizeControlUiBasePath, t as CONTROL_UI_AVATAR_PREFIX } from "./control-ui-shared-JKAx8vLp.js";
import "./prompt-style-BzSNuBnj.js";
import { c as handleReset } from "./onboard-helpers-D1z7-ld8.js";
import "./runtime-parse-DZJYFtfM.js";
import { p as scheduleDetachedLaunchdRestartHandoff } from "./launchd-CUHdrK0Y.js";
import { c as parseProcCmdline, s as isGatewayArgv } from "./service-DHyV2roU.js";
import "./systemd-BHvqbPC4.js";
import "./shared-D8ZesWgj.js";
import "./systemd-hints-DN8g-8yR.js";
import { t as parsePort } from "./parse-port-DZeY6VX0.js";
import { n as addGatewayServiceCommands } from "./daemon-cli-C8wh7tyA.js";
import { t as probeGateway } from "./probe-Dtp7fztw.js";
import { n as formatConfigIssueLines } from "./issue-format-DHdfT94W.js";
import "./lifecycle-core-C7Kg7MhG.js";
import "./status-B4bzYWj7.js";
import "./diagnostics-DxxPGaZ_.js";
import "./inspect-CmEfgEhG.js";
import "./probe-auth-f_duLt2h.js";
import { t as WizardCancelledError } from "./prompts-nwZDeFSs.js";
import "./slack-core-B43-CO_N.js";
import "./replies-BGAUgTEs.js";
import { a as rejectDevicePairing, c as revokeDeviceToken, d as updatePairedDeviceMetadata, f as verifyDeviceToken, i as listDevicePairing, l as rotateDeviceToken, m as roleScopesAllow, n as ensureDeviceToken, o as removePairedDevice, p as resolveMissingRequestedScope, r as getPairedDevice, s as requestDevicePairing, t as approveDevicePairing, u as summarizeDeviceTokens } from "./device-pairing-CopIq_M4.js";
import { n as verifyDeviceBootstrapToken } from "./device-bootstrap-CDhJgbMw.js";
import "./agent-08v5LMoR.js";
import { n as resolveHookConfig, r as shouldIncludeHook } from "./config-C32djeDs.js";
...
import { n as DEFAULT_GATEWAY_HTTP_TOOL_DENY } from "./dangerous-tools-Dzu49HNa.js";
import { t as readSecretFromFile } from "./secret-file-C5qwEklH.js";
import { r as resolveConfiguredDeferredChannelPluginIds } from "./channel-plugin-ids-zESQoye8.js";
import { a as buildBaseHints, i as applySensitiveHints, n as redactConfigSnapshot, o as mapSensitivePaths, r as restoreRedactedValues, s as applyDerivedTags, t as redactConfigObject } from "./redact-snapshot-BXvSI995.js";
import "./table-Crh5QJw9.js";
import { n as resolveWideAreaDiscoveryDomain, r as writeWideAreaGatewayZone } from "./widearea-dns-DImYZKmB.js";
import { i as toOptionString, n as extractGatewayMiskeys, r as maybeExplainGatewayServiceStop, t as describeUnknownError } from "./shared-Ckz29JCo.js";
import { t as discoverGatewayBeacons } from "./bonjour-discovery-Ca0MK6-r.js";
import { h as pickGatewaySelfPresence, t as getStatusSummary } from "./status.summary-Cb2oA0Ym.js";
import { n as resolveHeartbeatIntervalMs, t as isHeartbeatEnabledForAgent } from "./heartbeat-summary-5ktB2Pz7.js";
import { i as styleHealthChannelLine, n as getHealthSnapshot, t as formatHealthChannelLines } from "./health-DK9uTHu_.js";
import { a as resolveControlUiRootOverrideSync, n as isPackageProvenControlUiRootSync, o as resolveControlUiRootSync, t as ensureControlUiAssetsBuilt } from "./control-ui-assets-DWV6EKr5.js";
import { a as resolveNpmChannelTag, n as compareSemverStrings, p as normalizeUpdateChannel, t as checkUpdateStatus } from "./update-check-BfU_cB3L.js";
import "./setup.secret-input-Dn1VohGi.js";
import { t as runSetupWizard } from "./setup-DeG2xEeA.js";
import { a as resolveApnsAuthConfigFromEnv, c as shouldClearStoredApnsRegistration, d as parseMessageWithAttachments, f as formatForLog, g as setGatewayWsLogStyle, h as summarizeAgentEventForWsLog, l as resolveApnsRelayConfigFromEnv, m as shouldLogWs, n as loadApnsRegistration, o as sendApnsAlert, p as logWs, r as normalizeApnsEnvironment, s as sendApnsBackgroundWake, t as clearApnsRegistrationIfCurrent, u as normalizeRpcAttachmentsToChatAttachments } from "./push-apns-DTP9WV7y.js";
import { _ as buildGogWatchStartArgs, g as buildGogWatchServeArgs, i as ensureTailscaleEndpoint, w as resolveGmailHookRuntimeConfig } from "./gmail-setup-utils-BltZhriW.js";
import { g as computePreviousRunAtMs, h as computeNextRunAtMs, m as coerceFiniteScheduleNumber, p as normalizeStoredCronJobs, t as runGatewayUpdate } from "./update-runner-Dqw29tRu.js";
import { i as loadAgentIdentity, o as pruneAgentConfig, r as findAgentEntryIndex, t as applyAgentConfig } from "./agents.config-CtADkPCU.js";
import { n as isNodeCommandAllowed, r as resolveNodeCommandAllowlist } from "./node-command-policy-CBEGR12e.js";
import { t as buildChannelAccountSnapshot } from "./status-BVuPREOW.js";
import "./status-D6J78WRl.js";
import "./node-service-B05RDgoZ.js";
import "./channels-status-issues-D92fLnot.js";
import "./channels-CZU8aKqY.js";
import "./status.update-CIPVqugw.js";
import "./skill-scanner-D9Zv-wTU.js";
import { t as installSkill } from "./skills-install-Dtc_OLCa.js";
import { t as resolveAllowedAgentIds } from "./hooks-policy-OMduLyKo.js";
import { t as collectEnabledInsecureOrDangerousFlags } from "./dangerous-config-flags-D4n7SZCj.js";
import { t as loadWorkspaceHookEntries } from "./workspace-CkXlVLL7.js";
import { n as forceFreePortAndWait, r as waitForPortBindable } from "./ports-CY1-zNF2.js";
...
function loadSshConfigModule() {
	sshConfigModulePromise ??= import("./ssh-config-dzsiEY-x.js");
	return sshConfigModulePromise;
}
function loadSshTunnelModule() {
	sshTunnelModulePromise ??= import("./ssh-tunnel-DGD2fCoC.js");
...
const nodeHandlers = {
	...
	"node.event": async ({ params, respond, context, client }) => {
		...
		await respondUnavailableOnThrow(respond, async () => {
			const { handleNodeEvent } = await import("./server-node-events-CrXv_N7M.js");
...
const usageHandlers = {
	...
	"sessions.usage.logs": async ({ respond, params }) => {
		...
		if (!resolved) return;
		const { config, entry, agentId, sessionId, sessionFile } = resolved;
		const { loadSessionLogs } = await import("./session-cost-usage-Jt1MZIOb.js");
...
async function startBrowserControlServerIfEnabled() {
	...
	const mod = override ? await import(override) : await import("./server-5ujr3hsF.js");
...
async function startGatewayServer(port = 18789, opts = {}) {
	...
	if (!minimalTestGateway) (async () => {
		const { recoverPendingDeliveries } = await import("./delivery-queue-st0hkMAU.js");
		const { deliverOutboundPayloads } = await import("./deliver-BZPicMtV.js");
