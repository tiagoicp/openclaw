...
import { t as isChannelVisibleInConfiguredLists } from "./exposure-D14nkfqK.js";
...
import { i as loadAuthProfileStore } from "./store-BkxBSJMW.js";
import "./plugins-RAm7ylrL.js";
import "./logging-BZmmoywx.js";
import { c as resolveMessageActionDiscoveryForPlugin, r as createMessageActionDiscoveryContext } from "./message-action-discovery-D46AojW4.js";
...
import { i as resolveChannelDefaultAccountId, r as parseOptionalDelimitedEntries } from "./helpers-CRMEpaC8.js";
import { c as moveSingleAccountChannelSectionToDefaultAccount } from "./setup-helpers-DxNOfWja.js";
...
import { n as hasResolvedCredentialValue, t as hasConfiguredUnavailableCredentialStatus } from "./account-snapshot-fields-DRtPSPvj.js";
import { n as formatUsageReportLines, t as loadProviderUsageSummary } from "./provider-usage-C-xctyHm.js";
import { t as resolveCommandConfigWithSecrets } from "./command-config-resolution-C_yyyR5s.js";
import { n as resolveInstallableChannelPlugin } from "./channel-plugin-resolution-D1Xf9Geb.js";
import { t as parseLogLine } from "./parse-log-line-DJvembfl.js";
import { r as describeBinding, t as applyAgentBindings } from "./agents.bindings-BTEqe2_l.js";
import { n as requireValidConfigSnapshot, t as requireValidConfigFileSnapshot } from "./config-validation-BBgMmjhM.js";
import { t as collectChannelStatusIssues } from "./channels-status-issues-IZ03Vdz3.js";
import { n as buildReadOnlySourceChannelAccountSnapshot, t as buildChannelAccountSnapshot } from "./status-DND2C0ew.js";
...
function loadChannelSetupPluginInstall() {
	channelSetupPluginInstallPromise ??= import("./plugin-install-CdFLBOIc.js");
	return channelSetupPluginInstallPromise;
}
function loadOnboardChannels() {
	onboardChannelsPromise ??= import("./onboard-channels-Bn13PPwA.js");
	return onboardChannelsPromise;
}
async function resolveCatalogChannelEntry(raw, cfg) {
	const trimmed = normalizeOptionalLowercaseString(raw);
	if (!trimmed) return;
	const { listChannelPluginCatalogEntries } = await import("./catalog-MqCpWpZT.js");
...
async function channelsAddCommand(opts, runtime = defaultRuntime, params) {
	...
	if (shouldUseWizard(params)) {
		const [{ buildAgentSummaries }, onboardChannels] = await Promise.all([import("./agents.config-BRsLogLM.js"), loadOnboardChannels()]);
	...
	if (!channel && catalogEntry) {
		...
		const { isCatalogChannelInstalled } = await import("./discovery-Bcz9B6jF.js");
...
async function channelsRemoveCommand(opts, runtime = defaultRuntime, params) {
	...
	const resolvedPluginState = !useWizard && rawChannel && (!channel || !getChannelPlugin(channel)) ? await (async () => {
		const { resolveInstallableChannelPlugin } = await import("./channel-plugin-resolution-CotcC0r2.js");
