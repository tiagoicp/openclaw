import { o as getResolvedLoggerSettings } from "./logger-Bisu6sgz.js";
import { _ as resolveStateDir, d as resolveIsNixMode, h as resolveOAuthDir, t as CONFIG_PATH, u as resolveGatewayPort, x as resolveRequiredHomeDir } from "./paths-D_QmduAc.js";
import { m as defaultRuntime } from "./subsystem-Dm-AQqmI.js";
import { t as isTruthyEnvValue$1 } from "./env-mHZMLTjc.js";
import { C as sleep, S as shortenHomePath, y as resolveUserPath } from "./utils-CIAfMgvq.js";
import "./models-config.providers.discovery-CBSen190.js";
import { $d as resolveBootstrapContextForRun, Dx as repairOAuthProfileIdMismatch, Ex as resolveApiKeyForProfile, Gv as resolveApiKeyForProvider, Hb as loadCronStore, Hx as updateAuthProfileStoreWithLock, Ix as ensureAuthProfileStore, Tx as resolveBootstrapTotalMaxChars, Ub as resolveCronStorePath, Wb as saveCronStore, Xs as buildPluginCompatibilityWarnings, _i as DEFAULT_OAUTH_WARN_MS, ar as resolvePluginProviders, d as resolveProfileUnusableUntilForDisplay, gf as buildBootstrapInjectionStats, hf as analyzeBootstrapBudget, or as loadOpenClawPlugins, ox as resolveMainSessionKey, pb as loadSessionStore, rh as loadModelCatalog, vi as buildAuthHealthSummary, wx as resolveBootstrapMaxChars, y as resolveAgentSessionDirs, yi as formatRemainingShort, zp as hasConfiguredMemorySecretInput } from "./auth-profiles-Djd2VmMW.js";
import { O as DEFAULT_MODEL, g as resolveHooksGmailModel, i as getModelRefStatus, k as DEFAULT_PROVIDER, m as resolveConfiguredModelRef } from "./model-selection-BvgYPMZN.js";
import { a as resolveAgentDir, m as resolveDefaultAgentId, p as resolveAgentWorkspaceDir } from "./agent-scope-BvOTVsJZ.js";
import { S as parseAgentSessionKey } from "./session-key-DbuJEGZO.js";
...
import { t as DEFAULT_AGENTS_FILENAME } from "./workspace-C3BQkKrq.js";
import { d as readConfigFileSnapshot, g as writeConfigFile } from "./io-BLrYinYw.js";
import { a as hasConfiguredSecretInput, d as resolveSecretInputRef } from "./types.secrets-Mh0km-xK.js";
import { P as resolveSandboxScope, Q as DEFAULT_SANDBOX_BROWSER_IMAGE, et as DEFAULT_SANDBOX_IMAGE, k as cleanStaleLockFiles } from "./tool-policy-match-DO-I18kG.js";
import { m as resolveGatewayAuth } from "./config-DDXUFMD9.js";
import { t as formatCliCommand } from "./command-format-BGWw_xvQ.js";
import { r as isLoopbackHost, u as resolveGatewayBindHost } from "./net-BDAb36NC.js";
import { d as readGatewayTokenEnv } from "./credentials-Dlg2fw8S.js";
import { C as parseBrowserMajorVersion, T as resolveGoogleChromeExecutableForPlatform, at as resolveConfiguredSecretInputWithFallback, ct as hasAmbiguousGatewayAuthModeConfig, w as readBrowserVersion } from "./routes-D_PnVmld.js";
import { a as inspectPortUsage, c as formatPortDiagnostics } from "./ports-DbHCZ217.js";
import { n as isPrimarySessionTranscriptFileName, t as formatSessionArchiveTimestamp } from "./artifacts-BQFwsgjR.js";
import { n as listChannelPlugins } from "./registry-u4-bSC0t.js";
import { c as resolveSessionTranscriptsDirForAgent, i as resolveSessionFilePathOptions, l as resolveStorePath, r as resolveSessionFilePath } from "./paths-DkI03UGW.js";
import { r as resolveDmAllowState } from "./dm-policy-shared-DR-r8JQl.js";
import { n as callGateway, t as buildGatewayConnectionDetails } from "./call-CuSVmxO6.js";
import { t as resolveMemorySearchConfig } from "./memory-search-BEee7lTM.js";
import { r as resolveMemoryBackendConfig } from "./search-manager-APT1_VU4.js";
import { f as resolveGatewaySystemdServiceName, h as resolveNodeLaunchAgentLabel, l as resolveGatewayLaunchAgentLabel, p as resolveGatewayWindowsTaskName } from "./constants-DY-Ct-OW.js";
import { r as isWSLEnv, t as isWSL } from "./wsl-DVP8J-WP.js";
import { a as resolveSystemNodeInfo, r as renderSystemNodeWarning } from "./runtime-paths-B5uSIycC.js";
import { n as buildGatewayInstallPlan, r as gatewayInstallErrorHint, t as resolveGatewayInstallToken } from "./gateway-install-token-C02ehIvk.js";
import { n as GATEWAY_DAEMON_RUNTIME_OPTIONS, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-Dotd3w7r.js";
import { n as stylePromptMessage, r as stylePromptTitle, t as stylePromptHint } from "./prompt-style-BzSNuBnj.js";
import { f as printWizardHeader, m as randomToken, n as applyWizardMetadata, s as guardCancel } from "./onboard-helpers-Bp9X8OX9.js";
import { i as launchAgentPlistExists, n as isLaunchAgentListed, r as isLaunchAgentLoaded, s as repairLaunchAgentBootstrap } from "./launchd-CUHdrK0Y.js";
import { n as resolveGatewayService, t as describeGatewayServiceRestart } from "./service-DHyV2roU.js";
import { i as isSystemdUserServiceAvailable, u as uninstallLegacySystemdUnits } from "./systemd-BHvqbPC4.js";
import { c as buildPlatformRuntimeLogHints, i as auditGatewayServiceConfig, n as renderSystemdUnavailableHints, o as needsNodeRuntimeMigration, r as SERVICE_AUDIT_CODES, s as readEmbeddedGatewayToken, t as isSystemdUnavailableDetail, u as formatRuntimeStatus } from "./systemd-hints-DN8g-8yR.js";
import { t as readLastGatewayErrorLine } from "./diagnostics-DxxPGaZ_.js";
import { n as renderGatewayServiceCleanupHints, t as findExtraGatewayServices } from "./inspect-CmEfgEhG.js";
import { n as logConfigUpdated } from "./logging-DoKPzL8d.js";
import { t as note$1 } from "./note-xP9K_bzf.js";
import { n as noteOpenAIOAuthTlsPrerequisites } from "./provider-openai-codex-oauth-tls-CPwJCo_a.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-Bn7DAe6A.js";
import { r as healthCommand } from "./health-DZdFkqvi.js";
import { i as resolveControlUiDistIndexPathForRoot, r as resolveControlUiDistIndexHealth } from "./control-ui-assets-DWV6EKr5.js";
import { p as normalizeStoredCronJobs, t as runGatewayUpdate } from "./update-runner-CAPQfC51.js";
import { t as collectChannelStatusIssues } from "./channels-status-issues-D92fLnot.js";
import { n as resolveProviderAuthLoginCommand, t as buildProviderAuthRecoveryHint } from "./provider-auth-guidance-4sYW0l7X.js";
import { t as ensureSystemdUserLingerInteractive } from "./systemd-linger-B8hwhsjm.js";
import { t as formatHealthCheckFailure } from "./health-format-BYazdzNB.js";
import { n as doctorShellCompletion } from "./doctor-completion-DDqw9fqS.js";
import { a as runLegacyStateMigrations, i as detectLegacyStateMigrations, r as loadAndMaybeMigrateDoctorConfig } from "./doctor-config-flow-DRH2Xabl.js";
import { t as resolveDefaultChannelAccountContext } from "./channel-account-context-BmwsjEnw.js";
