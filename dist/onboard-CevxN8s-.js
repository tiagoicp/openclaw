...
import { h as restoreTerminalState, m as defaultRuntime } from "./subsystem-DZirmh0Z.js";
...
import { s as isValidEnvSecretRefId } from "./types.secrets-Es1UJmu9.js";
...
import "./daemon-runtime-B5n1n7iD.js";
import { a as ensureWorkspaceAndSessions, b as waitForGatewayReachable, c as handleReset, g as resolveControlUiLinks, m as randomToken, n as applyWizardMetadata, t as DEFAULT_WORKSPACE, u as normalizeGatewayTokenInput } from "./onboard-helpers-igIv5Vw8.js";
...
import { i as resolveManifestProviderOnboardAuthFlags } from "./provider-auth-choices-DT6nJ6ft.js";
import { n as isDeprecatedAuthChoice, r as normalizeLegacyOnboardAuthChoice } from "./auth-choice-legacy-B8K_oTxG.js";
...
async function collectGatewayHealthFailureDiagnostics() {
	const diagnostics = {};
	try {
		const { resolveGatewayService } = await import("./service-CFJYFrNa.js");
	...
	try {
		const { readLastGatewayErrorLine } = await import("./diagnostics-B4sHWkN5.js");
...
async function runNonInteractiveLocalSetup(params) {
	...
	if (authChoice !== "skip") {
		const { applyNonInteractiveAuthChoice } = await import("./auth-choice-Bpzkfpve.js");
	...
	if (opts.installDaemon) {
		const { installGatewayDaemonNonInteractive } = await import("./daemon-install-Dn1iz-jM.js");
