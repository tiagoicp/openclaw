...
import { Ad as truncateSlackText, Cd as normalizeSlackAllowOwnerEntry, Dt as dispatchPluginInteractiveHandler, Dv as resolveNativeCommandSessionTargets, Ed as resolveSlackUserAllowed, Fv as hasControlCommand, Gd as sendMessageSlack, Gv as resolveEnvelopeFormatOptions, Hd as removeSlackReaction, Jd as normalizeSlackOutboundText, Kd as SLACK_TEXT_LIMIT, Mv as resolveMentionGatingWithBypass, Nd as editSlackMessage, Nv as createChannelInboundDebouncer, Pv as shouldDebounceTextInbound, Qb as buildAllowlistResolutionSummary, Qd as resolveSlackThreadStarter, Qv as dispatchInboundMessage, Sd as normalizeAllowListLower, Td as resolveSlackAllowListMatch, Uv as formatInboundEnvelope, Xd as resolveSlackMedia, Yd as resolveSlackAttachmentContent, Zb as addAllowlistUserEntriesFromConfigEntry, Zd as resolveSlackThreadHistory, bd as allowListMatches, cd as recordSlackThreadParticipation, df as resolveSlackAccount, ef as createSlackWebClient, ex as mergeAllowlist, ff as resolveSlackReplyToMode, gd as registerSlackHttpHandler, hd as normalizeSlackWebhookPath, jd as deleteSlackMessage, mf as resolveSlackBotToken, nf as require_dist$5, nx as summarizeMapping, pS as resolveChannelConfigWrites, pf as resolveSlackAppToken, rf as require_eventemitter3, ry as createReplyDispatcherWithTyping, sd as hasSlackThreadParticipation, tf as resolveSlackWebClientOptions, tx as patchAllowlistUsersInConfigEntries, wd as normalizeSlackSlug, xd as normalizeAllowList, zd as reactSlackMessage } from "./pi-embedded-BHLc2HPd.js";
...
import { f as computeBackoff, p as sleepWithAbort } from "./level-overrides-DxRoq-Vr.js";
...
import { n as resolveSlackChannelAllowlist, t as resolveSlackUserAllowlist } from "./resolve-users-DRWHdwUb.js";
import { t as require_jsonwebtoken } from "./jsonwebtoken-CUtXITyZ.js";
import { a as resolveSlackThreadTs, i as resolveSlackReplyBlocks, n as deliverReplies, t as createSlackReplyDeliveryPlan } from "./replies-WEJy00IE.js";
...
function buildSlackPluginInteractionData(params) {
	...
	if (actionId.startsWith("openclaw:reply_button") || actionId === "openclaw:reply_select") return payload || null;
...
async function handleSlackBlockAction(params) {
	...
	if (params.handleSlackMessage && (parsed.actionId.startsWith("openclaw:reply_button") || parsed.actionId === "openclaw:reply_select")) {
		const buttonValue = parsed.actionSummary.value ?? parsed.actionSummary.selectedValues?.find(Boolean) ?? "";
...
function loadSlashCommandsRuntime() {
	slashCommandsRuntimePromise ??= import("./slash-commands.runtime-CCDUB0UM.js");
	return slashCommandsRuntimePromise;
}
function loadSlashDispatchRuntime() {
	slashDispatchRuntimePromise ??= import("./slash-dispatch.runtime-uxaZSb01.js");
	return slashDispatchRuntimePromise;
}
function loadSlashSkillCommandsRuntime() {
	slashSkillCommandsRuntimePromise ??= import("./slash-skill-commands.runtime-CZFSv9UF.js");
