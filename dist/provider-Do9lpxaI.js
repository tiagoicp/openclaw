...
import { a as clearExpiredCooldowns, f as resolveProfilesUnavailableReason, s as isProfileInCooldown } from "./auth-profiles-DWcA6joY.js";
...
import { $b as canonicalizeAllowlistWithResolvedIds, $i as GatewayOpcodes$1, $l as dispatchReplyWithBufferedBlockDispatcher, Ai as MessageReactionAddListener, Bi as UserSelectMenu, Br as stripUndefinedFields, CC as resolveDiscordAccount, Ci as TextDisplay, Cn as registerGateway, Di as GuildDeleteListener, Dt as dispatchPluginInteractiveHandler, Dv as resolveNativeCommandSessionTargets, EC as normalizeDiscordToken, Ei as Modal, El as getPluginCommandSpecs, Fi as VoiceServerUpdateListener, Gi as Command, Gn as createDiscordFormModal, Gv as resolveEnvelopeFormatOptions, Hi as RoleSelectMenu, Ii as VoiceStateUpdateListener, Io as buildModelsProviderData, Ji as Plugin, Jn as parseDiscordComponentCustomIdForCarbon, Jr as normalizeDiscordAllowList, Ki as ChannelSelectMenu, Kn as formatDiscordComponentEventText, Li as ListenerEvent, Mi as PresenceUpdateListener, Ni as ReadyListener, Oi as InteractionCreateListener, Pi as ThreadUpdateListener, Pn as editDiscordComponentMessage, Qb as buildAllowlistResolutionSummary, Qi as GatewayIntentBits, Ql as createReplyReferencePlanner, Qr as resolveDiscordChannelConfigWithFallback, Ri as Client, Si as Separator, TC as resolveDiscordMaxLinesPerMessage, Ti as Row, Ui as MentionableSelectMenu, Uv as formatInboundEnvelope, Vi as StringSelectMenu, Wi as CommandWithSubcommands, Xi as ChannelType, Xn as parseDiscordModalCustomIdForCarbon, Xr as resolveDiscordAllowListMatch, Yi as serializePayload, Yn as parseDiscordModalCustomId, Yr as normalizeDiscordSlug, Zb as addAllowlistUserEntriesFromConfigEntry, Zi as GatewayCloseCodes$1, _b as resolveExecApprovalCommandDisplay, ab as wrapFetchWithAbortSignal, ai as resolveGroupDmAllow, bl as matchPluginCommand, ci as formatDiscordUserTag, ei as resolveDiscordGuildEntry, er as resolveDiscordComponentEntry, eu as dispatchReplyWithDispatcher, hb as getExecApprovalApproverDmNoticeText, ia as Routes, ji as MessageReactionRemoveListener, ki as MessageCreateListener, la as setPresence, na as ButtonStyle, ni as resolveDiscordOwnerAccess, nx as summarizeMapping, oi as shouldEmitDiscordReactionNotification, qi as Button, qn as parseDiscordComponentCustomId, qr as isDiscordGroupAllowedByPolicy, ra as ChannelType$1, si as formatDiscordReactionEmoji, sr as formatMention, ta as ApplicationCommandOptionType, ti as resolveDiscordMemberAccessState, tr as resolveDiscordModalEntry, tx as patchAllowlistUsersInConfigEntries, vi as createDiscordClient, vl as executePluginCommand, wi as Container, wn as unregisterGateway, xi as chunkDiscordTextWithMode, zi as RateLimitError } from "./pi-embedded-BHLc2HPd.js";
...
import { o as resolveStoredModelOverride } from "./level-overrides-DxRoq-Vr.js";
...
async function loadDiscordVoiceRuntime() {
	discordVoiceRuntimePromise ??= import("./manager.runtime--e7dwy8S.js");
	return await discordVoiceRuntimePromise;
}
async function loadDiscordProviderSessionRuntime() {
	discordProviderSessionRuntimePromise ??= import("./provider-session.runtime-D_-FLxqL.js");
