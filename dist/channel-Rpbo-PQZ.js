import { Op as buildProbeChannelStatusSummary, jp as collectStatusIssuesFromLastError } from "./auth-profiles-BqVjFbSG.js";
...
import { _ as matrixSetupAdapter, a as resolveMatrixAccount, g as isBunRuntime, i as resolveDefaultMatrixAccountId, l as resolveSharedMatrixClient, o as resolveMatrixAccountConfig, p as resolveMatrixAuth, r as listMatrixAccountIds, t as matrixSetupWizard } from "./matrix-CS6Vktzz.js";
...
import { c as getActiveMatrixClient, n as sendMessageMatrix, o as resolveMatrixRoomId, s as createPreparedMatrixClient, t as reactMatrixMessage } from "./send-DF6wtp8j.js";
...
const loadMatrixChannelRuntime = createLazyRuntimeNamedExport(() => import("./channel.runtime-wcYkKZHI.js"), "matrixChannelRuntime");
const meta = {
	id: "matrix",
	label: "Matrix",
...
const matrixPlugin = {
	...
	gateway: { startAccount: async (ctx) => {
		...
		try {
			monitorMatrixProvider = (await import("./matrix-BvKIwOy1.js")).monitorMatrixProvider;
		} finally {
			releaseLock();
		}
