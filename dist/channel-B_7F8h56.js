import { Mp as createDefaultChannelRuntimeState, Op as buildProbeChannelStatusSummary, kp as buildRuntimeAccountStatusSnapshot, qt as createMessageToolCardSchema } from "./auth-profiles-Djd2VmMW.js";
...
const loadMSTeamsChannelRuntime = createLazyRuntimeNamedExport(() => import("./channel.runtime-BxPiSgIq.js"), "msTeamsChannelRuntime");
...
const msteamsPlugin = {
	...
	gateway: { startAccount: async (ctx) => {
		const { monitorMSTeamsProvider } = await import("./src-Cwwpqcoa.js");
