...
import { n as info, o as success, t as danger } from "./globals-BW15qYpX.js";
import { a as resolveSecretRefValue } from "./resolve-oobueFA6.js";
import { w as SecretProviderSchema } from "./zod-schema.core-Du3k_7-j.js";
import { b as validateConfigObjectRaw, l as readConfigFileSnapshot, v as collectUnsupportedSecretRefPolicyIssues } from "./io-CW6SWMPF.js";
...
import { a as normalizeConfigIssues, n as formatConfigIssueLines } from "./issue-format-QY32pSXt.js";
import { n as discoverConfigSecretTargets, s as resolveConfigSecretTargetByPath } from "./target-registry-WfUwiHm2.js";
import { i as redactConfigObject, n as readBestEffortRuntimeConfigSchema } from "./runtime-schema-DSK5C2M4.js";
import { n as setCommandJsonMode } from "./json-mode-CTpKkcsM.js";
...
function registerConfigCli(program) {
	const cmd = program.command("config").description("Non-interactive config helpers (get/set/unset/file/schema/validate). Run without subcommand for guided setup.").addHelpText("after", () => `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/config", "docs.openclaw.ai/cli/config")}\n`).option("--section <section>", "Configuration sections for guided setup (repeatable). Use with no subcommand.", (value, previous) => [...previous, value], []).action(async (opts) => {
		const { configureCommandFromSectionsArg } = await import("./configure-B5fpdJoO.js");
