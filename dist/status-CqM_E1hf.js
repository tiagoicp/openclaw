...
import { t as formatHealthChannelLines } from "./health-DZdFkqvi.js";
...
import { t as buildChannelsTable } from "./channels-BHZJFGF1.js";
...
function loadPluginRegistryModule() {
	pluginRegistryModulePromise ??= import("./plugin-registry-CPqrOqkG.js");
	return pluginRegistryModulePromise;
}
const loadStatusScanRuntimeModule = createLazyRuntimeSurface(() => import("./status.scan.runtime-DcCqIUbh.js"), ({ statusScanRuntime }) => statusScanRuntime);
function loadStatusScanDepsRuntimeModule() {
	statusScanDepsRuntimeModulePromise ??= import("./status.scan.deps.runtime-B5fuMcsP.js");
...
function loadProviderUsage() {
	providerUsagePromise ??= import("./provider-usage-BxZGAOA3.js");
	return providerUsagePromise;
}
function loadSecurityAuditModule() {
	securityAuditModulePromise ??= import("./audit.runtime-ts3oNpIz.js");
