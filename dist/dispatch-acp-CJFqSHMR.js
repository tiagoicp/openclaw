...
import { s as hasOutboundReplyContent } from "./reply-payload-B7vg_FeY.js";
import { n as formatToolSummary, r as resolveToolDisplay } from "./tool-display-4-jr5bHj.js";
...
import { r as prefixSystemMessage } from "./system-message-5N46sKwQ.js";
import { i as toAcpRuntimeError } from "./errors-AD-WEP_v.js";
import { o as isSessionIdentityPending, u as resolveSessionIdentityFromMeta } from "./session-identity-4kyjrUvj.js";
import { t as resolveConfiguredTtsMode } from "./tts-config-NldNTX2z.js";
import { r as resolveEffectiveBlockStreamingConfig, t as clampPositiveInteger } from "./block-streaming-xKwqDleX.js";
import { t as formatAcpRuntimeErrorText } from "./error-text-NznL1xLg.js";
import { a as resolveAcpDispatchPolicyError, i as resolveAcpAgentPolicyError } from "./policy-B3UwQEJB.js";
import { a as resolveAcpThreadSessionDetailLines } from "./session-identifiers-BDE2Nw26.js";
import { r as createBlockReplyPipeline } from "./block-reply-pipeline-CfKJkRF7.js";
import { t as resolveStatusTtsSnapshot } from "./status-config-U3ew07wx.js";
...
function loadDispatchAcpMediaRuntime() {
	dispatchAcpMediaRuntimePromise ??= import("./dispatch-acp-media.runtime-B_ypK-UY.js");
...
function loadRouteReplyRuntime() {
	routeReplyRuntimePromise ??= import("./route-reply.runtime-WyL1dNJK.js");
	return routeReplyRuntimePromise;
}
function loadDispatchAcpTtsRuntime$1() {
	dispatchAcpTtsRuntimePromise$1 ??= import("./dispatch-acp-tts.runtime-DkPNDrEi.js");
	return dispatchAcpTtsRuntimePromise$1;
}
function loadChannelPluginRuntime() {
	channelPluginRuntimePromise ??= import("./plugins-D-m8SWq5.js");
	return channelPluginRuntimePromise;
}
function loadMessageActionRuntime() {
	messageActionRuntimePromise ??= import("./message-action-runner-Qcqw7pRd.js");
...
function loadDispatchAcpManagerRuntime() {
	dispatchAcpManagerRuntimePromise ??= import("./dispatch-acp-manager.runtime-DY3CdZze.js");
	return dispatchAcpManagerRuntimePromise;
}
function loadDispatchAcpSessionRuntime() {
	dispatchAcpSessionRuntimePromise ??= import("./dispatch-acp-session.runtime-CH7H32XJ.js");
	return dispatchAcpSessionRuntimePromise;
}
function loadDispatchAcpTtsRuntime() {
	dispatchAcpTtsRuntimePromise ??= import("./dispatch-acp-tts.runtime-DkPNDrEi.js");
