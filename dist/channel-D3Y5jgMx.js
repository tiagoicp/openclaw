...
import { r as resolveMSTeamsGroupToolPolicy } from "./policy-DirFO6NY.js";
import { m as getMSTeamsRuntime, s as resolveMSTeamsCredentials } from "./graph-users-CSH_y87t.js";
import { i as parseMSTeamsTeamChannelInput, n as normalizeMSTeamsUserInput, o as resolveMSTeamsChannelAllowlist, r as parseMSTeamsConversationId, s as resolveMSTeamsUserAllowlist, t as normalizeMSTeamsMessagingTarget } from "./resolve-allowlist-K41oQiex.js";
import { n as msteamsSetupAdapter, t as msteamsSetupWizard } from "./setup-surface-Xx9W9rim.js";
...
const loadMSTeamsChannelRuntime = createLazyRuntimeNamedExport(() => import("./channel.runtime-MkA0PPqI.js"), "msTeamsChannelRuntime");
...
const msteamsPlugin = createChatChannelPlugin({
	base: {
		...
		gateway: { startAccount: async (ctx) => {
			const { monitorMSTeamsProvider } = await import("./src-uigpHWOh.js");
