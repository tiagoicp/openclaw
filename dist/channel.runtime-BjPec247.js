...
import "./accounts-De5zTbyk.js";
import "./runtime-api-D5cyFgo0.js";
import { i as getMe, n as ZaloApiError, t as resolveZaloProxyFetch } from "./proxy-U09FCG94.js";
import { t as sendMessageZalo } from "./send-DJXQkSvV.js";
...
async function notifyZaloPairingApproval(params) {
	const { resolveZaloAccount } = await import("./accounts-DLdnMcB3.js");
...
async function startZaloGatewayAccount(ctx) {
	...
	const { monitorZaloProvider } = await import("./monitor-BoXcnDc0.js");
