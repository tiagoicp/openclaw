...
import { d as requiresExplicitMatrixDefaultAccount } from "./helper-api-B-x72re_.js";
...
import { A as normalizeMatrixMessagingTarget, I as resolveDefaultMatrixAccountId, L as resolveMatrixAccount, M as resolveMatrixDirectUserId, N as resolveMatrixTargetIdentity, P as listMatrixAccountIds, R as resolveMatrixAccountConfig, j as normalizeMatrixResolvableTarget } from "./send-p3GP08R2.js";
import { i as resolveMatrixRoomConfig, n as normalizeMatrixUserId, t as normalizeMatrixAllowList } from "./allowlist-zu9TyQuG.js";
import { n as matrixSetupAdapter } from "./setup-core-CK1gJ9pf.js";
import { z } from "zod";
...
const matrixMessageActions = {
	...
	handleAction: async (ctx) => {
		const { handleMatrixAction } = await import("./tool-actions.runtime-NiNSXQmV.js");
...
const loadMatrixChannelRuntime = createLazyRuntimeNamedExport(() => import("./channel.runtime-DLFikg66.js"), "matrixChannelRuntime");
const meta = {
	id: "matrix",
	label: "Matrix",
...
const matrixPlugin = createChatChannelPlugin({
	base: {
		...
		gateway: { startAccount: async (ctx) => {
			...
			try {
				monitorMatrixProvider = (await import("./monitor-DdlcrBih.js")).monitorMatrixProvider;
			} finally {
				releaseLock();
			}
