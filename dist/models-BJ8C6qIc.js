...
import { d as openUrl } from "./onboard-helpers-D1z7-ld8.js";
...
import { t as buildProviderAuthRecoveryHint } from "./provider-auth-guidance-Ym5NP07G.js";
...
async function modelsListCommand(opts, runtime) {
	ensureFlagCompatibility(opts);
	const { ensureAuthProfileStore } = await import("./auth-profiles.runtime-WNJEPvLv.js");
	const { ensureOpenClawModelsJson } = await import("./models-config-i78CdtwQ.js");
