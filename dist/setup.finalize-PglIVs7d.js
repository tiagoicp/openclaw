...
import { t as runTui } from "./tui-DLiQiqOp.js";
...
async function finalizeSetupWizard(options) {
	...
	if (webSearchProvider) {
		const { SEARCH_PROVIDER_OPTIONS, resolveExistingKey, hasExistingKey, hasKeyInEnv } = await import("./onboard-search-DeImiLXa.js");
		...
		const { SEARCH_PROVIDER_OPTIONS, hasExistingKey, hasKeyInEnv } = await import("./onboard-search-DeImiLXa.js");
