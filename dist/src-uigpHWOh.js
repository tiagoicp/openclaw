...
import { Ov as resolveInboundSessionEnvelopeContext, Xp as resolveChannelMediaMaxBytes, Zv as dispatchReplyFromConfigWithSettledDispatcher, ex as mergeAllowlist, jv as resolveMentionGating, nx as summarizeMapping } from "./pi-embedded-BHLc2HPd.js";
...
import { c as createScopedExpiringIdCache } from "./text-runtime-B-kOpuLv.js";
...
import "./msteams-DW9kWabN.js";
import "./runtime-api-06QgJeYM.js";
import { a as resolveMSTeamsRouteConfig, i as resolveMSTeamsReplyPolicy, n as resolveMSTeamsAllowlistMatch, t as isMSTeamsGroupAllowed } from "./policy-DirFO6NY.js";
import { A as resolveRequestUrl, C as isDownloadableAttachment, D as normalizeContentType, E as isUrlAllowed, M as safeHostForUrl, O as resolveAttachmentFetchPolicy, S as inferPlaceholder, T as isRecord, _ as GRAPH_ROOT, b as extractHtmlFromAttachment, d as createMSTeamsTokenProvider, f as loadMSTeamsSdkWithAuth, g as ATTACHMENT_TAG_RE, j as safeFetchWithPolicy, k as resolveMediaSsrfPolicy, l as createBotFrameworkJwtValidator, m as getMSTeamsRuntime, s as resolveMSTeamsCredentials, u as createMSTeamsAdapter, v as IMG_SRC_RE, w as isLikelyImageAttachment, x as extractInlineImageCandidates, y as applyAuthorizationHeaderForUrl } from "./graph-users-CSH_y87t.js";
import { o as resolveMSTeamsChannelAllowlist, s as resolveMSTeamsUserAllowlist } from "./resolve-allowlist-K41oQiex.js";
import { S as extractMSTeamsPollVote, _ as classifyMSTeamsSendError, b as createMSTeamsConversationStoreFs, c as renderReplyPayloadsToMessages, d as withRevokedProxyFallback, f as getPendingUpload, g as uploadToConsentUrl, h as parseFileConsentInvoke, l as sendMSTeamsMessages, m as buildFileInfoCard, p as removePendingUpload, s as buildConversationReference, u as AI_GENERATED_ENTITY, v as formatMSTeamsSendErrorHint, x as createMSTeamsPollStoreFs, y as formatUnknownError } from "./probe-jrwhCJs3.js";
