...
import { n as isRestartEnabled, t as isCommandFlagEnabled } from "./commands.flags-BV4mxr4m.js";
import "./config-CGntDIeG.js";
import { g as GATEWAY_CLIENT_NAMES, h as GATEWAY_CLIENT_MODES, r as isInternalMessageChannel, u as normalizeMessageChannel } from "./message-channel-S0mPg8y2.js";
import { n as resolveChannelApprovalCapability } from "./plugins-RAm7ylrL.js";
import { m as triggerInternalHook, n as createInternalHookEvent } from "./internal-hooks-BejhqQO2.js";
import { x as prepareProviderRuntimeAuth } from "./provider-runtime-DnxLmvNm.js";
import { t as ensureOpenClawModelsJson } from "./models-config-BH-vCRea.js";
import { f as resolveResponseUsageMode, o as normalizeFastMode, u as normalizeUsageDisplay } from "./thinking.shared-B_XYtu1m.js";
...
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, r as resolveDefaultSessionStorePath } from "./paths-CEB5IskJ.js";
...
import { i as formatUsd, r as formatTokenCount } from "./usage-format-Cwjc176l.js";
...
import { S as setTtsProvider, _ as setLastTtsAttempt, a as getTtsMaxLength, b as setTtsEnabled, c as isTtsEnabled, h as resolveTtsPrefsPath, i as getResolvedSpeechProviderConfig, l as isTtsProviderConfigured, m as resolveTtsConfig, o as getTtsProvider, r as getLastTtsAttempt, s as isSummarizationEnabled, v as setSummarizationEnabled, w as textToSpeech, x as setTtsMaxLength } from "./tts-C8tYgc6K.js";
import { t as analyzeBootstrapBudget } from "./bootstrap-budget-DXKkQZb6.js";
...
import { i as resolveImageSanitizationLimits, n as sanitizeImageBlocks } from "./tool-images-B_3oFe4N.js";
...
import { i as unsetConfiguredMcpServer, r as setConfiguredMcpServer, t as listConfiguredMcpServers } from "./mcp-config-YcUJB29c.js";
import { t as EmbeddedBlockChunker } from "./pi-embedded-block-chunker-DhyGrLSG.js";
import { r as callGateway } from "./call-CpHMuJ4Y.js";
import { l as triggerOpenClawRestart, o as scheduleGatewaySigusr1Restart } from "./restart-DW0PhoV7.js";
import { i as resolveReplyToMode } from "./reply-threading-CeX3FwAJ.js";
import { b as formatConfigWriteDeniedMessageShared, v as authorizeConfigWriteShared, x as resolveConfigWriteTargetFromPathShared, y as canBypassConfigWritePolicyShared } from "./channel-config-helpers-Da4M1Ru3.js";
import { n as formatTaskStatusDetail, r as formatTaskStatusTitle, t as buildTaskStatusSnapshot } from "./task-status-D-ynjDEb.js";
import { a as clearSessionQueues } from "./queue-BcT8vXEu.js";
import { r as getSessionBindingService } from "./session-binding-service-C8U6LRDO.js";
import { h as replyRunRegistry, i as getActiveEmbeddedRunSnapshot } from "./runs-LpM-ccpN.js";
import "./diagnostic-KYj15r35.js";
import { t as formatDurationCompact } from "./format-duration-eMyfRkes.js";
import { O as getFinishedSession, k as getSession } from "./bash-tools.exec-runtime-BVl4aRzg.js";
import "./sandbox-IBSNYIhr.js";
import { a as stripToolResultDetails } from "./session-transcript-repair-DFczUp_l.js";
import { t as buildSystemPromptReport } from "./system-prompt-report-POqB1yFy.js";
import { n as estimateTokensFromChars } from "./cjk-chars-DX93WXpE.js";
import { r as resolveModelWithRegistry } from "./model-B7HWI1pe.js";
import { i as matchPluginCommand, n as executePluginCommand } from "./commands-BQek7zvd.js";
...
import { i as setAbortMemory, r as isAbortTrigger } from "./abort-primitives-ClM0p0jB.js";
...
import { n as setChannelConversationBindingMaxAgeBySessionKey, t as setChannelConversationBindingIdleTimeoutBySessionKey } from "./conversation-bindings-DI6F2Bdv.js";
import { a as readChannelAllowFromStore, l as removeChannelAllowFromStoreEntry, t as addChannelAllowFromStoreEntry } from "./pairing-store-Bpa-5SXl.js";
import { i as installPluginFromPath, r as installPluginFromNpmSpec } from "./install-dIdcLnmS.js";
import { l as resolveArchiveKind } from "./archive-BHFNCnj7.js";
import { n as isImplicitSameChatApprovalAuthorization } from "./approval-auth-helpers-B8V67Elu.js";
import { n as parseActivationCommand } from "./group-activation-DsnIlRKq.js";
...
import { n as resolveSessionEntryForKey, r as stopSubagentsForRequester, t as formatAbortReplyText } from "./abort-CYp1dyYs.js";
import { t as extractBtwQuestion } from "./btw-command-CnQygxZx.js";
import { t as formatThreadBindingDurationLabel } from "./thread-bindings-messages-CJJcCl2_.js";
...
import { a as requireGatewayClientScopeForInternalChannel, i as requireCommandFlagEnabled, n as rejectNonOwnerCommand, r as rejectUnauthorizedCommand, t as buildDisabledCommandReply } from "./command-gates-C4Li4X3g.js";
import { t as handleAcpCommand } from "./commands-acp-C43vXixi.js";
import { n as buildCommandsMessagePaginated, r as buildHelpMessage, t as buildCommandsMessage } from "./command-status-builders-Bb9gJhSv.js";
import { t as listSkillCommandsForAgents } from "./skill-commands-BrLfcDDJ.js";
import { r as handleModelsCommand } from "./commands-models-CEI2HWYl.js";
import { n as setPluginEnabledInConfig } from "./enable-CBSoCyxV.js";
import { r as createExecTool } from "./bash-tools-Csi6P7aM.js";
import { n as listTasksForAgentIdForStatus, r as listTasksForSessionKeyForStatus } from "./status-text-Dj6cUy-p.js";
import { n as buildThreadingToolContext } from "./agent-runner-utils-DtmY6bUL.js";
import { f as resolveSubagentsAction, h as resolveCommandSurfaceChannel, l as resolveHandledPrefix, m as resolveChannelAccountId, p as stopWithText, u as resolveRequesterSessionKey } from "./shared-BN5QB3H5.js";
import { n as buildToolsMessage } from "./status-Dpix2Rsl.js";
import { t as parseConfigValue } from "./config-value-BW9jJodT.js";
import { t as resolveCommandsSystemPromptBundle } from "./commands-system-prompt-BFf5Nlaw.js";
import { t as buildStatusReply } from "./commands-status-BxtLIKHK.js";
import { i as buildNpmInstallRecordFields, n as persistPluginInstall } from "./plugins-install-persist-DuMX_kgv.js";
import { m as parseClawHubPluginSpec } from "./clawhub-BQdfFFA7.js";
import { r as installPluginFromClawHub } from "./clawhub-FehziDWv.js";
import { a as buildPluginInspectReport, i as buildPluginDiagnosticsReport, o as buildPluginSnapshotReport, s as formatPluginCompatibilityNotice, t as buildAllPluginInspectReports } from "./status-CuWp_0x5.js";
import { a as decidePreferredClawHubFallback, i as createPluginInstallLogger, n as buildPreferredClawHubSpec, u as resolveFileNpmSpecToLocalPath } from "./plugins-command-helpers-C7Q6ipnu.js";
import { n as loadCostUsageSummary, r as loadSessionCostSummary } from "./session-cost-usage-BJSLm4Yt.js";
...
async function handleBashChatCommand(params) {
	...
	if (request.action === "stop") {
		...
		const { killProcessTree } = await import("./kill-tree-z5iZDLC4.js");
		killProcessTree(pid);
...
function loadCompactRuntime() {
	compactRuntimePromise ??= import("./commands-compact.runtime-DZ-Cigiv.js");
...
async function resolveContextReport(params) {
	...
	const { resolveCommandsSystemPromptBundle } = await import("./commands-system-prompt-DVNyDLik.js");
...
async function abortEmbeddedPiRunForSession(sessionId) {
	const { abortEmbeddedPiRun } = await import("./runs-B_TAAIrQ.js");
...
function loadAgentsAction() {
	actionAgentsPromise ??= import("./action-agents-DezQpPxM.js");
	return actionAgentsPromise;
}
function loadFocusAction() {
	actionFocusPromise ??= import("./action-focus-DauUnw7T.js");
	return actionFocusPromise;
}
function loadHelpAction() {
	actionHelpPromise ??= import("./action-help-DIgHRqgh.js");
	return actionHelpPromise;
}
function loadInfoAction() {
	actionInfoPromise ??= import("./action-info-Ba_PTT-U.js");
	return actionInfoPromise;
}
function loadKillAction() {
	actionKillPromise ??= import("./action-kill-DouVFoIx.js");
	return actionKillPromise;
}
function loadListAction() {
	actionListPromise ??= import("./action-list-DLM4mF6t.js");
	return actionListPromise;
}
function loadLogAction() {
	actionLogPromise ??= import("./action-log-DBV8BYus.js");
	return actionLogPromise;
}
function loadSendAction() {
	actionSendPromise ??= import("./action-send-l-jhTNIj.js");
	return actionSendPromise;
}
function loadSpawnAction() {
	actionSpawnPromise ??= import("./action-spawn-DiSIqxHB.js");
	return actionSpawnPromise;
}
function loadUnfocusAction() {
	actionUnfocusPromise ??= import("./action-unfocus-DkEp-fw3.js");
	return actionUnfocusPromise;
}
function loadControlRuntime() {
	controlRuntimePromise ??= import("./commands-subagents-control.runtime-CgfYsOlv.js");
