...
import { n as extractErrorCode, r as formatErrorMessage } from "./errors-Cn8_L7ES.js";
...
import { g as resolveConfigDir, l as escapeRegExp, t as CONFIG_DIR, y as resolveUserPath } from "./utils-DHW4u72m.js";
import { o as isNotFoundPathError, s as isPathInside } from "./boundary-path-C6aAhZ_Z.js";
import { r as runExec } from "./exec-CmLTXzPB.js";
import { a as getRuntimeConfigSnapshot, g as writeConfigFile, i as createConfigIO, s as loadConfig } from "./io-CT8Gq6Au.js";
import { a as hasConfiguredSecretInput, d as resolveSecretInputRef } from "./types.secrets-Es1UJmu9.js";
import { u as secretRefKey } from "./ref-contract-BQ1K_5QR.js";
import { i as resolveSecretRefValues } from "./resolve-166A8Gzf.js";
import { A as DEFAULT_AI_SNAPSHOT_MAX_CHARS, M as DEFAULT_OPENCLAW_BROWSER_PROFILE_NAME, a as allocateColor, c as isValidProfileName, i as allocateCdpPort, k as DEFAULT_AI_SNAPSHOT_EFFICIENT_MAX_CHARS, l as deriveDefaultBrowserCdpPortRange, m as resolveGatewayAuth, n as resolveBrowserConfig, o as getUsedColors, r as resolveProfile, s as getUsedPorts, t as parseHttpUrl } from "./config-BB7MEmFV.js";
import { t as formatCliCommand } from "./command-format-BFcnEFO6.js";
import { r as isLoopbackHost } from "./net-CF5pU6NS.js";
import { c as hasGatewayPasswordEnvCandidate, d as readGatewayTokenEnv, l as hasGatewayTokenEnvCandidate } from "./credentials-CDmoe70o.js";
import { r as ensurePortAvailable } from "./ports-cCFbb5dC.js";
import { a as SsrFBlockedError, h as resolvePinnedHostnameWithPolicy, m as resolvePinnedHostname, p as isPrivateNetworkAllowedByPolicy, r as hasProxyEnvConfigured } from "./proxy-env-CSWtGpnm.js";
import { a as openFileWithinRoot, c as readLocalFileSafely, t as SafeOpenError } from "./fs-safe-D8ECVG53.js";
import { n as extensionForMime, t as detectMime } from "./mime-BwxJ13J4.js";
import { t as rawDataToString } from "./ws-Xf8G6NNz.js";
import { t as generateSecureToken } from "./secure-random-Vd6hUqHk.js";
import { c as resizeToJpeg, i as getImageMetadata, n as buildImageResizeSideGrid, t as IMAGE_REDUCE_QUALITY_STEPS } from "./image-ops-C_ky4hEz.js";
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-4Onv910a.js");
	} catch (err) {
...
function createProfileAvailability({ opts, profile, state, getProfileState, setProfileRunning }) {
	...
	const closePlaywrightBrowserConnectionForProfile = async (cdpUrl) => {
		try {
			await (await import("./pw-ai-4Onv910a.js")).closePlaywrightBrowserConnection(cdpUrl ? { cdpUrl } : void 0);
		} catch {}
	};
...
async function stopBrowserRuntime(params) {
	...
	try {
		await (await import("./pw-ai-4Onv910a.js")).closePlaywrightBrowserConnection();
	} catch {}
}
//#endregion
