...
import { C as UINT32_LE, a as UnsupportedFileTypeError, i as InternalParserError, n as CouldNotDetermineFileTypeError } from "./BasicParser-BsFxFtjc.js";
import { n as fromStream, r as fromBuffer, t as fromFile } from "./lib-Dt2-ibPN.js";
import { l as toRatio, n as decodeString } from "./Util-BTenpTf7.js";
import { c as TimestampFormat, i as LyricsContentType } from "./ID3v2Token-D9waJLwb.js";
import { a as textDecode, t as APEv2Parser } from "./APEv2Parser-RlvYcrcK.js";
import { r as hasID3v1Header } from "./ID3v1Parser-CMdxIBi1.js";
import { n as TrackType, r as TrackTypeValueToKeyMap } from "./types-CKScU5_V.js";
...
const mpegParserLoader = {
	...
	async load() {
		return (await import("./MpegParser-DZwNy3b2.js")).MpegParser;
	}
};
//#endregion
...
const apeParserLoader = {
	...
	async load() {
		return (await import("./APEv2Parser-DbDe-_6u.js")).APEv2Parser;
	}
};
//#endregion
...
const asfParserLoader = {
	...
	async load() {
		return (await import("./AsfParser-CaNDojWm.js")).AsfParser;
	}
};
//#endregion
...
const dsdiffParserLoader = {
	...
	async load() {
		return (await import("./DsdiffParser-BBOK0-zB.js")).DsdiffParser;
	}
};
//#endregion
...
const aiffParserLoader = {
	...
	async load() {
		return (await import("./AiffParser-Djd2NfNf.js")).AIFFParser;
	}
};
//#endregion
...
const dsfParserLoader = {
	...
	mimeTypes: ["audio/dsf"],
	async load() {
		return (await import("./DsfParser-D29bIV4b.js")).DsfParser;
	}
};
//#endregion
...
const flacParserLoader = {
	...
	async load() {
		return (await import("./FlacParser-DQgZJxxi.js")).FlacParser;
	}
};
//#endregion
...
const matroskaParserLoader = {
	...
	async load() {
		return (await import("./MatroskaParser-D4ctCfpp.js")).MatroskaParser;
	}
};
//#endregion
...
const mp4ParserLoader = {
	...
	async load() {
		return (await import("./MP4Parser-CSrhAg5K.js")).MP4Parser;
	}
};
//#endregion
...
const musepackParserLoader = {
	...
	async load() {
		return (await import("./MusepackParser-Gn19l7Tc.js")).MusepackParser;
	}
};
//#endregion
...
const oggParserLoader = {
	...
	async load() {
		return (await import("./OggParser-Bprci48M.js")).OggParser;
	}
};
//#endregion
...
const wavpackParserLoader = {
	...
	async load() {
		return (await import("./WavPackParser-BIfT0REw.js")).WavPackParser;
	}
};
//#endregion
...
const riffParserLoader = {
	...
	async load() {
		return (await import("./WaveParser-DphE-6ni.js")).WaveParser;
	}
};
//#endregion
