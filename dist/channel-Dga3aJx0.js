import { Op as buildProbeChannelStatusSummary, jp as collectStatusIssuesFromLastError } from "./auth-profiles-C1V2x6_A.js";
...
import { _ as matrixSetupAdapter, a as resolveMatrixAccount, g as isBunRuntime, i as resolveDefaultMatrixAccountId, l as resolveSharedMatrixClient, o as resolveMatrixAccountConfig, p as resolveMatrixAuth, r as listMatrixAccountIds, t as matrixSetupWizard } from "./matrix-BjWChL6n.js";
...
import { c as getActiveMatrixClient, n as sendMessageMatrix, o as resolveMatrixRoomId, s as createPreparedMatrixClient, t as reactMatrixMessage } from "./send-CLgC_tFn.js";
...
const loadMatrixChannelRuntime = createLazyRuntimeNamedExport(() => import("./channel.runtime-Bu7FFLiS.js"), "matrixChannelRuntime");
const meta = {
	id: "matrix",
	label: "Matrix",
...
const matrixPlugin = {
	...
	gateway: { startAccount: async (ctx) => {
		...
		try {
			monitorMatrixProvider = (await import("./matrix-CnftdIUi.js")).monitorMatrixProvider;
		} finally {
			releaseLock();
		}
