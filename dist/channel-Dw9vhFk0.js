import { i as normalizeLowercaseStringOrEmpty$1, s as normalizeOptionalString$2 } from "./string-coerce-BUSzWgUA.js";
...
import { n as describeAccountSnapshot, s as resolveMergedAccountConfig, t as createAccountListHelpers } from "./account-helpers-Cq1Zr5oH.js";
import { a as createSetupInputPresenceValidator, i as createPatchedAccountSetupAdapter, n as applySetupAccountConfigPatch, s as migrateBaseNameToDefaultAccount } from "./setup-helpers-DxNOfWja.js";
...
import { g as createAllowlistProviderOpenWarningCollector, n as createDangerousNameMatchingMutableAllowlistWarningCollector, p as composeAccountWarningCollectors } from "./channel-policy-fpyKQCGQ.js";
import { t as createChannelDirectoryAdapter } from "./directory-runtime-CMbDj_o-.js";
import { f as listResolvedDirectoryGroupEntriesFromMapKeys, p as listResolvedDirectoryUserEntriesFromAllowFrom } from "./directory-config-helpers-C7uQQUxi.js";
import { t as resolveChannelMediaMaxBytes } from "./media-limits-DYdkyg_b.js";
import { Q as splitSetupEntries, d as createPromptParsedAllowFromForAccount, f as createStandardChannelSetupStatus, t as addWildcardAllowFrom, v as mergeAllowFromEntries } from "./setup-wizard-helpers-BrpKVoK7.js";
import { t as PAIRING_APPROVED_MESSAGE } from "./pairing-message-COPj1ZLj.js";
import { d as createDefaultChannelRuntimeState, u as createComputedAccountStatusAdapter } from "./status-helpers-C-OjDvUo.js";
...
import { t as getGoogleChatRuntime } from "./runtime-api-DyRyfSzl.js";
import { a as findGoogleChatDirectMessage, c as sendGoogleChatMessage, o as listGoogleChatReactions, r as deleteGoogleChatReaction, t as createGoogleChatReaction, u as uploadGoogleChatAttachment } from "./api-CDH5P7rR.js";
import { n as collectRuntimeConfigAssignments, r as secretTargetRegistryEntries } from "./secret-contract-B5gK1Ip2.js";
import { z } from "zod";
...
function resolveCredentialsFromConfig(params) {
	...
	const file = normalizeOptionalString$1(account.serviceAccountFile);
	if (file) return {
	...
	if (accountId === "default") {
		...
		const envFile = normalizeOptionalString$1(process.env[ENV_SERVICE_ACCOUNT_FILE$1]);
		if (envFile) return {
...
function normalizeGoogleChatApproverId(value) {
	...
	const suffix = normalizeLowercaseStringOrEmpty$1(normalized.slice(6));
...
const loadGoogleChatChannelRuntime$2 = createLazyRuntimeNamedExport(() => import("./channel.runtime-CLB4GA4C.js"), "googleChatChannelRuntime");
const formatAllowFromEntry = (entry) => normalizeLowercaseStringOrEmpty$1(entry.trim().replace(/^(googlechat|google-chat|gchat):/i, "").replace(/^user:/i, "").replace(/^users\//i, ""));
...
const googlechatOutboundAdapter = {
	base: {
		...
		resolveTarget: ({ to }) => {
			const trimmed = normalizeOptionalString$2(to) ?? "";
			if (trimmed) {
...
const loadGoogleChatChannelRuntime$1 = createLazyRuntimeNamedExport(() => import("./channel.runtime-CLB4GA4C.js"), "googleChatChannelRuntime");
...
const loadGoogleChatChannelRuntime = createLazyRuntimeNamedExport(() => import("./channel.runtime-CLB4GA4C.js"), "googleChatChannelRuntime");
const meta = {
	id: "googlechat",
	label: "Google Chat",
