...
import { d as resolveProfileUnusableUntilForDisplay, h as repairOAuthProfileIdMismatch, m as resolveApiKeyForProfile } from "./auth-profiles-z_oM_y_O.js";
...
import { $o as resolveBootstrapContextForRun, Dh as listTelegramAccountIds, F as hasConfiguredMemorySecretInput, H as resolveApiKeyForProvider, XS as resolveBootstrapMaxChars, Yh as resolveCommandSecretRefsViaGateway, ZS as resolveBootstrapTotalMaxChars, bh as lookupTelegramChatId, db as applyPluginAutoEnable, es as analyzeBootstrapBudget, gt as loadOpenClawPlugins, ht as resolvePluginProviders, jh as resolveTelegramAccount, lC as loadModelCatalog, ts as buildBootstrapInjectionStats, wh as inspectTelegramAccount } from "./pi-embedded-DFNOKLyy.js";
...
import { F as readBrowserVersion, I as resolveGoogleChromeExecutableForPlatform, P as parseBrowserMajorVersion, rt as resolveConfiguredSecretInputWithFallback } from "./client-fetch-DG9t9440.js";
...
import { r as resolveMemoryBackendConfig } from "./search-manager-BH4BTUaa.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-IwW0pkVv.js";
import { r as buildPluginCompatibilityWarnings } from "./status-s9qV9aLH.js";
import { n as buildAuthHealthSummary, r as formatRemainingShort, t as DEFAULT_OAUTH_WARN_MS } from "./auth-health-B19OwBVw.js";
import { t as note$1 } from "./note-D37CGhkM.js";
import { r as healthCommand } from "./health-C3xM8JpD.js";
import { i as resolveControlUiDistIndexPathForRoot, r as resolveControlUiDistIndexHealth } from "./control-ui-assets-DaZvz3lm.js";
import { g as normalizeStoredCronJobs, n as runGatewayUpdate, t as runStartupMatrixMigration } from "./server-startup-matrix-migration-C4Uq92ja.js";
import { t as collectChannelStatusIssues } from "./channels-status-issues-CIlxExOp.js";
import { n as runMatrixDoctorSequence, t as cleanStaleMatrixPluginConfig } from "./matrix-DrI8NhZX.js";
import { n as resolveProviderAuthLoginCommand, t as buildProviderAuthRecoveryHint } from "./provider-auth-guidance-CiywbkIC.js";
import { t as ensureSystemdUserLingerInteractive } from "./systemd-linger-DHLD198s.js";
import { t as formatHealthCheckFailure } from "./health-format-CPKitg2Z.js";
import { n as doctorShellCompletion } from "./doctor-completion-hn5iBBLn.js";
import { a as stripUnknownConfigKeys, i as resolveConfigPathTarget, n as formatConfigPath, r as noteOpencodeProviderOverrides, t as runDoctorConfigPreflight } from "./doctor-config-preflight-CeFe33yV.js";
import { a as isMattermostMutableAllowEntry, i as isMSTeamsMutableAllowEntry, n as isGoogleChatMutableAllowEntry, o as isSlackMutableAllowEntry, r as isIrcMutableAllowEntry, s as isZalouserMutableGroupEntry, t as isDiscordMutableAllowEntry } from "./mutable-allowlist-detectors-B4ecK3P_.js";
import { t as resolveDefaultChannelAccountContext } from "./channel-account-context-DIw3rX50.js";
import { i as runLegacyStateMigrations, n as detectLegacyStateMigrations } from "./doctor-state-migrations-DJ8Hezt3.js";
import { n as noteOpenAIOAuthTlsPrerequisites } from "./provider-openai-codex-oauth-tls-h93P5reh.js";
