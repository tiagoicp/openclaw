...
import { h as restoreTerminalState } from "./subsystem-DZirmh0Z.js";
import "./ansi-cwY8Vrne.js";
import "./boolean-B6zcAynR.js";
import "./env-BhXregSC.js";
import "./warning-filter-hHA7Rorp.js";
import { h as pathExists, y as resolveUserPath } from "./utils-DHW4u72m.js";
...
import { r as DEFAULT_BOOTSTRAP_FILENAME } from "./workspace-v-lU9b6K.js";
...
import { n as resolveCliName } from "./cli-name-DEKmjlQR.js";
...
import { b as waitForGatewayReachable, d as openUrl, g as resolveControlUiLinks, i as detectBrowserOpenSupport, o as formatControlUiSshHint, p as probeGatewayReachable } from "./onboard-helpers-igIv5Vw8.js";
...
import { i as isSystemdUserServiceAvailable } from "./systemd-D-7FRv18.js";
...
import { t as ensureControlUiAssetsBuilt } from "./control-ui-assets-BDnC0dQf.js";
import { t as resolveSetupSecretInputString } from "./setup.secret-input-DBHi0U4v.js";
...
import { t as runTui } from "./tui-CcBnSvUF.js";
...
async function finalizeSetupWizard(options) {
	...
	if (process.platform === "linux" && systemdAvailable) {
		const { ensureSystemdUserLingerInteractive } = await import("./systemd-linger-CLP_WN9t.js");
	...
	if (webSearchProvider) {
		const { SEARCH_PROVIDER_OPTIONS, resolveExistingKey, hasExistingKey, hasKeyInEnv } = await import("./onboard-search-CrdzAIj3.js");
		...
		const { SEARCH_PROVIDER_OPTIONS, hasExistingKey, hasKeyInEnv } = await import("./onboard-search-CrdzAIj3.js");
