...
import { Bi as formatResolvedUnresolvedNote, Zi as buildSingleChannelSecretPromptState, _a as patchNestedChannelConfigSection, ca as createTopLevelChannelGroupPolicySetter, la as mergeAllowFromEntries, ra as createNestedChannelDmPolicy, wa as promptSingleChannelSecretInput } from "./auth-profiles-CPtwVkYW.js";
...
async function createMatrixClient(params) {
	...
	if (params.encryption) {
		...
		try {
			const { StoreType } = await import("./matrix-sdk-crypto-nodejs-DO5M0l09.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1));
