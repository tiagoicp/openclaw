...
import { t as runSetupWizard } from "./setup-Cpm2pAvs.js";
import { i as resolveManifestProviderOnboardAuthFlags } from "./provider-auth-choices-Bn22vmAM.js";
import { n as isDeprecatedAuthChoice, r as normalizeLegacyOnboardAuthChoice } from "./auth-choice-legacy-BukVI4qW.js";
import { r as applyLocalSetupWorkspaceConfig } from "./onboard-config-rIuOWOS0.js";
...
async function runNonInteractiveLocalSetup(params) {
	...
	if (authChoice !== "skip") {
		const { applyNonInteractiveAuthChoice } = await import("./auth-choice-GzQmShZH.js");
	...
	if (opts.installDaemon) {
		const { installGatewayDaemonNonInteractive } = await import("./daemon-install-nr-bwf0I.js");
