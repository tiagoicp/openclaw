...
import { r as resolveProviderWizardOptions, t as resolveProviderModelPickerEntries } from "./provider-wizard-DjZkfdQb.js";
import { t as sortFlowContributionsByLabel } from "./types-8ovXpvGO.js";
...
function resolveProviderSetupFlowContributions(params) {
	...
	return sortFlowContributionsByLabel(resolveProviderWizardOptions(params ?? {}).filter((option) => includesProviderFlowScope(option.onboardingScopes, scope)).map((option) => Object.assign({
