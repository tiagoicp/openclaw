import { _ as resolveStateDir, o as resolveConfigPath } from "./paths-C--RM-nt.js";
import { By as hasPotentialConfiguredChannels } from "./auth-profiles-BwxmeQoE.js";
import { K as normalizeTrustedSafeBinDirs } from "./io-CT8Gq6Au.js";
import { a as hasConfiguredSecretInput } from "./types.secrets-Es1UJmu9.js";
import { n as formatPermissionRemediation, r as inspectPathPermissions, t as formatPermissionDetail } from "./audit-fs-Dg-uUMPP.js";
import { N as resolveSandboxConfigForAgent } from "./tool-policy-match-CRgUDkB8.js";
import { m as resolveGatewayAuth, n as resolveBrowserConfig, r as resolveProfile } from "./config-BB7MEmFV.js";
import { t as formatCliCommand } from "./command-format-BFcnEFO6.js";
import { et as resolveBrowserControlAuth, f as redactCdpUrl } from "./routes-YZNukrO4.js";
import { d as isBlockedHostnameOrIp, p as isPrivateNetworkAllowedByPolicy } from "./proxy-env-CSWtGpnm.js";
...
async function loadChannelPlugins() {
	channelPluginsModulePromise ??= import("./plugins-C25E0Yq5.js");
	return await channelPluginsModulePromise;
}
async function loadAuditNonDeepModule() {
	auditNonDeepModulePromise ??= import("./audit.nondeep.runtime-Ds3Yswgt.js");
	return await auditNonDeepModulePromise;
}
async function loadAuditDeepModule() {
	auditDeepModulePromise ??= import("./audit.deep.runtime-BuRHVK9m.js");
	return await auditDeepModulePromise;
}
async function loadAuditChannelModule() {
	auditChannelModulePromise ??= import("./audit-channel.collect.runtime-BdDAECEC.js");
	return await auditChannelModulePromise;
}
async function loadGatewayProbeDeps() {
	gatewayProbeDepsPromise ??= Promise.all([
		import("./call-76cBJafr.js"),
		import("./probe-auth-j4BsXlcK.js"),
		import("./probe-BuNcYgrT.js")
