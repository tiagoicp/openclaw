...
export declare function saveMatrixCredentials(credentials: Omit<MatrixStoredCredentials, "createdAt" | "lastUsedAt">, env?: NodeJS.ProcessEnv, accountId?: string | null): void;
export declare function touchMatrixCredentials(env?: NodeJS.ProcessEnv, accountId?: string | null): void;
