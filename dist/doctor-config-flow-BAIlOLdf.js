import { _ as resolveStateDir, h as resolveOAuthDir, m as resolveNewStateDir, p as resolveLegacyStateDirs, t as CONFIG_PATH } from "./paths-D_QmduAc.js";
import { _ as resolveHomeDir, d as isRecord } from "./utils-CIAfMgvq.js";
import { Hf as resolveCommandSecretRefsViaGateway, Pt as applyPluginAutoEnable, Sv as resolveTelegramAccount, _b as saveSessionStore, _v as normalizeTelegramAllowFromEntry, bv as listTelegramAccountIds, gv as isNumericTelegramUserId, hv as fetchTelegramChatId, rx as canonicalizeMainSessionAlias, vv as inspectTelegramAccount } from "./auth-profiles-CPtwVkYW.js";
import { m as resolveDefaultAgentId } from "./agent-scope-BvOTVsJZ.js";
import { c as normalizeAgentId, n as DEFAULT_MAIN_KEY, r as buildAgentMainSessionKey } from "./session-key-DbuJEGZO.js";
import { n as normalizeAccountId, r as normalizeOptionalAccountId, t as DEFAULT_ACCOUNT_ID } from "./account-id-B0Ci-_gE.js";
import { K as normalizeTrustedSafeBinDirs, U as getTrustedSafeBinDirs, W as isTrustedSafeBinPath, ct as resolveCommandResolutionFromArgv, d as readConfigFileSnapshot, x as OpenClawSchema } from "./io-BLrYinYw.js";
import { E as formatSlackStreamingBooleanMigrationMessage, F as resolveTelegramPreviewStreamMode, M as resolveDiscordPreviewStreamMode, N as resolveSlackNativeStreaming, P as resolveSlackStreamingMode, T as formatSlackStreamModeMigrationMessage } from "./zod-schema.providers-core-JSZEvSLs.js";
import { c as normalizeChatChannelId } from "./registry-DHFXbGRB.js";
import { t as migrateLegacyConfig } from "./config-BuXmKtbA.js";
import { n as parseToolsBySenderTypedKey } from "./types.tools-GbQREqvo.js";
import { t as describeUnknownError } from "./shared-DM3DUUlR.js";
import { t as formatCliCommand } from "./command-format-BGWw_xvQ.js";
import { l as shouldMoveSingleAccountChannelKey } from "./setup-helpers-qP9EmTJt.js";
import { t as collectProviderDangerousNameMatchingScopes } from "./dangerous-name-matching-KBgCcSIA.js";
import { r as listRouteBindings } from "./bindings-BIjLKdqJ.js";
import { n as formatSetExplicitDefaultInstruction, r as formatSetExplicitDefaultToConfiguredInstruction, t as formatChannelAccountsDefaultPath } from "./routing-CM1q67VT.js";
import { a as readChannelAllowFromStore, u as resolveChannelAllowFromPath } from "./pairing-store-BqbEmTVQ.js";
import { a as resolveMergedSafeBinProfileFixtures, r as listInterpreterLikeSafeBins } from "./with-timeout-6Mk1JecS.js";
import { f as isWithinDir } from "./signal-cli-install-CazITAFo.js";
import { n as getChannelsCommandSecretTargetIds } from "./command-secret-targets-DoLf7afU.js";
import { n as formatConfigIssueLines } from "./issue-format-DHdfT94W.js";
import { t as note } from "./note-xP9K_bzf.js";
import { a as isMattermostMutableAllowEntry, i as isMSTeamsMutableAllowEntry, n as isGoogleChatMutableAllowEntry, o as isSlackMutableAllowEntry, r as isIrcMutableAllowEntry, s as isZalouserMutableGroupEntry, t as isDiscordMutableAllowEntry } from "./mutable-allowlist-detectors-qZQvavvu.js";
