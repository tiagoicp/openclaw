...
import { a as stripToolResultDetails } from "./session-transcript-repair-GjJzTrBn.js";
...
import { n as resolveSessionEntryForKey, r as stopSubagentsForRequester, t as formatAbortReplyText } from "./abort-5CV2bZoJ.js";
...
import { r as createExecTool } from "./bash-tools-BjogiOkJ.js";
import { n as listTasksForAgentIdForStatus, r as listTasksForSessionKeyForStatus } from "./status-text-BQ04JSNt.js";
import { n as buildThreadingToolContext } from "./agent-runner-utils-DtmY6bUL.js";
import { f as resolveSubagentsAction, h as resolveCommandSurfaceChannel, l as resolveHandledPrefix, m as resolveChannelAccountId, p as stopWithText, u as resolveRequesterSessionKey } from "./shared-ChujXVU6.js";
import { n as buildToolsMessage } from "./status-CMAhmLdg.js";
import { t as parseConfigValue } from "./config-value-BW9jJodT.js";
import { t as resolveCommandsSystemPromptBundle } from "./commands-system-prompt-iik0TUeg.js";
...
function loadCompactRuntime() {
	compactRuntimePromise ??= import("./commands-compact.runtime-BsY94VW1.js");
...
async function resolveContextReport(params) {
	...
	const { resolveCommandsSystemPromptBundle } = await import("./commands-system-prompt-D-oE_lkR.js");
...
function loadAgentsAction() {
	actionAgentsPromise ??= import("./action-agents-DD_OAn_y.js");
	return actionAgentsPromise;
}
function loadFocusAction() {
	actionFocusPromise ??= import("./action-focus-DhR0viqj.js");
	return actionFocusPromise;
}
function loadHelpAction() {
	actionHelpPromise ??= import("./action-help-Co91wEcb.js");
	return actionHelpPromise;
}
function loadInfoAction() {
	actionInfoPromise ??= import("./action-info-C3-0uKzE.js");
	return actionInfoPromise;
}
function loadKillAction() {
	actionKillPromise ??= import("./action-kill-B0oUPS_T.js");
	return actionKillPromise;
}
function loadListAction() {
	actionListPromise ??= import("./action-list-DfEuMON3.js");
	return actionListPromise;
}
function loadLogAction() {
	actionLogPromise ??= import("./action-log-C41zSwPq.js");
	return actionLogPromise;
}
function loadSendAction() {
	actionSendPromise ??= import("./action-send-X2vzouDM.js");
	return actionSendPromise;
}
function loadSpawnAction() {
	actionSpawnPromise ??= import("./action-spawn-xIJBS0uX.js");
	return actionSpawnPromise;
}
function loadUnfocusAction() {
	actionUnfocusPromise ??= import("./action-unfocus-Bz6o7M9t.js");
	return actionUnfocusPromise;
}
function loadControlRuntime() {
	controlRuntimePromise ??= import("./commands-subagents-control.runtime-B0q-CkIT.js");
