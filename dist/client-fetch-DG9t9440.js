...
function createProfileAvailability({ opts, profile, state, getProfileState, setProfileRunning }) {
	...
	const closePlaywrightBrowserConnectionForProfile = async (cdpUrl) => {
		try {
			await (await import("./pw-ai-v0IdGxIM.js")).closePlaywrightBrowserConnection(cdpUrl ? { cdpUrl } : void 0);
		} catch {}
	};
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-v0IdGxIM.js");
	} catch (err) {
...
async function stopBrowserRuntime(params) {
	...
	try {
		await (await import("./pw-ai-v0IdGxIM.js")).closePlaywrightBrowserConnection();
	} catch {}
}
//#endregion
