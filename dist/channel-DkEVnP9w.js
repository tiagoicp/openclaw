import { Mp as createDefaultChannelRuntimeState, Op as buildProbeChannelStatusSummary, kp as buildRuntimeAccountStatusSnapshot, qt as createMessageToolCardSchema, um as parseFeishuConversationId } from "./auth-profiles-CPtwVkYW.js";
...
import { c as listFeishuAccountIds, d as resolveFeishuCredentials, f as feishuSetupAdapter, i as createFeishuClient, l as resolveDefaultFeishuAccountId, s as listEnabledFeishuAccounts, t as feishuSetupWizard, u as resolveFeishuAccount } from "./feishu-D9a-WC9b.js";
...
const loadFeishuChannelRuntime = createLazyRuntimeNamedExport(() => import("./channel.runtime-iDbDyIIY.js"), "feishuChannelRuntime");
...
const feishuPlugin = {
	...
	gateway: { startAccount: async (ctx) => {
		const { monitorFeishuProvider } = await import("./monitor-BIywcm0s.js");
		const account = resolveFeishuAccount({
			cfg: ctx.cfg,
