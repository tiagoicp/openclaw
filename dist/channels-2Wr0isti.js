...
import { Hf as resolveCommandSecretRefsViaGateway, Lx as loadAuthProfileStore, Mu as resolveMessageActionDiscoveryForPlugin, Wd as resolveMessageChannelSelection, gl as loadProviderUsageSummary, ju as createMessageActionDiscoveryContext, yl as formatUsageReportLines, zy as listChannelPluginCatalogEntries } from "./auth-profiles-CPtwVkYW.js";
...
import { n as listChannelPlugins, r as normalizeChannelId, t as getChannelPlugin } from "./registry-u4-bSC0t.js";
import "./plugins-CrRqO64r.js";
import "./paths-DkI03UGW.js";
import { o as moveSingleAccountChannelSectionToDefaultAccount } from "./setup-helpers-qP9EmTJt.js";
import "./config-schema-SbU9iMOP.js";
import { i as resolveChannelDefaultAccountId, r as parseOptionalDelimitedEntries } from "./helpers-7HrxcRQR.js";
import "./channel-plugin-common-lL08nJSM.js";
import { n as hasResolvedCredentialValue, t as hasConfiguredUnavailableCredentialStatus } from "./account-snapshot-fields-BkvaYdu_.js";
...
import { n as callGateway } from "./call-BlwEFcjC.js";
...
import { n as buildReadOnlySourceChannelAccountSnapshot, t as buildChannelAccountSnapshot } from "./status-BVuPREOW.js";
import { t as collectChannelStatusIssues } from "./channels-status-issues-D92fLnot.js";
import { t as parseLogLine } from "./parse-log-line-ByhwHFd6.js";
import { t as createClackPrompter } from "./clack-prompter-BjFG7rAB.js";
import { i as describeBinding, n as applyAgentBindings, t as requireValidConfigSnapshot } from "./config-validation-Dt4LrA1n.js";
import { t as isCatalogChannelInstalled } from "./discovery-Ds6MtDv2.js";
...
async function channelsAddCommand(opts, runtime = defaultRuntime, params) {
	...
	if (shouldUseWizard(params)) {
		const [{ buildAgentSummaries }, { setupChannels }] = await Promise.all([import("./agents.config-_3WPHR00.js"), import("./onboard-channels-CfdPoigg.js")]);
	...
	const loadScopedPlugin = async (channelId, pluginId) => {
		...
		const { loadChannelSetupPluginRegistrySnapshotForChannel } = await import("./plugin-install-DVY8UGrY.js");
	...
	if (!channel && catalogEntry) {
		...
		if (!isCatalogChannelInstalled({
			...
			const { ensureChannelSetupPluginInstalled } = await import("./plugin-install-DVY8UGrY.js");
			const prompter = createClackPrompter();
