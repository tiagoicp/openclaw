...
import { h as restoreTerminalState, m as defaultRuntime } from "./subsystem-Dm-AQqmI.js";
...
import { s as isValidEnvSecretRefId } from "./types.secrets-Mh0km-xK.js";
...
import "./daemon-runtime-Dotd3w7r.js";
import { a as ensureWorkspaceAndSessions, b as waitForGatewayReachable, c as handleReset, g as resolveControlUiLinks, m as randomToken, n as applyWizardMetadata, t as DEFAULT_WORKSPACE, u as normalizeGatewayTokenInput } from "./onboard-helpers-Bp9X8OX9.js";
...
import { i as resolveManifestProviderOnboardAuthFlags } from "./provider-auth-choices-B48Gcww1.js";
import { n as isDeprecatedAuthChoice, r as normalizeLegacyOnboardAuthChoice } from "./auth-choice-legacy-CM9_dCxr.js";
import { r as applyLocalSetupWorkspaceConfig } from "./onboard-config-CGqfgSwO.js";
...
async function collectGatewayHealthFailureDiagnostics() {
	const diagnostics = {};
	try {
		const { resolveGatewayService } = await import("./service-CWPzbmUl.js");
	...
	try {
		const { readLastGatewayErrorLine } = await import("./diagnostics-9ZCy_PHu.js");
...
async function runNonInteractiveLocalSetup(params) {
	...
	if (authChoice !== "skip") {
		const { applyNonInteractiveAuthChoice } = await import("./auth-choice-B89u3lVM.js");
	...
	if (opts.installDaemon) {
		const { installGatewayDaemonNonInteractive } = await import("./daemon-install-lLFtENK3.js");
	...
	if (!opts.skipHealth) {
		const { healthCommand } = await import("./health-BTRBgMjO.js");
