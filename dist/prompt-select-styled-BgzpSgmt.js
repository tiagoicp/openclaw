import { o as getResolvedLoggerSettings } from "./logger-Qep7Kkk8.js";
import { _ as resolveStateDir, d as resolveIsNixMode, h as resolveOAuthDir, t as CONFIG_PATH, u as resolveGatewayPort, x as resolveRequiredHomeDir } from "./paths-C--RM-nt.js";
import { m as defaultRuntime } from "./subsystem-DZirmh0Z.js";
import { t as isTruthyEnvValue$1 } from "./env-BhXregSC.js";
import { C as sleep, S as shortenHomePath, y as resolveUserPath } from "./utils-DHW4u72m.js";
...
import { O as DEFAULT_MODEL, g as resolveHooksGmailModel, i as getModelRefStatus, k as DEFAULT_PROVIDER, m as resolveConfiguredModelRef } from "./model-selection-CnnQfpX3.js";
import { a as resolveAgentDir, m as resolveDefaultAgentId, p as resolveAgentWorkspaceDir } from "./agent-scope-CjT_nq79.js";
...
import { t as DEFAULT_AGENTS_FILENAME } from "./workspace-v-lU9b6K.js";
import { d as readConfigFileSnapshot, g as writeConfigFile } from "./io-CT8Gq6Au.js";
import { a as hasConfiguredSecretInput, d as resolveSecretInputRef } from "./types.secrets-Es1UJmu9.js";
import { P as resolveSandboxScope, Q as DEFAULT_SANDBOX_BROWSER_IMAGE, et as DEFAULT_SANDBOX_IMAGE, k as cleanStaleLockFiles } from "./tool-policy-match-CRgUDkB8.js";
import { m as resolveGatewayAuth } from "./config-BB7MEmFV.js";
import { t as formatCliCommand } from "./command-format-BFcnEFO6.js";
import { r as isLoopbackHost, u as resolveGatewayBindHost } from "./net-CF5pU6NS.js";
import { d as readGatewayTokenEnv } from "./credentials-CDmoe70o.js";
import { C as parseBrowserMajorVersion, T as resolveGoogleChromeExecutableForPlatform, at as resolveConfiguredSecretInputWithFallback, ct as hasAmbiguousGatewayAuthModeConfig, w as readBrowserVersion } from "./routes-YZNukrO4.js";
...
import { c as resolveSessionTranscriptsDirForAgent, i as resolveSessionFilePathOptions, l as resolveStorePath, r as resolveSessionFilePath } from "./paths-CQCu7NWf.js";
import { r as resolveDmAllowState } from "./dm-policy-shared-DemT0SXY.js";
import { n as callGateway, t as buildGatewayConnectionDetails } from "./call-DsrhjEGT.js";
import { t as resolveMemorySearchConfig } from "./memory-search-Dc0FafUQ.js";
import { r as resolveMemoryBackendConfig } from "./search-manager-CT1sU3t7.js";
import { f as resolveGatewaySystemdServiceName, h as resolveNodeLaunchAgentLabel, l as resolveGatewayLaunchAgentLabel, p as resolveGatewayWindowsTaskName } from "./constants-DDjBTZad.js";
import { r as isWSLEnv, t as isWSL } from "./wsl-CDHkXzVe.js";
import { a as resolveSystemNodeInfo, r as renderSystemNodeWarning } from "./runtime-paths-rSGPvmQ3.js";
import { n as buildGatewayInstallPlan, r as gatewayInstallErrorHint, t as resolveGatewayInstallToken } from "./gateway-install-token-CSJot3Xk.js";
import { n as GATEWAY_DAEMON_RUNTIME_OPTIONS, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-B5n1n7iD.js";
import { n as stylePromptMessage, r as stylePromptTitle, t as stylePromptHint } from "./prompt-style-m5RmghCt.js";
import { f as printWizardHeader, m as randomToken, n as applyWizardMetadata, s as guardCancel } from "./onboard-helpers-igIv5Vw8.js";
import { i as launchAgentPlistExists, n as isLaunchAgentListed, r as isLaunchAgentLoaded, s as repairLaunchAgentBootstrap } from "./launchd-BxxknCWn.js";
import { n as resolveGatewayService, t as describeGatewayServiceRestart } from "./service-D28G6QL6.js";
import { i as isSystemdUserServiceAvailable, u as uninstallLegacySystemdUnits } from "./systemd-D-7FRv18.js";
import { c as buildPlatformRuntimeLogHints, i as auditGatewayServiceConfig, n as renderSystemdUnavailableHints, o as needsNodeRuntimeMigration, r as SERVICE_AUDIT_CODES, s as readEmbeddedGatewayToken, t as isSystemdUnavailableDetail, u as formatRuntimeStatus } from "./systemd-hints-qagSoh_R.js";
import { t as readLastGatewayErrorLine } from "./diagnostics-BXtEh3e8.js";
import { n as renderGatewayServiceCleanupHints, t as findExtraGatewayServices } from "./inspect-DGPCyh-B.js";
import { n as logConfigUpdated } from "./logging-B66tGTZe.js";
import { t as note$1 } from "./note-DLg3kxfE.js";
import { n as noteOpenAIOAuthTlsPrerequisites } from "./provider-openai-codex-oauth-tls-Bsjo1MYZ.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-BwHENxb3.js";
import { r as healthCommand } from "./health-BXUdMzDD.js";
import { i as resolveControlUiDistIndexPathForRoot, r as resolveControlUiDistIndexHealth } from "./control-ui-assets-BDnC0dQf.js";
import { p as normalizeStoredCronJobs, t as runGatewayUpdate } from "./update-runner-BDephK0Q.js";
import { t as collectChannelStatusIssues } from "./channels-status-issues-a-w52bmm.js";
import { n as resolveProviderAuthLoginCommand, t as buildProviderAuthRecoveryHint } from "./provider-auth-guidance-CVVDm4vW.js";
import { t as ensureSystemdUserLingerInteractive } from "./systemd-linger-BcbMEb0k.js";
import { t as formatHealthCheckFailure } from "./health-format-D89Uomdt.js";
import { n as doctorShellCompletion } from "./doctor-completion-BbtilSGo.js";
import { a as runLegacyStateMigrations, i as detectLegacyStateMigrations, r as loadAndMaybeMigrateDoctorConfig } from "./doctor-config-flow-0mbrsOwL.js";
