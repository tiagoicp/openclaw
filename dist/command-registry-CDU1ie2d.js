...
import { a as removeCommandByName, i as registerSubCliCommands, o as reparseProgramFromActionArgs } from "./register.subclis-BFqDi1Xg.js";
...
const coreEntries = [
	{
		...
		register: async ({ program }) => {
			(await import("./register.setup-C_kN9nl-.js")).registerSetupCommand(program);
		}
	},
	{
		commands: [{
		...
		register: async ({ program }) => {
			(await import("./register.onboard-CdxNQues.js")).registerOnboardCommand(program);
		}
	},
	{
		commands: [{
		...
		register: async ({ program }) => {
			(await import("./register.configure-COn7RWj5.js")).registerConfigureCommand(program);
		}
	},
	{
		commands: [{
		...
		register: async ({ program }) => {
			(await import("./config-cli-qvepjciF.js")).registerConfigCli(program);
		}
	},
	{
		commands: [{
	...
	},
	{
		...
		register: async ({ program }) => {
			(await import("./register.maintenance-FNMlpGZ8.js")).registerMaintenanceCommands(program);
		}
	},
	{
		commands: [{
		...
		register: async ({ program, ctx }) => {
			(await import("./register.message-D1maJQtJ.js")).registerMessageCommands(program, ctx);
		}
	},
	{
		commands: [{
		...
		register: async ({ program }) => {
			(await import("./memory-cli-CtpZ9vp6.js")).registerMemoryCli(program);
		}
	},
	{
		commands: [{
	...
	},
	{
		...
		register: async ({ program, ctx }) => {
			(await import("./register.agent-DGUImghE.js")).registerAgentCommands(program, { agentChannelOptions: ctx.agentChannelOptions });
		}
	},
	{
		commands: [
		...
		register: async ({ program }) => {
			(await import("./register.status-health-sessions-BkftgWju.js")).registerStatusHealthSessionsCommands(program);
		}
	},
	{
		commands: [{
