...
import { ft as getSessionCompactionCheckpoint, pt as listSessionCompactionCheckpoints } from "./model-context-tokens-DqoMeHEd.js";
...
import { n as compactEmbeddedPiSession, r as selectAgentHarness } from "./pi-embedded-runner-DadJfjsd.js";
import { i as supportsXHighThinking, t as formatThinkingLevels } from "./thinking-CM6tfHdy.js";
import { o as resolveFailoverReasonFromError } from "./failover-error-BEwDRpkR.js";
...
import { n as createOutboundPayloadPlan, s as projectOutboundPayloadPlanForMirror, t as deliverOutboundPayloads } from "./deliver-BeAWUF3a.js";
...
import { a as normalizeCronJobCreate, o as normalizeCronJobInput, s as normalizeCronJobPatch } from "./openclaw-tools-BkngfiYT.js";
...
import { i as resolveOutboundSessionRoute, r as ensureOutboundSessionEntry, s as dispatchChannelMessageAction } from "./message-action-runner-CcF8Z7vR.js";
...
import { a as createRunningTaskRun, o as failTaskRunByRunId, r as completeTaskRunByRunId } from "./task-executor-BllHI_1w.js";
import { _ as cleanupBrowserSessionsForLifecycleEnd, h as onSessionLifecycleEvent, o as initSubagentRegistry, p as scheduleSubagentOrphanRecovery, y as movePathToTrash } from "./subagent-registry-m4WE-LIZ.js";
...
import { n as createPluginRuntime, r as setGatewaySubagentRuntime } from "./runtime-D_gYdUbl.js";
import { r as listChatCommandsForConfig } from "./commands-registry-list-CzmkNUiJ.js";
import "./commands-registry-Ct4QqMNc.js";
import { o as getTotalPendingReplies } from "./dispatch-BjhpELCU.js";
...
import { i as resolveBareSessionResetPromptState, n as shouldApplyStartupContext, r as resolveBareResetBootstrapFileAccess, t as buildSessionStartupContextPrelude } from "./startup-context-BjUT4IA6.js";
...
import { r as agentCommandFromIngress } from "./agent-command-CaP8ld3q.js";
...
import { t as closeMcpLoopbackServer } from "./mcp-http-6L-fnf5a.js";
...
import { a as performGatewaySessionReset } from "./session-reset-service-C97eo8SP.js";
...
import "./status-MeWEMBHZ.js";
import { t as getStatusSummary } from "./status.summary-Da58d1XS.js";
import { d as startTaskRegistryMaintenance, f as stopTaskRegistryMaintenance, g as markCronJobActive, h as clearCronJobActive, n as getInspectableTaskRegistrySummary } from "./task-registry.maintenance-Cghkk3Ap.js";
...
function loadExecApprovalForwarderRuntime() {
	execApprovalForwarderRuntimePromise ??= import("./exec-approval-forwarder.runtime-CMl7e6g3.js");
...
async function loadCronExecutorRuntime() {
	cronExecutorRuntimePromise ??= import("./run-executor.runtime-CqkBWEjW.js");
...
async function loadCronDeliveryRuntime() {
	cronDeliveryRuntimePromise ??= import("./run-delivery.runtime-scsAwYV5.js");
...
async function loadCliRunnerRuntime() {
	return await import("./cli-runner.runtime-jdPmvhUD.js");
}
...
async function loadSessionSubagentReactivationRuntime() {
	return import("./session-subagent-reactivation.runtime-BpLLyn-g.js");
}
...
const nodeHandlers = {
	...
	"node.event": async ({ params, respond, context, client }) => {
		...
		await respondUnavailableOnThrow(respond, async () => {
			const { handleNodeEvent } = await import("./server-node-events-DZVrxGtp.js");
...
function loadSessionsRuntimeModule() {
	sessionsRuntimeModulePromise ??= import("./sessions.runtime-BGdx22AV.js");
...
function recoverPendingOutboundDeliveries(params) {
	(async () => {
		...
		const { deliverOutboundPayloads } = await import("./deliver-B25cmGdL.js");
...
function getOpenAiHttpModule() {
	openAiHttpModulePromise ??= import("./openai-http-BPtwRhYO.js");
	return openAiHttpModulePromise;
}
function getOpenResponsesHttpModule() {
	openResponsesHttpModulePromise ??= import("./openresponses-http-itiGEBJS.js");
	return openResponsesHttpModulePromise;
}
function getSessionHistoryHttpModule() {
	sessionHistoryHttpModulePromise ??= import("./sessions-history-http-CSNiZtMv.js");
	return sessionHistoryHttpModulePromise;
}
function getSessionKillHttpModule() {
	sessionKillHttpModulePromise ??= import("./session-kill-http-CN4MW8cJ.js");
	return sessionKillHttpModulePromise;
}
function getToolsInvokeHttpModule() {
	toolsInvokeHttpModulePromise ??= import("./tools-invoke-http-UkUGHh2Y.js");
