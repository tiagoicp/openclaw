...
import { a as createWebhookInFlightLimiter, t as WEBHOOK_BODY_READ_DEFAULTS } from "./webhook-request-guards-CB27SJb7.js";
import "./webhook-ingress-OddxVfzA.js";
import { t as zod_exports } from "./zod-BIW-RsMp.js";
import "./api-BWX2VEp22.js";
import { a as deepMergeDefined, i as validateProviderConfig, n as normalizeVoiceCallConfig, r as resolveVoiceCallConfig } from "./config-BmYab3kZ.js";
import { n as mapVoiceToPolly, t as escapeXml } from "./voice-mapping-DpHlMg0a.js";
import { a as convertPcmToMulaw8k, t as isProviderStatusTerminal } from "./call-status-BVNH6JjK.js";
import { t as getHeader } from "./http-headers-BYlb1W4X.js";
...
function loadRealtimeTranscriptionRuntime() {
	realtimeTranscriptionRuntimePromise ??= import("./realtime-transcription.runtime-CRaKO126.js");
	return realtimeTranscriptionRuntimePromise;
}
function loadResponseGeneratorModule() {
	responseGeneratorModulePromise ??= import("./response-generator-DVyE4eiL.js");
...
function loadTelnyxProvider() {
	telnyxProviderPromise ??= import("./telnyx-CeRq9mm-.js");
	return telnyxProviderPromise;
}
function loadTwilioProvider() {
	twilioProviderPromise ??= import("./twilio-ugcI1nJO.js");
	return twilioProviderPromise;
}
function loadPlivoProvider() {
	plivoProviderPromise ??= import("./plivo-BKWgtPoe.js");
	return plivoProviderPromise;
}
function loadMockProvider() {
	mockProviderPromise ??= import("./mock-I6MfEZAP.js");
	return mockProviderPromise;
}
function loadRealtimeVoiceRuntime() {
	realtimeVoiceRuntimePromise ??= import("./realtime-voice.runtime-CO4gtELa.js");
	return realtimeVoiceRuntimePromise;
}
function loadRealtimeHandler() {
	realtimeHandlerPromise ??= import("./realtime-handler-BnO6O1Cc.js");
