...
import { ys as listConfiguredWebSearchProviders } from "./pi-embedded-BHLc2HPd.js";
...
import { t as runTui } from "./tui-CoukKbXW.js";
...
async function finalizeSetupWizard(options) {
	...
	if (process.platform === "linux" && systemdAvailable) {
		const { ensureSystemdUserLingerInteractive } = await import("./systemd-linger-BdDRxtJ_.js");
	...
	if (webSearchProvider) {
		const { resolveExistingKey, hasExistingKey, hasKeyInEnv } = await import("./onboard-search-Drj1758C.js");
		...
		const { hasExistingKey, hasKeyInEnv } = await import("./onboard-search-Drj1758C.js");
