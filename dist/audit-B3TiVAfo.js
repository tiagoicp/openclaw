...
import { Q as resolveBrowserControlAuth, q as redactCdpUrl } from "./client-fetch-DG9t9440.js";
...
import { n as DEFAULT_GATEWAY_HTTP_TOOL_DENY } from "./dangerous-tools-t7kir_KA.js";
import { t as collectEnabledInsecureOrDangerousFlags } from "./dangerous-config-flags-Bnl0U-Ma.js";
...
async function loadAuditNonDeepModule() {
	auditNonDeepModulePromise ??= import("./audit.nondeep.runtime-D0QdfEFG.js");
	return await auditNonDeepModulePromise;
}
async function loadAuditDeepModule() {
	auditDeepModulePromise ??= import("./audit.deep.runtime-DMJpcZsr.js");
	return await auditDeepModulePromise;
}
async function loadAuditChannelModule() {
	auditChannelModulePromise ??= import("./audit-channel.collect.runtime-CiyCL5dY.js");
