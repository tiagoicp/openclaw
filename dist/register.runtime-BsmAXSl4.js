...
import { c as cloneFirstTemplateModel } from "./provider-model-shared-Cl567THa.js";
...
import "./cli-runtime-CfgBrCbF.js";
import { a as fetchClaudeUsage } from "./provider-usage-C5h_x8Ai.js";
import { n as readClaudeCliCredentialsForSetup, r as readClaudeCliCredentialsForSetupNonInteractive, t as readClaudeCliCredentialsForRuntime } from "./cli-auth-seam-CMUnAxC1.js";
import { i as CLAUDE_CLI_DEFAULT_MODEL_REF, r as CLAUDE_CLI_DEFAULT_ALLOWLIST_REFS, t as CLAUDE_CLI_BACKEND_ID } from "./cli-shared-B_LgKGrL.js";
import { t as buildAnthropicCliBackend } from "./cli-backend-DIJLDozy.js";
import { t as buildAnthropicCliMigrationResult } from "./cli-migration-D_Slat8C.js";
import { n as normalizeAnthropicProviderConfig, t as applyAnthropicConfigDefaults } from "./config-defaults-ghQZA7ju.js";
import { t as anthropicMediaUnderstandingProvider } from "./media-understanding-provider-ZXS41XDg.js";
import { t as buildReplayPolicy } from "./replay-policy-90VbcWGm.js";
import { c as wrapAnthropicProviderStream } from "./stream-wrappers-BY9qPscv.js";
...
function buildAnthropicProvider() {
	...
	return {
		...
		resolveDefaultThinkingLevel: ({ modelId }) => isAnthropicOpus47Model(modelId) ? "off" : matchesAnthropicModernModel(modelId) && shouldUseAnthropicAdaptiveThinkingDefault(modelId) ? "adaptive" : void 0,
