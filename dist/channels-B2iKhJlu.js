...
import { n as buildReadOnlySourceChannelAccountSnapshot, t as buildChannelAccountSnapshot } from "./status-DneYiwtY.js";
...
import { i as describeBinding, n as applyAgentBindings, t as requireValidConfigSnapshot } from "./config-validation-CBdvcxbq.js";
import { t as isCatalogChannelInstalled } from "./discovery-B_YM5rFA.js";
...
async function channelsAddCommand(opts, runtime = defaultRuntime, params) {
	...
	if (shouldUseWizard(params)) {
		const [{ buildAgentSummaries }, { setupChannels }] = await Promise.all([import("./agents.config-_3WPHR00.js"), import("./onboard-channels-CWHie3YB.js")]);
	...
	const loadScopedPlugin = async (channelId, pluginId) => {
		...
		const { loadChannelSetupPluginRegistrySnapshotForChannel } = await import("./plugin-install-Deg8cg26.js");
	...
	if (!channel && catalogEntry) {
		...
		if (!isCatalogChannelInstalled({
			...
			const { ensureChannelSetupPluginInstalled } = await import("./plugin-install-Deg8cg26.js");
			const prompter = createClackPrompter();
