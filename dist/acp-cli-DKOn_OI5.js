...
import { Zn as listThinkingLevels } from "./auth-profiles-Djd2VmMW.js";
...
import { q as isKnownCoreToolId } from "./tool-policy-match-DO-I18kG.js";
...
import { n as materializeWindowsSpawnProgram, r as resolveWindowsSpawnProgram } from "./windows-spawn-BYBEEc_q.js";
...
import { f as listKnownProviderAuthEnvVarNames, m as omitEnvKeysCaseInsensitive } from "./registry-D0H7k4Rl.js";
...
import { t as DANGEROUS_ACP_TOOLS } from "./dangerous-tools-Dzu49HNa.js";
...
async function createAcpClient(opts = {}) {
	...
	const { getActiveSkillEnvKeys } = await import("./env-overrides.runtime-WM2NuMml.js");
