...
import { Ms as resolveMentionGatingWithBypass, Ps as createReplyPrefixOptions, wd as issuePairingChallenge } from "./auth-profiles-C1V2x6_A.js";
...
import { i as resolveWebhookTargetWithAuthOrReject, l as resolveWebhookPath, n as registerWebhookTargetWithPluginRoute, s as withResolvedWebhookRequestPipeline } from "./webhook-targets-DFAPta-5.js";
import { i as readJsonWebhookBodyOrReject, r as createWebhookInFlightLimiter } from "./webhook-request-guards-CzMAUg0S.js";
...
async function uploadAttachmentForReply(params) {
	...
	const { uploadGoogleChatAttachment } = await import("./api-CXZXFNHm.js");
