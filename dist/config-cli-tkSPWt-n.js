...
import { t as CONFIG_PATH } from "./paths-D_QmduAc.js";
...
import { d as readConfigFileSnapshot, g as writeConfigFile, v as validateConfigObjectRaw } from "./io-BLrYinYw.js";
import "./host-env-security-DRYydSLp.js";
import "./safe-text-Bls0e7eh.js";
import "./version-BXFMfrjE.js";
import { d as resolveSecretInputRef, i as coerceSecretRef, s as isValidEnvSecretRefId } from "./types.secrets-Mh0km-xK.js";
...
import { a as formatExecSecretRefIdValidationMessage, c as isValidSecretProviderAlias, d as validateExecSecretRefId, o as isValidExecSecretRefId, s as isValidFileSecretRefId, u as secretRefKey } from "./ref-contract-DVGMsUgm.js";
...
import { r as resolveSecretRefValue } from "./resolve-OpLtNdHa.js";
...
import { h as resolveConfigSecretTargetByPath, u as discoverConfigSecretTargets } from "./command-secret-targets-DoLf7afU.js";
...
import { a as normalizeConfigIssues, n as formatConfigIssueLines } from "./issue-format-DHdfT94W.js";
import { t as redactConfigObject } from "./redact-snapshot-BXvSI995.js";
...
function registerConfigCli(program) {
	const cmd = program.command("config").description("Non-interactive config helpers (get/set/unset/file/validate). Run without subcommand for guided setup.").addHelpText("after", () => `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/config", "docs.openclaw.ai/cli/config")}\n`).option("--section <section>", "Configuration sections for guided setup (repeatable). Use with no subcommand.", (value, previous) => [...previous, value], []).action(async (opts) => {
		const { configureCommandFromSectionsArg } = await import("./configure-wP5M3N9K.js");
