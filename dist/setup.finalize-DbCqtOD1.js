...
import { vs as listConfiguredWebSearchProviders } from "./pi-embedded-DFNOKLyy.js";
...
import { t as runTui } from "./tui-CUHHFAxW.js";
...
async function finalizeSetupWizard(options) {
	...
	if (webSearchProvider) {
		const { resolveExistingKey, hasExistingKey, hasKeyInEnv } = await import("./onboard-search-DzTRRc6b.js");
		...
		const { hasExistingKey, hasKeyInEnv } = await import("./onboard-search-DzTRRc6b.js");
