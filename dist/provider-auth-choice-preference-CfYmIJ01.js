import { g as resolveOpenClawAgentDir } from "./models-config.providers.discovery-CBSen190.js";
import { Dv as buildApiKeyCredential, Ev as applyAuthProfileConfig, Fv as normalizeTokenProviderInput, Ix as ensureAuthProfileStore, Nv as normalizeApiKeyInput, Nx as upsertAuthProfile, Pv as normalizeSecretInputModeInput, Rv as validateApiKeyInput, jv as ensureApiKeyFromOptionEnvOrPrompt, n as resolveAuthProfileOrder } from "./auth-profiles-BqVjFbSG.js";
import { r as applyProviderConfigWithDefaultModel, t as applyAgentDefaultModelPrimary } from "./provider-onboard-YZwyyz0l.js";
import { n as resolveManifestProviderAuthChoice, t as resolveManifestProviderApiKeyChoice } from "./provider-auth-choices-B48Gcww1.js";
import { t as createAuthChoiceDefaultModelApplierForMutableState } from "./auth-choice.apply-helpers-CYnaDztT.js";
...
async function resolvePreferredProviderForAuthChoice(params) {
	...
	const { resolveProviderPluginChoice, resolvePluginProviders } = await import("./provider-auth-choice.runtime-C9X3z782.js");
