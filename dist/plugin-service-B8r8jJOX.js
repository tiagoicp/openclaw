...
import { c as safeParseJson, o as respondUnavailableOnNodeInvokeError } from "./startup-auth-BIFHF9wn.js";
...
import { b as normalizeBrowserFormField, x as normalizeBrowserFormFieldValue } from "./chrome-DQrUoch7.js";
import { d as resolveExistingPathsWithinRoot, n as DEFAULT_AI_SNAPSHOT_MAX_CHARS, u as DEFAULT_UPLOAD_DIR } from "./utils-nMa6kBZs.js";
import { d as redactCdpUrl } from "./cdp.helpers-CCxWmOBr.js";
import { a as getBrowserProfileCapabilities } from "./server-context-B3jWtanf.js";
import { n as resolveProfile, t as resolveBrowserConfig } from "./config-D2Y1jrAQ.js";
import { c as browserPdfSave, d as browserArmFileChooser, f as browserNavigate, i as isPersistentBrowserProfileMutation, l as browserAct, n as persistBrowserProxyFiles, o as resolveRequestedBrowserProfile, p as browserScreenshotAction, s as browserConsoleMessages, t as applyBrowserProxyPaths, u as browserArmDialog } from "./browser-runtime-CY-5xZpH.js";
import { c as browserOpenTab, d as browserSnapshot, f as browserStart, g as browserTabs, i as browserCloseTab, l as browserProfiles, m as browserStop, n as trackSessionBrowserTab, p as browserStatus, r as untrackSessionBrowserTab, s as browserFocusTab } from "./session-tab-registry-CocuJQZo.js";
	...
	return {
		...
		start: async () => {
			...
			handle = await startLazyPluginServiceModule({
				...
				loadDefaultModule: async () => await import("./server-DqHOKdbd.js"),
