...
import { t as formatHealthChannelLines } from "./health-C2r0CjXi.js";
...
import { t as buildChannelsTable } from "./channels-B43EladT.js";
...
function loadPluginRegistryModule() {
	pluginRegistryModulePromise ??= import("./plugin-registry-qn0kHe-h.js");
	return pluginRegistryModulePromise;
}
const loadStatusScanRuntimeModule = createLazyRuntimeSurface(() => import("./status.scan.runtime-CbYtl2-K.js"), ({ statusScanRuntime }) => statusScanRuntime);
function loadStatusScanDepsRuntimeModule() {
	statusScanDepsRuntimeModulePromise ??= import("./status.scan.deps.runtime-BkAknvXg.js");
...
function loadProviderUsage() {
	providerUsagePromise ??= import("./provider-usage-B8a6LGi5.js");
	return providerUsagePromise;
}
function loadSecurityAuditModule() {
	securityAuditModulePromise ??= import("./audit.runtime-CEMG1vBy.js");
