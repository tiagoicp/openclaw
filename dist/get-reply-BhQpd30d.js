...
import { t as resolveQueueSettings } from "./queue-BcT8vXEu.js";
...
function loadCommandsStatus() {
	commandsStatusPromise ??= import("./commands-status.runtime-Do4SZY7l.js");
...
function loadDirectiveImpl() {
	directiveImplPromise ??= import("./directive-handling.impl-CxY9BhIh.js");
	return directiveImplPromise;
}
function loadDirectiveFastLane() {
	directiveFastLanePromise ??= import("./directive-handling.fast-lane-CZ_r1W9M.js");
...
function loadOpenClawToolsRuntime() {
	openClawToolsRuntimePromise ??= import("./openclaw-tools.runtime-CYe9bPrd.js");
...
function loadCommandsRuntime() {
	commandsRuntimePromise ??= import("./commands.runtime-CCkoePd0.js");
...
function loadPiEmbeddedRuntime() {
	piEmbeddedRuntimePromise ??= import("./pi-embedded.runtime-nu57EB2m.js");
	return piEmbeddedRuntimePromise;
}
function loadAgentRunnerRuntime() {
	agentRunnerRuntimePromise ??= import("./agent-runner.runtime-DP68Ejqj.js");
...
function loadMediaUnderstandingApplyRuntime() {
	mediaUnderstandingApplyRuntimePromise ??= import("./apply.runtime-DYupZNes.js");
	return mediaUnderstandingApplyRuntimePromise;
}
function loadLinkUnderstandingApplyRuntime() {
	linkUnderstandingApplyRuntimePromise ??= import("./apply.runtime-CqUg150r.js");
	return linkUnderstandingApplyRuntimePromise;
}
function loadCommandsCoreRuntime() {
	commandsCoreRuntimePromise ??= import("./commands-core.runtime-C9DhyrVR.js");
...
async function getReplyFromConfig(ctx, opts, configOverride) {
	...
	const maybeEmitAutoResetHook = async () => {
		...
		const { emitResetCommandHooks } = await import("./commands-core.runtime-C9DhyrVR.js");
		await emitResetCommandHooks({
			action: "reset",
			ctx,
			cfg,
