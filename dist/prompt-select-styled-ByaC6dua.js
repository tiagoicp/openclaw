...
import { t as isTruthyEnvValue$1 } from "./env-CqNoAfUj.js";
...
import { a as resolveSystemNodeInfo, r as renderSystemNodeWarning } from "./runtime-paths-DkAqA6Ce.js";
...
import { l as normalizeTrimmedStringList, s as normalizeStringEntries } from "./string-normalization-DpFJ3rD9.js";
import { i as listBundledChannelPluginIds } from "./bootstrap-registry-DjzgO-1e.js";
import { B as normalizeLegacyBrowserConfig, G as seedMissingDefaultAccountsFromSingleAccountBase, H as normalizeLegacyMediaProviderOptions, K as normalizeLegacyTalkConfig, R as findLegacyConfigIssues, S as validateConfigObjectWithPlugins, U as normalizeLegacyMistralModelMaxTokens, V as normalizeLegacyCrossContextMessageConfig, W as normalizeLegacyNanoBananaSkill, at as listPluginDoctorLegacyConfigRules, et as applyLegacyDoctorMigrations, g as writeConfigFile, it as collectRelevantDoctorPluginIds, l as readConfigFileSnapshot, nt as migrateLegacyXSearchConfig, rt as applyChannelDoctorCompatibilityMigrations, tt as migrateLegacyWebSearchConfig, z as migrateLegacyWebFetchConfig } from "./io-CW6SWMPF.js";
import { t as asNullableObjectRecord } from "./record-coerce-y8jMKGf7.js";
import { t as loadPluginManifestRegistry } from "./manifest-registry-CIsaiiqr.js";
import { c as normalizeAgentId, x as parseAgentSessionKey } from "./session-key-DO1ve_TS.js";
...
import { b as resolveExecutablePath } from "./exec-safe-bin-trust-MVZpmYed.js";
import { t as DEFAULT_AGENTS_FILENAME } from "./workspace-Dphk4K2m.js";
import { b as resolveAgentWorkspaceDir, h as listAgentEntries, x as resolveDefaultAgentId, y as resolveAgentDir } from "./agent-scope-DsH_ZwEW.js";
import { t as randomToken } from "./random-token-BGinZeIC.js";
import { d as uninstallLegacySystemdUnits, i as isSystemdUserServiceAvailable, p as classifySystemdUnavailableDetail } from "./systemd-C3qt0ip4.js";
import { i as launchAgentPlistExists, n as isLaunchAgentListed, r as isLaunchAgentLoaded, s as repairLaunchAgentBootstrap } from "./launchd-CUWv3PeD.js";
...
import { i as resolveDaemonContainerContext, r as formatRuntimeStatus, t as buildPlatformRuntimeLogHints } from "./runtime-hints-DrfC-8Ef.js";
import "./config-CGntDIeG.js";
import { n as safeParseWithSchema, t as safeParseJsonWithSchema } from "./zod-parse-DyCUZEvs.js";
import { n as formatConfigIssueLines } from "./issue-format-QY32pSXt.js";
import { a as readEmbeddedGatewayToken, i as needsNodeRuntimeMigration, n as auditGatewayServiceConfig, t as SERVICE_AUDIT_CODES } from "./service-audit-sjzT9mdK.js";
import { n as renderSystemdUnavailableHints, t as isSystemdUnavailableDetail } from "./systemd-hints-UcT1h_mP.js";
import { r as isWSLEnv, t as isWSL } from "./wsl-JT5M_OUO.js";
import { t as readLastGatewayErrorLine } from "./diagnostics-DBcOOC0l.js";
import { n as findExtraGatewayServices, r as renderGatewayServiceCleanupHints } from "./inspect-BSp8VhQU.js";
import { u as resolveAuthStorePathForDisplay } from "./source-check-Bc8rRw6e.js";
import { D as CLAUDE_CLI_PROFILE_ID, n as ensureAuthProfileStore, w as readClaudeCliCredentialsCached } from "./store-BkxBSJMW.js";
import { t as applyPluginAutoEnable } from "./plugin-auto-enable-CuavPfxV.js";
import { t as hasBundledChannelPersistedAuthState } from "./persisted-auth-state-CxjoiNee.js";
import { i as runPluginSetupConfigMigrations } from "./setup-registry-fRiGzhRX.js";
import "./plugins-RAm7ylrL.js";
import "./logging-BZmmoywx.js";
import { g as resolveHooksGmailModel, m as resolveConfiguredModelRef } from "./model-selection-cli-CXSa0KzE.js";
import { n as getModelRefStatus } from "./model-selection-C05AhLK_.js";
import { r as loadModelCatalog } from "./model-catalog-CM7cSMQY.js";
import { n as isPrimarySessionTranscriptFileName, t as formatSessionArchiveTimestamp } from "./artifacts-BIUayLFY.js";
import { i as resolveMainSessionKey } from "./main-session-CRdpto3G.js";
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, l as resolveSessionTranscriptsDirForAgent, u as resolveStorePath } from "./paths-CEB5IskJ.js";
...
import { n as buildBootstrapInjectionStats, t as analyzeBootstrapBudget } from "./bootstrap-budget-DXKkQZb6.js";
import { i as resolveBootstrapContextForRun } from "./bootstrap-files-BauY28ZH.js";
import { S as resolveBootstrapMaxChars, w as resolveBootstrapTotalMaxChars } from "./pi-embedded-helpers-BcdLfiTZ.js";
import { n as classifyOAuthRefreshFailure, t as buildOAuthRefreshFailureLoginCommand } from "./oauth-refresh-failure-3ZKAF3SM.js";
import { l as DEFAULT_SANDBOX_IMAGE, r as resolveSandboxScope, s as DEFAULT_SANDBOX_BROWSER_IMAGE } from "./config-DNJkN53Y.js";
import { r as formatAuthDoctorHint, t as resolveApiKeyForProfile } from "./auth-profiles-D8BxwHwt.js";
import { t as repairOAuthProfileIdMismatch } from "./repair-CRbbHpEK.js";
import { d as resolveProfileUnusableUntilForDisplay } from "./order-DnyCa__a.js";
...
import { l as loadExecApprovals } from "./exec-approvals-DnKdr6O0.js";
import { i as TrimmedNonEmptyStringFieldSchema, n as LowercaseNonEmptyStringFieldSchema, o as parseOptionalField, t as DeliveryThreadIdFieldSchema } from "./delivery-field-schemas-CcBU2kTF.js";
...
import { N as listTaskFlowRecords, d as listTasksForFlowId } from "./task-registry-CXwLtxYv.js";
import "./runtime-internal-Kc_O3mT5.js";
...
import { n as formatSetExplicitDefaultInstruction, r as formatSetExplicitDefaultToConfiguredInstruction, t as formatChannelAccountsDefaultPath } from "./default-account-warnings-COXXSkW5.js";
import { a as readChannelAllowFromStore } from "./pairing-store-Bpa-5SXl.js";
import { r as resolveDmAllowState } from "./dm-policy-shared-GFAS1R1h.js";
...
import "./engine-storage-Dpb-DqYn.js";
import "./secret-CfpfqVT9.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-DQ0KRhLN.js";
import { i as buildPluginDiagnosticsReport, r as buildPluginCompatibilityWarnings } from "./status-CuWp_0x5.js";
import { n as buildAuthHealthSummary, r as formatRemainingShort, t as DEFAULT_OAUTH_WARN_MS } from "./auth-health-DbAdG-x3.js";
import { n as resolveExecPolicyScopeSnapshot } from "./exec-approvals-effective-C5eRzKh5.js";
import { i as resolveControlUiDistIndexPathForRoot, r as resolveControlUiDistIndexHealth } from "./control-ui-assets-DDiDfV0b.js";
import { a as guardCancel, l as printWizardHeader, n as applyWizardMetadata } from "./onboard-helpers-DF7PxzmN.js";
import { a as collectChannelDoctorRepairMutations, n as collectChannelDoctorEmptyAllowlistExtraWarnings, o as collectChannelDoctorStaleConfigMutations, r as collectChannelDoctorMutableAllowlistWarnings, s as runChannelDoctorConfigSequences } from "./channel-doctor-DHhPqPU7.js";
...
import { a as stripUnknownConfigKeys, r as noteOpencodeProviderOverrides } from "./doctor-config-analysis-BoqVMnbF.js";
import { t as runDoctorConfigPreflight } from "./doctor-config-preflight-CfcPBqXR.js";
import { n as maybeRepairOpenPolicyAllowFrom, r as resolveAllowFromMode } from "./open-policy-allowfrom-CbfnU6Bw.js";
import { n as hasAllowFromEntries, t as scanEmptyAllowlistPolicyWarnings } from "./empty-allowlist-scan-C1ArH7OZ.js";
import { t as asObjectRecord } from "./object-vN8w8bVO.js";
import { n as maybeRepairBundledPluginLoadPaths } from "./bundled-plugin-load-paths-CjEoL7ZE.js";
import { r as maybeRepairExecSafeBinProfiles } from "./exec-safe-bins-DtO5FSZL.js";
import { n as maybeRepairLegacyToolsBySenderKeys } from "./legacy-tools-by-sender-obBXyIQS.js";
import { r as maybeRepairStalePluginConfig } from "./stale-plugin-config-RGW15kUl.js";
...
import { n as doctorShellCompletion } from "./doctor-completion-C_zPQlht.js";
import { t as coerceFiniteScheduleNumber } from "./schedule-CT6SIMvN.js";
import { t as collectChannelStatusIssues } from "./channels-status-issues-IZ03Vdz3.js";
import { t as resolveDefaultChannelAccountContext } from "./channel-account-context-DN_down7.js";
import { a as runLegacyStateMigrations, n as detectLegacyStateMigrations } from "./state-migrations-D3vAIZOI.js";
import "./doctor-state-migrations-CdPpMDQB.js";
import { n as noteOpenAIOAuthTlsPrerequisites } from "./provider-openai-codex-oauth-tls-DAA1kyfD.js";
...
function loadChannelDoctorModule() {
	channelDoctorModulePromise ??= import("./channel-doctor-CJ57qCJu.js");
...
async function collectDoctorPreviewWarnings(params) {
	...
	const channelPluginRuntime = hasChannelConfig && hasExplicitChannelPluginBlockerConfig(params.cfg) ? await import("./channel-plugin-blockers-CyJFrzP-.js") : void 0;
	...
	if (hasChannelConfig) {
		...
		const { collectOpenPolicyAllowFromWarnings, maybeRepairOpenPolicyAllowFrom } = await import("./open-policy-allowfrom-3whJwom9.js");
	...
	if (hasPluginConfig) {
		const { collectStalePluginConfigWarnings, isStalePluginAutoRepairBlocked, scanStalePluginConfig } = await import("./stale-plugin-config-D21DQ0vU.js");
	...
	if (hasPluginLoadPaths(params.cfg)) {
		const { collectBundledPluginLoadPathWarnings, scanBundledPluginLoadPathMigrations } = await import("./bundled-plugin-load-paths-CrfyCkgD.js");
	...
	if (hasChannelConfig) {
		...
		const { scanEmptyAllowlistPolicyWarnings } = await import("./empty-allowlist-scan-xJWAuRVl.js");
		...
		if (emptyAllowlistWarnings.length > 0) {
			const { sanitizeForLog } = await import("./ansi-B1N19Or7.js");
			warnings.push(emptyAllowlistWarnings.map((line) => sanitizeForLog(line)).join("\n"));
		}
	}
	if (hasToolsBySenderKey(params.cfg)) {
		const { collectLegacyToolsBySenderWarnings, scanLegacyToolsBySenderKeys } = await import("./legacy-tools-by-sender-D9Rw5-Ie.js");
	...
	if (hasConfiguredSafeBins(params.cfg)) {
		const { collectExecSafeBinCoverageWarnings, collectExecSafeBinTrustedDirHintWarnings, scanExecSafeBinCoverage, scanExecSafeBinTrustedDirHints } = await import("./exec-safe-bins-BbC_9Jom.js");
...
async function loadProviderRuntime() {
	return import("./providers.runtime-BUCxc9qr.js");
}
async function loadNoteRuntime() {
	return import("./note-BM_gT9MP.js");
}
