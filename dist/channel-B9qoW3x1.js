import { Mp as createDefaultChannelRuntimeState, Op as buildProbeChannelStatusSummary, kp as buildRuntimeAccountStatusSnapshot, qt as createMessageToolCardSchema } from "./auth-profiles-BwxmeQoE.js";
import { t as DEFAULT_ACCOUNT_ID } from "./account-id-BuyZMNja.js";
import { o as MSTeamsConfigSchema } from "./zod-schema.providers-core-Lq3UWu4O.js";
...
import { s as createTopLevelChannelConfigAdapter } from "./channel-config-helpers-BRtPQkQ4.js";
...
const loadMSTeamsChannelRuntime = createLazyRuntimeNamedExport(() => import("./channel.runtime-CWDH3Iwh.js"), "msTeamsChannelRuntime");
...
const msteamsPlugin = {
	...
	gateway: { startAccount: async (ctx) => {
		const { monitorMSTeamsProvider } = await import("./src-CJZtJhXe.js");
