import { Op as buildProbeChannelStatusSummary, jp as collectStatusIssuesFromLastError } from "./auth-profiles-BwxmeQoE.js";
...
import { c as GroupPolicySchema, m as MarkdownConfigSchema } from "./zod-schema.core-Ck0QyHFp.js";
import { i as buildNestedDmConfigSchema, r as buildChannelConfigSchema, t as AllowFromListSchema } from "./config-schema-DxpGRv8-.js";
...
import { i as collectAllowlistProviderGroupPolicyWarnings, r as buildOpenGroupPolicyWarning } from "./group-policy-warnings-YpdU_Yps.js";
import { i as createScopedChannelConfigAdapter, o as createScopedDmSecurityResolver } from "./channel-config-helpers-BRtPQkQ4.js";
import { o as stripChannelTargetPrefix, s as stripTargetKindPrefix, t as buildChannelOutboundSessionRoute } from "./core-DczSNd0Z.js";
import { i as createLazyRuntimeNamedExport } from "./lazy-runtime-DN6VaF6M.js";
import { t as buildSecretInputSchema } from "./secret-input-schema-CwOcgb-P.js";
import { _ as matrixSetupAdapter, a as resolveMatrixAccount, g as isBunRuntime, i as resolveDefaultMatrixAccountId, l as resolveSharedMatrixClient, o as resolveMatrixAccountConfig, p as resolveMatrixAuth, r as listMatrixAccountIds, t as matrixSetupWizard } from "./matrix-BMLJ-446.js";
import { s as getMatrixRuntime } from "./credentials-IOihXLeg.js";
import { r as buildTrafficStatusSummary } from "./channel-status-summary-RzTrM4E-.js";
import { c as getActiveMatrixClient, n as sendMessageMatrix, o as resolveMatrixRoomId, s as createPreparedMatrixClient, t as reactMatrixMessage } from "./send-CO0_2qHW.js";
import { a as resolveMatrixRoomConfig, c as summarizeMatrixRawEvent, d as RelationType, l as EventType, n as normalizeMatrixUserId, o as fetchEventSummary, s as readPinnedEvents, t as normalizeMatrixAllowList, u as MsgType } from "./allowlist-9VhiIfnt.js";
import { z } from "zod";
...
const loadMatrixChannelRuntime = createLazyRuntimeNamedExport(() => import("./channel.runtime-CFx-DLJL.js"), "matrixChannelRuntime");
const meta = {
	id: "matrix",
	label: "Matrix",
...
const matrixPlugin = {
	...
	gateway: { startAccount: async (ctx) => {
		...
		try {
			monitorMatrixProvider = (await import("./matrix-wVYzKjIn.js")).monitorMatrixProvider;
		} finally {
			releaseLock();
		}
