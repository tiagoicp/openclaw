...
import { _ as resolveStateDir, o as resolveConfigPath } from "./paths-D_QmduAc.js";
...
import { By as hasPotentialConfiguredChannels, Ys as buildPluginCompatibilityNotices } from "./auth-profiles-CPtwVkYW.js";
...
import { h as resolveUpdateChannelDisplay, p as normalizeUpdateChannel } from "./update-check-BfU_cB3L.js";
import "./node-service-B05RDgoZ.js";
import { r as getUpdateCheckResult } from "./status.update-CIPVqugw.js";
...
function loadCommandSecretTargetsModule() {
	commandSecretTargetsModulePromise ??= import("./command-secret-targets-YxSw2rpq.js");
	return commandSecretTargetsModulePromise;
}
function loadCommandSecretGatewayModule() {
	commandSecretGatewayModulePromise ??= import("./command-secret-gateway-B08xsreY.js");
	return commandSecretGatewayModulePromise;
}
function loadMemorySearchModule() {
	memorySearchModulePromise ??= import("./memory-search-CIMx4gB0.js");
...
function loadGatewayCallModule() {
	gatewayCallModulePromise ??= import("./call-yZTOmJYH.js");
