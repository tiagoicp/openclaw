import { Mp as createDefaultChannelRuntimeState, Op as buildProbeChannelStatusSummary, kp as buildRuntimeAccountStatusSnapshot, qt as createMessageToolCardSchema, um as parseFeishuConversationId } from "./auth-profiles-BqVjFbSG.js";
...
import { c as listFeishuAccountIds, d as resolveFeishuCredentials, f as feishuSetupAdapter, i as createFeishuClient, l as resolveDefaultFeishuAccountId, s as listEnabledFeishuAccounts, t as feishuSetupWizard, u as resolveFeishuAccount } from "./feishu-u0SpIhdb.js";
import { i as normalizeFeishuTarget, r as looksLikeFeishuId, t as getFeishuRuntime } from "./runtime-GK-blqJr.js";
import { n as listFeishuDirectoryPeers, t as listFeishuDirectoryGroups } from "./directory.static-DglmJsmq.js";
...
const loadFeishuChannelRuntime = createLazyRuntimeNamedExport(() => import("./channel.runtime-S-g6ykdo.js"), "feishuChannelRuntime");
...
const feishuPlugin = {
	...
	gateway: { startAccount: async (ctx) => {
		const { monitorFeishuProvider } = await import("./monitor-CzbMDLAl.js");
		const account = resolveFeishuAccount({
			cfg: ctx.cfg,
