...
import { t as require_src } from "./src-DYUWP8pD.js";
import { C as UINT32_LE, a as UnsupportedFileTypeError, i as InternalParserError, k as textDecode, n as CouldNotDetermineFileTypeError } from "./BasicParser-DlMvTVwN.js";
import { t as fromBuffer } from "./lib-COH1UvBz.js";
import { l as toRatio, n as decodeString } from "./Util-BCn7_x8r.js";
import { c as TimestampFormat, i as LyricsContentType } from "./ID3v2Token-C8Rsbq5H.js";
import { t as APEv2Parser } from "./APEv2Parser-B2szYhJI.js";
import { r as hasID3v1Header } from "./ID3v1Parser-DmKXx7Tc.js";
import { n as TrackType, r as TrackTypeValueToKeyMap } from "./types-B-NETcXT.js";
...
const mpegParserLoader = {
	...
	async load() {
		return (await import("./MpegParser-D6UQfB46.js")).MpegParser;
	}
};
//#endregion
...
const apeParserLoader = {
	...
	async load() {
		return (await import("./APEv2Parser-aohLXeej.js")).APEv2Parser;
	}
};
//#endregion
...
const asfParserLoader = {
	...
	async load() {
		return (await import("./AsfParser-CgivGmJJ.js")).AsfParser;
	}
};
//#endregion
...
const dsdiffParserLoader = {
	...
	async load() {
		return (await import("./DsdiffParser-XEgsgLl2.js")).DsdiffParser;
	}
};
//#endregion
...
const aiffParserLoader = {
	...
	async load() {
		return (await import("./AiffParser-BLic_NTQ.js")).AIFFParser;
	}
};
//#endregion
...
const dsfParserLoader = {
	...
	mimeTypes: ["audio/dsf"],
	async load() {
		return (await import("./DsfParser-Csr_wH9Z.js")).DsfParser;
	}
};
//#endregion
...
const flacParserLoader = {
	...
	async load() {
		return (await import("./FlacParser-DlGtkaP8.js")).FlacParser;
	}
};
//#endregion
...
const matroskaParserLoader = {
	...
	async load() {
		return (await import("./MatroskaParser-CviPHCt1.js")).MatroskaParser;
	}
};
//#endregion
...
const mp4ParserLoader = {
	...
	async load() {
		return (await import("./MP4Parser-D_rpohhJ.js")).MP4Parser;
	}
};
//#endregion
...
const musepackParserLoader = {
	...
	async load() {
		return (await import("./MusepackParser-DTu5-1eo.js")).MusepackParser;
	}
};
//#endregion
...
const oggParserLoader = {
	...
	async load() {
		return (await import("./OggParser-D9ZQ_T-L.js")).OggParser;
	}
};
//#endregion
...
const wavpackParserLoader = {
	...
	async load() {
		return (await import("./WavPackParser-U51CjgNn.js")).WavPackParser;
	}
};
//#endregion
...
const riffParserLoader = {
	...
	async load() {
		return (await import("./WaveParser-Bru3qUQX.js")).WaveParser;
	}
};
//#endregion
