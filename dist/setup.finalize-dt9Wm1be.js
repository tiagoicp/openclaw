...
import { h as restoreTerminalState } from "./subsystem-Dm-AQqmI.js";
import "./ansi-BMqrB9En.js";
import "./boolean-BgLJTske.js";
import "./env-mHZMLTjc.js";
import "./warning-filter-m2BbicIr.js";
import { h as pathExists, y as resolveUserPath } from "./utils-CIAfMgvq.js";
...
import { r as DEFAULT_BOOTSTRAP_FILENAME } from "./workspace-C3BQkKrq.js";
...
import { n as resolveCliName } from "./cli-name-DssQsG7y.js";
...
import { b as waitForGatewayReachable, d as openUrl, g as resolveControlUiLinks, i as detectBrowserOpenSupport, o as formatControlUiSshHint, p as probeGatewayReachable } from "./onboard-helpers-D1z7-ld8.js";
...
import { i as isSystemdUserServiceAvailable } from "./systemd-BHvqbPC4.js";
...
import { t as runTui } from "./tui-CdwlE1Op.js";
...
async function finalizeSetupWizard(options) {
	...
	if (process.platform === "linux" && systemdAvailable) {
		const { ensureSystemdUserLingerInteractive } = await import("./systemd-linger-BZ-FbrVM.js");
	...
	if (webSearchProvider) {
		const { SEARCH_PROVIDER_OPTIONS, resolveExistingKey, hasExistingKey, hasKeyInEnv } = await import("./onboard-search-YH83kxLc.js");
		...
		const { SEARCH_PROVIDER_OPTIONS, hasExistingKey, hasKeyInEnv } = await import("./onboard-search-YH83kxLc.js");
